...
$jscomp.polyfill("Number.MAX_SAFE_INTEGER",function(){return 9007199254740991},"es6-impl","es3");$jscomp.polyfill("Number.isSafeInteger",function(b){return b?b:function(b){return Number.isInteger(b)&&Math.abs(b)<=Number.MAX_SAFE_INTEGER}},"es6-impl","es3");
...
h=f.length,n=b[c],g=0;g<h;g++){var m=f[g],z;z=f[g];for(var B=0,v=0;v<d.length;v++)if(z.rules[v]&&d[v]){if(d[v].s>=z.rules[v].s&&d[v].e<=z.rules[v].e)B=0,B+=Math.abs(d[v].s-z.rules[v].s),B+=Math.abs(z.rules[v].e-d[v].e);else{B="N/A";break}if(864E6<B){B="N/A";break}}z=B=a(d,c,B,z);"N/A"!==z&&(e[m.name]=z)}for(var E in e)if(e.hasOwnProperty(E))for(f=0;f<n.length;f++)if(n[f]===E)return E;return c},h=function(a){var b=function(){for(var a=[],d=0;d<jstz.olson.dst_rules.years.length;d++){var b;b=jstz.olson.dst_rules.years[d];
var e=(new Date(b,0,1,0,0,1,0)).getTime();b=(new Date(b,12,31,23,59,59)).getTime();for(var f=(new Date(e)).getTimezoneOffset(),h=null,n=null;e<b-864E5;){var g=new Date(e),m=g.getTimezoneOffset();m!==f&&(m<f&&(h=g),m>f&&(n=g),f=m);e+=864E5}b=h&&n?{s:c(h).getTime(),e:c(n).getTime()}:!1;a.push(b)}return a}();return function(a){for(var d=0;d<a.length;d++)if(!1!==a[d])return!0;return!1}(b)?d(b,a):a};return{determine:function(){var a=e();a||(a=jstz.olson.timezones[f()],"undefined"!==typeof b[a]&&(a=h(a)));
...
g.getElementName(e));switch(l){case "Problems":b.processProblemsElement(e);break;case "ProblemSets":b.processProblemSetsElement(e);break;case "Assets":h=b.processAssetsElement(e,h)}}}};this.processProblemsElement=function(a){a=g.getElementChildren(a);b.ctatdebug("CTATPackage.processProblemsElement ... nChildren="+a.length);for(var d=[],c=0;c<a.length;c++){var e=a[c],f=g.getElementAttr(e,"problem_file"),l=g.getElementAttr(e,"student_interface"),x=g.getElementAttr(e,"name"),r=g.getElementAttr(e,"label"),
y=g.getElementAttr(e,"description");h[f]=f;h[l]=l;b.ctatdebug("Problem ["+c+"] desc: "+y+", ui: "+l+", brd: "+f);f=b.addProblem(f,l,x,r,y);f.setTutorFlag(g.getElementAttr(e,"tutor_flag"));e=g.getElementChildren(e);for(l=0;l<e.length;l++)if("Skills"==g.getElementName(e[l]))for(x=g.getElementChildren(e[l]),r=0;r<x.length;r++){var y=x[r],z=0;f.addSkillOpps({name:g.getElementAttr(y,"name"),category:g.getElementAttr(y,"category"),opportunities:Number.isNaN(z=Number.parseInt(g.getElementAttr(y,"occurrences")),
10)?0:z})}d.push(f)}console.log("CTATPackage.processProblemsElement result",d);return d};this.processProblemSetsElement=function(a){a=g.getElementChildren(a);b.ctatdebug("CTATPackage.processProblemSetsElement ... nChildren="+a.length);for(var d=0;d<a.length;d++);return[]};this.processAssetsElement=function(a,d){var c=g.getElementChildren(a);b.ctatdebug("CTATPackage.processAssetsElement ... nChildren="+c.length);for(var e=0;e<c.length;e++){var f=c[e],h;"Asset"==g.getElementName(f)&&"undefined"!=d[h=
...
g),e=0;e<g.length;++e)if(f=$(g[e]).attr("value"),b.ctatdebug("generateDefaultConfiguration() fVarsAsString "+f),f&&(f=parseQueryStringArgs(f))&&f.question_file)for(var u in f)d[u]=f[u];ctatdebug("tutorPrep ("+d+")");u={};if(null===d||void 0===d)ctatdebug("tutorPrep(): Internal error: null argument passed");else{ctatdebug("parseQueryString ()");g=location.search;ctatdebug("Query String: "+g);e="?"==g.charAt(0)?g.substring(1):g;g={};if(e)for(e=e.split("&"),f=0;f<e.length;f++){h=e[f].split("=");ctatdebug("Setting flashvar "+
h[0]+", to: "+decodeURIComponent(h[1].replace(/\+/g," ")));g[decodeURIComponent(h[0])]="";for(var x=1;x<h.length;x++)g[decodeURIComponent(h[0])]+=(1<x?"=":"")+decodeURIComponent(h[x].replace(/\+/g," "));ctatdebug("Decoded args: "+g[decodeURIComponent(h[0])])}null!==g&&(ctatdebug("tutorPrep(): Assigning parsed arguments ..."),u=g);g=!1;for(var r in u)if(u.hasOwnProperty(r))switch(ctatdebug("Processing external FlashVar "+r+"("+u[r]+")"),r){case "GENERATED":"on"==u[r]&&(d.session_id=CTATGuid.guid(),
g=!0);break;case "BRD":d.question_file=u[r];break;case "BRMODE":d.BehaviorRecorderMode=u[r];break;case "PROBLEM":d.problem_name=u[r];break;case "DATASET":d.dataset_name=u[r];break;case "LEVEL1":d.dataset_level_name1=u[r];break;case "TYPE1":d.dataset_level_type1=u[r];break;case "LEVEL2":d.dataset_level_name2=u[r];break;case "TYPE2":d.dataset_level_type2=u[r];break;case "LEVEL3":d.dataset_level_name3=u[r];break;case "TYPE3":d.dataset_level_type3=u[r];break;case "LEVEL4":d.dataset_level_name4=u[r];break;
case "TYPE4":d.dataset_level_type4=u[r];break;case "USER":d.user_guid=u[r];break;case "SESSION":!1===g&&(d.session_id=u[r]);break;case "SOURCE":d.source_id=u[r];break;case "LOGTYPE":d.Logging=u[r];break;case "PORT":d.remoteSocketPort=u[r];break;case "REMOTEURL":d.remoteSocketURL=u[r];break;case "DISKDIR":d.log_to_disk_directory=u[r];break;case "log_service_url":d.log_service_url=u[r];break;case "URL":d.log_service_url=u[r];break;case "LOGURL":d.log_service_url=u[r];break;case "CONNECTION":d.tutoring_service_communication=
u[r];break;case "SUI":d.sui=u[r];break;case "VAR1":d.var1=u[r];break;case "VAL1":d.val1=u[r];break;case "VAR2":d.var2=u[r];break;case "VAL2":d.val2=u[r];break;case "VAR3":d.var3=u[r];break;case "VAL3":d.val3=u[r];break;case "VAR4":d.var4=u[r];break;case "VAL4":d.val4=u[r];break;case "SLOG":case "SessionLog":d.SessionLog=u[r];break;case "KEYBOARDGROUP":"Disabled"==u[r]&&(d.keyboard="disabled");"Auto"==u[r]&&(d.keyboard="auto");"On"==u[r]&&(d.keyboard="on");break;default:d[r]=u[r]}}return d};this.getCustomFields=
...
c);null==c&&(c=new WebSocket(e.getURL()),c.addEventListener("open",function(e){ctatdebug("STATUS: open");d=!0;ctatdebug("Connection open, flushing outgoing queue ...");h=(new Date).getTime();if(0<a.length){for(e=0;e<a.length;e++)c.send(a[e]);a=[]}}),c.addEventListener("message",function(a){l=(new Date).getTime();ctatdebug("STATUS: message after "+(l-h)+" ms");ctatdebug("Received: "+a.data);n?n(a.data):ctatdebug("Error: no processing function provided")}),c.addEventListener("close",function(a){ctatdebug("STATUS: close; "+
...
e+"<br><br></div></div></div>"),!0===d&&(waitScrim=!1,u=f(b,"close"),$(u).appendTo("#scrimpanel")),!0===c&&(waitScrim=!1,p=f(h,"yes"),$(p).appendTo("#scrimpanel"),c=!1),!0===a&&(waitScrim=!1,q=f(l,"no"),$(q).appendTo("#scrimpanel"),a=!1),!0===waitScrim)){r.ctatdebug("Adding spinner ...");$("#scrimpanel").append("<br>");g=$('<div id="scrim_spin">');g.css("width","100%");g.css("position","relative");$("#scrimpanel").append(g);try{var m=(new Spinner({className:"scrim_spinner"})).spin();$("#scrim_spin").append(m.el)}catch(B){(B instanceof
ReferenceError||B instanceof TypeError)&&r.ctatdebug('Spinner is not available, please include it in the build or add <script src="node_modules/spin.js/spin.min.js">\x3c/script> to the html file.',B,typeof B)}}};this.waitScrimUp=function(){r.ctatdebug("waitScrimUp () CTATConfig.platform "+CTATConfig.platform+", scrimIsUp "+scrimIsUp);"google"!=CTATConfig.platform&&(!0===scrimIsUp&&r.scrimDownForced(),waitScrim=!0,r.scrimUp(CTATGlobals.languageManager.getString("LOADING")),r.ctatdebug("return from waitScrimUp(): scrimIsUp "+
scrimIsUp))};this.nextProblemScrimUp=function(){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&r.scrimDownForced(),r.ctatdebug("nextProblemScrimUp ()"),r.scrimUp(CTATGlobals.languageManager.getString("NEXTPROBLEM")))};this.OKScrimUp=function(e,b){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&r.scrimDownForced(),r.ctatdebug("OKScrimUp ("+e+","+b+")"),waitScrim=a=c=d=warnScrim=errorScrim=!1,r.scrimUp(e),x=f(b,"OK"),$(x).appendTo("#scrimpanel"))};this.confirmScrimUp=function(d,e,b){"google"!=CTATConfig.platform&&
(!0===scrimIsUp&&r.scrimDownForced(),r.ctatdebug("confirmScrimUp ("+d+","+e+","+b+")"),a=c=!0,l=b,h=e,r.scrimUp(d))};this.errorScrimUp=function(a){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&r.scrimDownForced(),!1===authorTimeSet?(r.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"),m.push("ERROR: "+a),errorScrim=!0):!1===inAuthorTime?r.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes"):(errorScrim=!0,g("ERROR: "+
...
document.dispatchEvent(new CustomEvent("receiveFromCollaborator",{detail:a}));return d};this.setSocketType=function(a){p=a;if(m.hasWebSocket()||m.hasPostMessage())$(window).on("message",function(a){if(a.originalEvent.origin===window.location.origin&&(a=a.originalEvent?a.originalEvent.data:null,console.log("message from "+a.from+":",a),a))if(d){if(a=m.interpretCollab(a))d.processMessage(a),m.hasPostMessage()||CTAT.ToolTutor.sendToTutor(a)}else console.log("No http handler defined for websocket listener.")})};
this.hasSecureSocket=function(){return/https/i.test(p)||/wss/i.test(p)};this.hasJavaScriptConnection=function(){return/javascript/i.test(p)};this.hasWebSocket=function(){return/websocket/i.test(p)};this.hasPostMessage=function(){return/postmessage/i.test(p)};this.assignHandler=function(a){d=a};this.assignMessageListener=function(a){n=a};this.encodeVariables=function(a){m.ctatdebug("encodeVariables ()");for(var d="",c=0;c<a.length;c++){var e=a[c];0<c&&(d+="&");d+=e.name;d+="=";d+=encodeURIComponent(e.value)}return d};
this.encodeVariablesOLI=function(a){m.ctatdebug("encodeVariablesOLI ()");for(var d="",c=0;c<a.length;c++){var e=a[c];0<c&&(d+="&");d+=e.name;d+="=";d+=encodeURIComponent(e.value)}return d};this.createConnection=function(d,b,f){m.ctatdebug("createConnection () canBeWebSocket "+f);f="undefined"==typeof f?!0:!1!==f;if(!b)return new CTATConnection(d);if(f&&m.hasWebSocket())return f=this.findWSConnection(b),f||(f=new CTATWSConnection(d),f.setID(e),f.setURL(b),f.assignReceiveFunction(this.processWSReply),
f.assignCloseFunction(this.processWSClose),c.push(f),e++),f;f=new CTATConnection(d);f.setID(e);f.setURL(b);f.assignReceiveFunction(m.processReply);c.push(f);e++;return a=f};this.findWSConnection=function(a){ctatdebug("findWSConnection( "+a+" )");a=m.editSocketURLForHTTPS(a);for(var d=0;d<c.length;d++){var e=c[d];ctatdebug("checking: socketType = "+e.getSocketType()+" URL = "+e.getURL());if("ws"==e.getSocketType()&&e.getURL()==a)return e}return null};this.startBundle=function(){m.ctatdebug("startBundle ()");
!1===useBundling?this.ctatdebug("Not using bundling, bump"):(bundleFormatter='<?xml version="1.0" encoding="UTF-8"?><message><verb/><properties><MessageType>MessageBundle</MessageType><messages>',inBundle=!0)};this.endBundle=function(){m.ctatdebug("endBundle ()");!1===useBundling?m.ctatdebug("Not using bundling, bump"):(inBundle=!1,bundleFormatter+="</messages></properties></message>",m.sendXML(bundleFormatter))};this.setFixedURL=function(a){f=a};this.getURL=function(){m.ctatdebug("getURL ()");if(""!==
f)return m.ctatdebug("Returning fixedURL: "+f),f;var a=flashVars.getRawFlashVars(),d="http://";m.hasSecureSocket()&&(d="https://");d=d+a.remoteSocketURL+":"+a.remoteSocketPort;a.remoteSocketURL&&-1!=a.remoteSocketURL.indexOf("http")&&(d=a.remoteSocketURL+":"+a.remoteSocketPort);return d};this.sendXML=function(a,c){m.ctatdebug("Sending: "+a);m.ctatdebug("sendXML ("+a+")");d.updateLastActionTimestamp&&d.updateLastActionTimestamp();if(!0===useBundling&&!0===inBundle)m.ctatdebug("Bundling ..."),bundleFormatter+=
a;else{bundleFormatter=a;flashVars.getRawFlashVars();var e=this.getURL(),b=bundleFormatter;-1==bundleFormatter.indexOf("<?xml")&&(b='<?xml version="1.0" encoding="UTF-8"?>'+bundleFormatter);m.getUseCommSettings()&&m.hasJavaScriptConnection()?(m.sendToToolsOrCollaborators(e,b,c),CTATConfiguration.get("noLocalTrace")||CTAT.ToolTutor.sendToTutor(b)):m.send_post(e,b)}};this.sendToToolsOrCollaborators=function(a,d,c){return!m.hasWebSocket()||"ctatAsListener"!=CTATConfiguration.get("mode")&&"undefined"!=
typeof c&&!1===c?!1:(this.send_post(a,d),!0)};this.sendXMLNoBundle=function(a){m.ctatdebug("sendXMLNoBundle ("+a+")");bundleFormatter=a;d.updateLastActionTimestamp&&d.updateLastActionTimestamp();var c=this.getURL(),e=a;-1==a.indexOf("<?xml")&&(e='<?xml version="1.0" encoding="UTF-8"?>'+a);flashVars.getRawFlashVars();m.getUseCommSettings()&&m.hasJavaScriptConnection()?(m.sendToToolsOrCollaborators(c,e),CTAT.ToolTutor.sendToTutor(e)):this.send_post(c,e)};this.sendXMLURL=function(a,c,e){ctatdebug("sendXMLURL ("+
c+", "+e+")");var b=a;-1==a.indexOf("<?xml")&&(b='<?xml version="1.0" encoding="UTF-8"?>'+a);flashVars.getRawFlashVars();m.ctatdebug("Sending: "+b);d.updateLastActionTimestamp&&d.updateLastActionTimestamp();this.getUseCommSettings()&&m.hasJavaScriptConnection()?(m.sendToToolsOrCollaborators(c,b),e||CTAT.ToolTutor.sendToTutor(b)):this.send_post(c,b)};this.send_post_variables=function(a,c){m.ctatdebug("send_post_variables ("+a+")");flashVars.getRawFlashVars();var e;e=!1===useOLIEncoding?this.encodeVariables(c):
this.encodeVariablesOLI(c);this.ctatdebug("Sending: "+e);d.updateLastActionTimestamp&&d.updateLastActionTimestamp();if(!0===CTATGlobals.CommDisabled)m.ctatdebug("Communications globally disabled, please check your settings");else{var b=m.createConnection(CTATConfiguration.getRawFlashVars(),a,!1);b.setContentType("application/x-www-form-urlencoded");m.ctatdebug("CTATCommLibrary.send_post_variables() data to send:\n  "+e);null!==n&&n.processOutgoing(e);b.setURL(a);b.setData(e);b.assignReceiveFunction(m.processReply);
b.send()}};this.formPostMessage=function(a){return{command:"message",user_guid:CTATConfiguration.get("user_guid"),data:a}};this.send_post=function(a,d){var c;ctatdebug("send_post ("+a+")");if(!0===CTATGlobals.CommDisabled)m.ctatdebug("Communications globally disabled, please check your settings");else{ctatdebug("Outgoing on wire, "+(m.hasPostMessage()?"to post":"no post")+"; data "+d);c=flashVars.getRawFlashVars();var e=a;if(m.hasPostMessage())c=m.formPostMessage(d),c.dest="sendToTutor",parent.postMessage(c,
parent.location.origin);else{if(m.hasWebSocket()){if(CTATCommShell.commShell.hasTutorShopCable()){parent.postMessage(m.formPostMessage(d),"*");return}a&&(ctatdebug("opening websocket connection: url "+a),e=a.replace(/https?:/,"ws:"),e=m.editSocketURLForHTTPS(e),ctatdebug("opening websocket connection to "+e))}c=m.createConnection(c,e);c.setData(d);null!==n&&n.processOutgoing(d);c.send()}}};this.processReply=function(a,e,b){m.ctatdebug("processReply ("+c.length+","+a+", ...)");"undefined"==typeof b&&
"function"==typeof this.getHTTPObject&&this.getHTTPObject();e=0;a=[];var f;for(f=0;f<c.length;f++){var g=c[f];if(g&&"function"==typeof g.getHTTPObject){var l=g.getHTTPObject();m.ctatdebug("Testing connection entry["+f+"]: readyState & status: "+(l?l.readyState+" & "+l.status:"null")+", consumed: "+g.getConsumed());l&&(4==l.readyState&&!1===g.getConsumed()?(m.ctatdebug("Investigating request response: "+e+" -> "+l.status+", for: "+g.getURL()),b=!1,0===l.status&&(b=!0,m.ctatdebug("Received message (status 0): ("+
l.responseText+"), status: "+l.status),h&&CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(q))),408==l.status&&(b=!0,m.ctatdebug("Received message (status 408): "+l.responseText),h&&CTATScrim.scrim.scrimDown()),502==l.status&&(b=!0,m.ctatdebug("Received message (status 502): "+l.responseText),h&&CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(ERROR_502))),200==l.status?(b=!0,m.ctatdebug("Processing 200 response ..."),null!==d?(a.push(l.responseText),null!==
n&&n.processIncoming(l.responseText)):m.ctatdebug("Error: httphandler is null, can't process response!")):d&&d.processError&&(b=!0,m.ctatdebug("Processing non-200 response, status "+l.status),d.processError(l.status,l.responseText)),!1===b&&m.ctatdebug("Error: status not handled for: "+l.status),m.ctatdebug("Marking connection as consumed ..."),g.setConsumed(!0)):(0===l.readyState&&m.ctatdebug("Received message (status 0, request not initialized)"),1===l.readyState&&m.ctatdebug("Received message (status 1, server connection established)"),
2===l.readyState&&m.ctatdebug("Received message (status 2, request received)"),3===l.readyState&&m.ctatdebug("Received message (status 3, processing request)")),e++)}}m.cleanup();for(e=0;e<a.length;e++)m.ctatdebug("Processing incoming message: "+e),b=a[e],-1!=b.indexOf("status=success")?m.ctatdebug("Info: logging success message received, not propagating to message handler"):(m.ctatdebug("Processing incoming message: "+b),d.processMessage(b))};this.processWSReply=function(a){m.ctatdebug("processWSReply() length "+
(null===a?null:a.toString().length));"string"==typeof a&&(null!==n&&n.processIncoming(a),-1!=a.indexOf("status=success")?m.ctatdebug("processWSReply() logging success message received, not propagating to message handler: "+a):(m.ctatdebug("Processing incoming message: "+a),d.processMessage(a)))};this.processWSClose=function(a){m.ctatdebug("processWSClose("+a+")");a instanceof CloseEvent&&m.ctatdebug("CloseEvent: code "+a.code+", reason "+a.reason+", wasClean "+a.wasClean);CTATLMS.is.Authoring()||
CTATLMS.is.ToolsListener()?CTATScrim.scrim.scrimUp(CTATGlobals.languageManager.filterString("AUTHORPLEASECLOSE")):CTATScrim.scrim.handleTSDisconnect()};this.cleanup=function(){m.ctatdebug("cleanup ()");m.ctatdebug("checkEntries() httprequests.length "+c.length);for(var a=0,d=c.length-1;0<=d;d--){var e=c[d];if(e)if(!0===e.getConsumed())m.ctatdebug("checkEntries() removing["+d+"] ID: "+e.getID()),c.splice(d,1),a++;else if("function"==typeof e.getHTTPObject){var b=e.getHTTPObject();m.ctatdebug("checkEntries() checking["+
d+"], readyState: "+(b?b.readyState:"null")+", consumed: "+e.getConsumed())}}m.ctatdebug("Removed "+a+" entries")};this.retrieveProblemFile=function(a,d,c){"function"==typeof CTATScrim&&CTATScrim.scrim&&CTATScrim.scrim.waitScrimUp();var e=/\.([A-z]*)$/.exec(a);e&&e[1]&&"nools"===e[1].toLowerCase()?(console.log("got a nools file:",a),c.processNools(a)):(console.log("got an xml file, maybe:",a),m.retrieveXMLFile(a,d,c))};this.getFileRequest=function(a,d,c){var e=-1!=(location.href?location.href:a).indexOf("file://")?
!0:!1;location.href||m.ctatdebug("We can't check location.href in the current configuration");if(e)c=(new CTATTutorMessageBuilder).createErrorMessage("","Unable to load: "+a+" - You are trying to use the file:// protocol, which is not allowed in this browser."),m.ctatdebug("onerror GET for fileName "+c),CTAT.ToolTutor.sendToInterface(c,!0);else return u=a,a=new CTATConnection,a.assignReceiveFunction(function(a,c,e){"undefined"==typeof e&&(e="function"==typeof this.getHTTPObject&&this.getHTTPObject());
m.ctatdebug("onready... GET for xmlFile xmlhttp "+e+", .readyState & .status "+(e?e.readyState+" & "+e.status:""));e&&4!=e.readyState||(e&&200==e.status&&d(e),e&&404==e.status&&(a=(new CTATTutorMessageBuilder).createErrorMessage("Unable to download file","("+u+") not found"),m.ctatdebug("Error loading xmlFile "+u+": "+a),CTAT.ToolTutor.sendToInterface(a,!0)))}),a.assignFailFunction(c),a};this.retrieveXMLFile=function(a,d,c){m.ctatdebug("retrieveXMLFile ("+a+")");d=this.getFileRequest(a,function(a){a.responseXML?
(m.ctatdebug("parsing brd xml using something else"),a=a.responseXML.documentElement):(m.ctatdebug("parsing brd xml using node"),a=(new CTATXML).parseXML(a.responseText));null===a?(a=(new CTATTutorMessageBuilder).createErrorMessage("Error parsing xmlFile "+u),m.ctatdebug("Error parsing xmlFile "+u+": "+a),CTAT.ToolTutor.sendToInterface(a,!0)):c.processXML(a)},function(){var a=(new CTATTutorMessageBuilder).createErrorMessage("","Unable to load: "+u+" - Either you are trying to use the  file:// protocol, there is a firewall between the tutor and BRD, or the BRD is on a different domain and permission to retrieve data from that server is denied.");
m.ctatdebug("onerror GET for xmlFile "+a);CTAT.ToolTutor.sendToInterface(a,!0);c.processXML(null)});d.setMethod("GET");d.setURL(a);d.setContentType("text/plain");d.send()};this.retrieveJSONFile=function(a,d){m.ctatdebug("retrieveJSONFile ("+a+")");var c=this.getFileRequest(a,function(){4==c.readyState&&200==c.status&&(m.ctatdebug("Successfully retrieved file: "+a),d(JSON.parse(c.responseText)))},function(){var a=(new CTATTutorMessageBuilder).createErrorMessage("","Unable to load: "+u+" - Either you are trying to use the  file:// protocol, there is a firewall between the tutor and BRD, or the BRD is on a different domain and permission to retrieve data from that server is denied.");
m.ctatdebug("onerror GET for xmlFile "+a);CTAT.ToolTutor.sendToInterface(a,!0)});c.open("GET",a,!0);c.setRequestHeader("Content-type","text/plain");c.send()};this.retrieveFile=function(a,d){m.ctatdebug("retrieveFile ("+a+")");var c=this.getFileRequest(a,function(){4==c.readyState&&200==c.status&&(m.ctatdebug("Successfully retrieved file: "+a),d(c.responseText))},function(){var a=(new CTATTutorMessageBuilder).createErrorMessage("","Unable to load: "+u+" - Either you are trying to use the  file:// protocol, there is a firewall between the tutor and BRD, or the BRD is on a different domain and permission to retrieve data from that server is denied.");
...
Array.isArray(a)?a.slice():[String(a)]};this.getActionArray=function(){return h};this.appendToInputArray=function(a){p.ctatdebug("appendToInputArray ("+a+")");null==a?p.addArgument("","String","text"):p.addArgument(a,"String","text")};this.setInputArray=function(a){l=[];if(null!=a)for(var d=0;d<a.length;d++)p.appendToInputArray(a[d])};this.getInputArray=function(){p.ctatdebug("getInputArray ("+l.length+")");n=[];for(var a=0;a<l.length;a++){var d=l[a];"object"===typeof d?(p.ctatdebug("Adding object value ("+
d.getValue()+") to temp input array"),n.push(d.getValue())):(p.ctatdebug("Adding string value ("+d+") to temp input array"),n.push(d))}return n};this.setPrompt=function(d){a=d};this.getPrompt=function(){return a};this.propagate=function(a){p.ctatdebug("propagate ()");a=a.getArguments();for(var d=0;d<a.length;d++){var c=a[d],e=l[d];if(null===c||null===e){p.ctatdebug("Internal error: argument lists do not align between received SAI and source SAI");break}e.setValue(c.getValue())}};this.fromString=function(a){a=
m.parse(a);p.fromXML(a)};this.fromXML=function(a){p.ctatdebug("fromXML ()");l=[];a=m.getElementChildren(a);for(var d,c=0;c<a.length;c++){var e=a[c];if("selection"==m.getElementName(e)||"Selection"==m.getElementName(e)){for(var b=m.getElementChildren(e),f=!1,h=0;h<b.length;h++)d=b[h],"value"==m.getElementName(d)&&(d=m.getNodeTextValue(d),1>h?p.setSelectionArray(d):p.appendToSelectionArray(d),f=!0,p.setSelection(d));!1===f&&(d=m.getNodeTextValue(e),p.setSelectionArray(d),p.setSelection(d))}if("action"==
m.getElementName(e)||"Action"==m.getElementName(e)){b=m.getElementChildren(e);f=!1;for(h=0;h<b.length;h++)d=b[h],"value"==m.getElementName(d)&&(d=m.getNodeTextValue(d),1>h?p.setActionArray(d):p.appendToActionArray(d),f=!0,p.setAction(d));!1===f&&(d=m.getNodeTextValue(e),p.setActionArray(d),p.setAction(d))}if("inputArray"==m.getElementName(e)||"value"==m.getElementName(e)||"Input"==m.getElementName(e)){d=m.getElementChildren(e);var g;l=[];b=new CTATHTMLManager;f=new CTATArgument;h=0;l.push(f);for(var n=
0;n<d.length;n++){var q=d[n];"value"==m.getElementName(q)&&(g=m.getElementChildren(q),null!==g?(p.ctatdebug("Parsing SAI input ..."),p.ctatdebug("Childnodes: "+g.length),1===g.length?(g=b.htmlDecode(m.getNodeTextValue(q)),p.ctatdebug("Setting new value to: "+g),f.setValue(g)):(g=b.htmlDecode(m.getNodeTextValue(q)),p.ctatdebug("Setting new value to: "+g),f.setValue(g),f.setName(q.attributes.getNamedItem("name").value),f.setType(q.attributes.getNamedItem("type").value),f.setFormat(q.attributes.getNamedItem("format").value),
h++),1>n?p.setInputArray(g):p.appendToInputArray(g)):(q=b.htmlDecode(m.getNodeTextValue(q)),p.ctatdebug("Setting new value to: "+q),f.setValue(q),1>n?p.setInputArray(q):p.appendToInputArray(q)))}}if("prompt"==m.getElementName(e)||"Prompt"==m.getElementName(e))p.ctatdebug("Parsing prompt ..."),p.setPrompt(m.getNodeTextValue(e))}p.checkDefaultArgument()};this.appendFromElement=function x(a,d,c,e,b){p.ctatdebug("appendFromElement ()");e=String(m.getElementName(d)).toLowerCase();if(e==a||"value"==e)if(e=
m.getElementChildren(d),!Array.isArray(e)||1>e.length)0==b?c.push(m.getNodeTextValue(d)):p.appendToInputArray(m.getNodeTextValue(d));else for(d=0;d<e.length;++d)x(a,e[d],c,d,b)};this.setArrayFromElements=function(a){p.ctatdebug("setArrayFromElements ()");if(!a||!Array.isArray(a)||1>a.length)p.ctatdebug("can't get name: don't know whether selection, action or input");else{var c,e=String(m.getElementName(a[0])).toLowerCase();switch(e){case "selection":p.ctatdebug("Processing selection field ...");d=
...
!1===f&&(d=m.getNodeTextValue(e),p.setSelectionArray(d),p.setSelection(d))}if("action"==m.getElementName(e)||"Action"==m.getElementName(e)){b=e.childNodes;f=!1;for(h=0;h<b.length;h++)d=b[h],"value"==m.getElementName(d)&&(d=m.getNodeTextValue(d),1>h?p.setActionArray(d):p.appendToActionArray(d),f=!0,p.setAction(d));!1===f&&(d=m.getNodeTextValue(e),p.setActionArray(d),p.setAction(d))}if("inputArray"==m.getElementName(e)||"Input"==m.getElementName(e)){d=e.childNodes;l=[];var b=new CTATHTMLManager,f=new CTATArgument,
h=0,g;l.push(f);for(var n=0;n<d.length;n++)if(g=d[n],"value"==m.getElementName(g)){var q=m.getElementChildren(g);null!==q?(p.ctatdebug("Parsing SAI input ..."),p.ctatdebug("Childnodes: "+q.length),1===q.length?(g=b.htmlDecode(m.getNodeTextValue(g)),p.ctatdebug("Setting new value to: "+g),f.setValue(g)):(g=b.htmlDecode(m.getNodeTextValue(g)),p.ctatdebug("Setting new value to: "+g),f.setValue(g),f.setName(m.getElementAttr("name")),f.setType(m.getElementAttr("type")),f.setFormat(m.getElementAttr("format")),
h++)):(g=b.htmlDecode(m.getNodeTextValue(g)),p.ctatdebug("Setting new value to: "+g),f.setValue(g));1>n?p.setInputArray(g):p.appendToInputArray(g)}}if("prompt"==m.getElementName(e)||"Prompt"==m.getElementName(e))p.ctatdebug("Parsing prompt ..."),p.setPrompt(m.getNodeTextValue(e))}p.checkDefaultArgument()};this.toXMLString=function(a){p.ctatdebug("toXMLString ()");return a?p.toLSxmlString():p.toTSxmlString()};this.toLSxmlString=function(){p.ctatdebug("toLSxmlString ()");for(var a="",c=0;c<d.length;c++){var e=
...
"&lt;").replace(/>/g,"&gt;");return b.replace(/("(\\u[a-zA-Z0-9]{4}|\\[^u]|[^\\"])*"(\s*:)?|\b(true|false|null)\b|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)/g,function(e){var c="number";/^"/.test(e)?c=/:$/.test(e)?"key":"string":/true|false/.test(e)?c="boolean":/null/.test(e)&&(c="null");return'<span class="'+c+'">'+e+"</span>"})}};CTATJSON.prototype=Object.create(CTATBase.prototype);CTATJSON.prototype.constructor=CTATJSON;"undefined"!==typeof module&&(module.exports=CTATJSON);var CTATMessage=function(b){function g(d){var c=[],e=a.getElementChildren(d);this.ctatdebug("CTATMessage.parseCustomFields("+a.stringify(d)+"): valueElts.length "+e.length);for(d=0;d<e.length;++d){var b=e[d];"value"!=a.getElementName(b)?console.log("CTATMessage.parseRules(): unexpected element name "+a.getElementName(b)+" at custom_fields["+d+"]"):(b=a.getNodeTextValue(b))&&c.push(b)}return c}function f(d){var c={},e=a.getElementChildren(d);this.ctatdebug("CTATMessage.parseCustomFields("+a.stringify(d)+
"): cfElts.length "+e.length);for(d=0;d<e.length;++d){var b=e[d];if("custom_field"==a.getElementName(b)){for(var f=null,h=null,b=a.getElementChildren(b),g=0,n=0;g<b.length&&2>n;++g){var l=b[g];switch(a.getElementName(l)){case "name":f=a.getNodeTextValue(l);n++;break;case "value":h=a.getNodeTextValue(l),n++}}f&&(c[f]=h?h:"",this.ctatdebug("CTATMessage.parseCustomFields(): result["+f+"]="+c[f]+";"))}}return c}CTATBase.call(this,"CTATMessage","message");CTATMessage.makeTransactionId=function(){return CTATGuid.guid()};
var e=b,c=null,a=null;void 0==b&&(e=null);a="xml"==CTATConfig.parserType?new CTATXML:new CTATJSON;e&&(this.ctatdebug("messageParser "+a+", messageObj "+e),e.children&&this.ctatdebug(e.children));var d="ungraded",h=!1,l=!1,n=new CTATSkillSet,m="",p="",q="",u="",x="",r=!0,y,z=null,B=null,v=null,E=!1;this.setURL=function(a){y=a};this.getURL=function(){return y};this.assignSAI=function(a){l=!0;z=a};this.setTransactionID=function(a){p=a};this.getTransactionID=function(){return p};this.setGradeResult=function(a){d=
a};this.getGradeResult=function(){return d};this.getXMLObject=function(){return e};this.getSkillsObject=function(){return n};this.getCustomFields=function(){return B};this.getRules=function(){return v};this.getSuccessMessage=function(){return q};this.getBuggyMsg=function(){return u};this.getHighlightMsg=function(){return x};this.parse=function(){this.ctatdebug("parse ()");if(null!==e){this.ctatdebug("messageParser: "+a);this.ctatdebug("Root name: "+a.getElementName(e));"tool_message"==a.getElementName(e)?
(this.ctatdebug("Detected tool message"),m="tool_message"):"message"!=a.getElementName(e)?(this.ctatdebug("Detected log message"),h=!0,m=a.getElementName(e)):(this.ctatdebug("Detected regular message"),h=!1,this.parseMessageType());this.parseTransactionID();this.parseSAI();for(var d=a.getElementChildren(e),b=0;b<d.length;b++){var f=d[b];"properties"==a.getElementName(f)&&(ctatdebug("Found a 'properties' element ... "),c=a.getElementChildren(f))}this.ctatdebug("Message "+m+", with transaction id: "+
p)}};this.parseSAI=function(){this.ctatdebug("parseSAI ()");var d="",c="",b="",r="",p=[],w=[],G=[];if("tool_message"==m){this.ctatdebug("Parsing s, a and i");d=a.getElementChildren(e);for(c=0;c<d.length;c++)if(b=d[c],"tool_message"==a.getElementName(b))for(b=a.getElementChildren(b),r=0;r<b.length;r++)p=b[r],"event_descriptor"==a.getElementName(p)&&(z=new CTATSAI,z.fromXMLInternal(p));l=!0}else{if(h){this.ctatdebug("isLogMessage ...");for(var I=a.getElementChildren(e),E=0;E<I.length;E++){var Q=I[E];
if("event_descriptor"==a.getElementName(Q))for(var Q=a.getElementChildren(Q),L=0;L<Q.length;L++){var D=Q[L];"selection"==a.getElementName(D)&&(d=a.getNodeTextValue(D),p.push(D));"action"==a.getElementName(D)&&(c=a.getNodeTextValue(D),w.push(D));"input"==a.getElementName(D)&&(b=a.getNodeTextValue(D),G.push(D));"prompt"==a.getElementName(D)&&(r=a.getNodeTextValue(D))}}}else for(this.ctatdebug("!isLogMessage ..."),I=a.getElementChildren(e),E=0;E<I.length;E++)if(Q=I[E],"properties"==a.getElementName(Q))for(Q=
a.getElementChildren(Q),L=0;L<Q.length;L++){var D=Q[L],N=a.getElementName(D);this.ctatdebug("Nodename: "+N);switch(N){case "URL":y=a.getNodeTextValue(D);break;case "Skills":n.parseByValue(D);break;case "SuccessMsg":q=d=a.getNodeTextValue(D);break;case "BuggyMsg":u=a.getNodeTextValue(D);break;case "Selection":d=a.getNodeTextValue(D);p.push(D);break;case "Action":c=a.getNodeTextValue(D);w.push(D);break;case "Input":b=a.getNodeTextValue(D);G.push(D);break;case "prompt":r=a.getNodeTextValue(D);break;
case "HighlightMsgText":x=a.getNodeTextValue(D);break;case "custom_fields":B=f(D);break;case "Rules":v=g(D)}}this.ctatdebug("SAI: "+d+","+c+","+b);""!==d&&null!==d?(z=new CTATSAI(d,c,b,r),z.setArrayFromElements(p),z.setArrayFromElements(w),z.setArrayFromElements(G),l=!0):(this.ctatdebug("No SAI found"),l=!1);this.ctatdebug("parseSAI () done, hassai: "+l+", ("+d+","+c+","+b+","+r+")")}};this.parseTransactionID=function(){this.ctatdebug("parseTransactionID()");if("tool_message"!=m){if(!h)for(var d=
a.getElementChildren(e),c=0;c<d.length;c++){var b=d[c];if("properties"==a.getElementName(b))for(var b=a.getElementChildren(b),f=0;f<b.length;f++){var g=b[f];"transaction_id"==a.getElementName(g)&&(p=a.getNodeTextValue(g))}}this.ctatdebug("parseTransactionID() done, id: "+p)}};this.parseMessageType=function(){this.ctatdebug("parseMessageType()");for(var d=a.getElementChildren(e),c=0;c<d.length;c++){var b=d[c];if("properties"==a.getElementName(b))for(var b=a.getElementChildren(b),f=0;f<b.length;f++){var h=
b[f];"MessageType"==a.getElementName(h)&&(m=a.getNodeTextValue(h))}}this.ctatdebug("parseMessageType() -> "+m)};this.getMessageType=function(){return m};this.getTransactionID=function(){return p};this.getSAI=function(){return l?z:new CTATSAI};this.getSelection=function(){return l?z.getSelection():""};this.getAction=function(){return l?z.getAction():""};this.getInput=function(){return l?z.getInput():""};this.getSelectionArray=function(){return l?z.getSelectionArray():[]};this.getActionArray=function(){return l?
z.getActionArray():[]};this.getInputArray=function(){return l?z.getInputArray():[]};this.getXML=function(){return e};this.getXMLString=function(a){if(e.xml)return e.xml;if(XMLSerializer)return(new XMLSerializer).serializeToString(e);alert("ERROR: Extremely old browser");return""};this.getIndicator=function(){return"AssociatedRules"!=m?"":this.getProperty("Indicator")};this.getIndicatorSub=function(){return"AssociatedRules"!=m?"":this.getProperty("IndicatorSub")};this.setProperty=function(d,e){this.ctatdebug("setProperty ("+
d+","+e+")");if(null!==c)for(var b=0;b<c.length;b++)a.getElementName(c[b]);else this.ctatdebug("Internal error: no messageProperties object available")};this.getProperty=function(d){if(!h)if(null!==c)for(var e=0;e<c.length;e++){var b=c[e];if(a.getElementName(b)==d)return a.getNodeTextValue(b)}else this.ctatdebug("Internal error: no messageProperties object available");return""};this.hasProperty=function(a){a=this.getProperty(a);return!h&&""!==a};this.hasSAI=function(){return l};this.isEndOfTransaction=
...
a);m=a};this.setTransactionId=function(a){if(!E){if(null===a||"undefined"===typeof a||1>a.length)a=CTATMessage.makeTransactionId();this.setProperty(CTATMessage.TRANSACTION_ID_TAG,a)}};this.suppressLogging=function(){r=!1};this.isLoggingSuppressed=function(){return!r};CTATMessage.create=function(a,d){var c=new CTATMessage;c.init(a);return c}};Object.defineProperty(CTATMessage,"MESSAGE_TYPE",{enumerable:!1,configurable:!1,writable:!1,value:"MessageType"});
...
c.student_interface=a.getStudentInterface();c.skills=encodeURIComponent(f.getRevisedSkills(a.getSkills()).toXML());d.setAttribute("data-params",JSON.stringify(c));d.src=e.getURLPrefix()+e.getRelativePath(a.getStudentInterface())+(c.mode?"?MODE="+c.mode:"");return a};this.getRevisedSkills=function(a,d){a.forEach(function(a){n.addSkill(a,d)});return n};this.getNextProblem=function(){f.ctatdebug("getNextProblem(): currentIndex "+f.currentIndex);var a=e.getProblemSets();return 0==a.length?(f.ctatdebug("Error: no problem sets available, trying list of problems directly ..."),
...
this.getAttributeString=function(){var a="";if(!this.isHint())return a;a+='current_hint_number="'+g+'" ';a+='total_hints_available="'+f+'" ';""!==e&&(a+='hint_id="'+e+'" ');return a}};CTATActionEvaluationData.prototype=Object.create(CTATBase.prototype);CTATActionEvaluationData.prototype.constructor=CTATActionEvaluationData;var CTATVariable=function(){this.value=this.name=""};var CTATCurriculumService=function(b){CTATBase.call(this,"CTATCurriculumService","curriculum_service");var g=[],f=this;this.reset=function(){g=[]};this.addVariable=function(e,c){var a=new CTATVariable;a.name=e;a.value=c;g.push(a)};this.sendSummary=function(e){f.ctatdebug("sendSummary ()");var c=e.getXMLObject(),a=c.getElementsByTagName("ProblemSummary"),a=$("<div>").html(a[0].innerHTML).text(),d=CTATConfiguration.getRawFlashVars();e=d.curriculum_service_url;var h=new CTATXML,l=h.parse(a),h=h.getElementAttr(l,
"CompletionStatus");if(e)CTATLMS.is.TutorShop()&&(a=c.getElementsByTagName("ProblemSummaryJSON"),a=a[0].textContent),h&&h.toLowerCase().startsWith("complete")&&(CTATScrim.scrim.nextProblemScrimUp(),b.assignMessageListener(f),b.assignHandler(f)),g=[],this.addVariable("user_guid",d.user_guid),this.addVariable("session_id",d.session_id),this.addVariable("authenticity_token",d.authenticity_token),this.addVariable("school_name",d.school_name),this.addVariable("summary",a),c=d.target_frame,a=d.reuse_swf,
d=d.run_problem_url,this.addVariable("targetFrame",c),this.addVariable("reuseSWF",a),f.ctatdebug("CTATCurriculumService.sendSummary about to send targetFrame = "+c+", reuseSwf "+a+", runProblemUrl "+d),b.send_post_variables(e,g);else if("complete"==h){var n=CTATGlobals.languageManager.getString("CONGRATULATIONS_YOU_ARE_DONE");CTATScrim.scrim.OKScrimUp(n,function(){var a=CTATShellTools.getAllComponents(),d=a.find(function(a){return"CTATHintWindow"===a.getClassName()});d&&d.showFeedback(n);a.forEach(function(a){return a.lock()});
CTATScrim.scrim.scrimDown()})}};this.processOutgoing=function(e){f.ctatdebug('CTATCurriculumService.processOutgoing("'+e+'")')};this.processIncoming=function(e){var c=flashVars.getRawFlashVars().run_problem_url;f.ctatdebug("CTATCurriculumService.processIncoming("+(e?e.substring(0,12)+"...":"")+") parent.location.replace "+parent.location.replace+', runProblemUrl "'+c+'"');if(c&&parent&&parent.location){var a=CTATCommShell.commShell.getLoggingLibrary();a&&a.then(function(){parent.location.replace(c)},
...
n+='<ui_event name="'+a+'">'+d+"</ui_event>";c="<event_descriptor>"+c.toSerializedString();n=n+(c+"</event_descriptor>")+this.createCustomFields(g,f);n+="</tool_message>";b.ctatdebug("messageString = "+n);return n};this.createTutorMessage=function(c,a,d,e,l,n,m,p){b.ctatdebug("createTutorMessage()");var h=new Date;flashVars.getRawFlashVars();var u='<tutor_message context_message_id="'+this.getContextName()+'">';p||(u+=this.makeMetaElement(h));a='<semantic_event transaction_id="'+a+'" name="'+d+'"';
""!==n&&(a+=' subtype="'+n+'"');u+=a+"/>";c="<event_descriptor>"+c.toXMLString(!0);u+=c+"</event_descriptor>";c="<action_evaluation ";e.hasClassification()&&null!=e.getAttributeString()&&(c+=e.getAttributeString());c+=">"+e.getEvaluation()+"</action_evaluation>";u+=c;""!=l&&(u+="<tutor_advice>"+l+"</tutor_advice>");null!=m&&(b.ctatdebug("Adding skills to log message ..."),u+=m.toLogString());u+=this.createCustomFields(g,f);u+="</tutor_message>";b.ctatdebug("messageString = "+u);return u};this.createGenericMessage=
...
"message"==b&&this.processSingleMessage(d,c)};this.processMessageBundle=function(d,c){var b=a.getElementName(d);e.ctatdebug("processMessageBundle ("+b+")");b=a.getElementChildren(d);if(null===b)e.ctatdebug("Error parsing bundle");else{ctatdebug("Processing "+b.length+" objects in bundle");for(var f=0;f<b.length;f++)this.parseElement(b[f])}};this.processSingleMessage=function(h,g){e.ctatdebug("processSingleMessage ("+a.getElementName(h)+")");b.sendToTools(g);g=new CTATMessage(h);var n=g.getProperty("subtype"),
n=!n||/tutor/i.test(n)?"tutor":n;f.updateLastActionTimestamp&&f.updateLastActionTimestamp();var l=a.getElementChildren(h);e.ctatdebug("Generated CTATMessage, now doing regular processing ...");for(var q=0;q<l.length;q++){var u=l[q];if("properties"==a.getElementName(u)){e.ctatdebug("Parsing properties ...");for(var x=a.getElementChildren(u),r=0;r<x.length;r++){var y=x[r];if("MessageType"==a.getElementName(y)){y=a.getNodeTextValue(y);e.ctatdebug("MessageType: "+y);switch(y){case "StateGraph":ctatdebug("Setting inStartState to true");
CTATMessageHandler.inStartState=!0;b.setGotProblemRestoreEnd(!1);this.processStateGraph(u);b.propagateShellEvent("StateGraph",g);break;case "StartProblem":e.ctatdebug("Setting inStartState to true");CTATMessageHandler.inStartState=!0;b.setGotProblemRestoreEnd(!1);this.processStartProblem(x);b.propagateShellEvent("StartProblem",g);break;case "InterfaceIdentification":this.processInterfaceIdentification(x);b.propagateShellEvent("InterfaceIdentification",g);break;case "InterfaceDescription":this.processInterfaceDescription(x);
...
g);break;case "AssociatedRules":e.ctatdebug("Found: AssociatedRules ("+x.length+")");for(var z=y="",B="",v=0;v<x.length;v++){var E=x[v];switch(a.getElementName(E)){case "TutorAdvice":y=a.getNodeTextValue(E);break;case "Actor":n=a.getNodeTextValue(E);break;case "Indicator":z=a.getNodeTextValue(E);break;case "StepID":a.getNodeTextValue(E);break;case "LogAsResult":a.getNodeTextValue(E);break;case "tool_selection":case "StudentSelection":B=a.getNodeTextValue(E);break;case "Skills":e.ctatdebug("Processing skills ..."),
null===CTATSkillSet.skills&&(e.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."),CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(E)}}f.processAssociatedRules(g,z,y,B);b.propagateShellEvent("AssociatedRules",g,n);break;case "BuggyMessage":e.ctatdebug("Found: BuggyMessage");f.processBuggyMessage(g);b.propagateShellEvent("BuggyMessage",g);break;case "SuccessMessage":e.ctatdebug("Found: SuccessMessage");f.processSuccessMessage(g);b.propagateShellEvent("SuccessMessage",
g);break;case "InterfaceAction":e.ctatdebug("Found: InterfaceAction");y=g.getSAI();-1!=y.getAction().indexOf(":")?(e.ctatdebug("Processing and storing timed interface action : "+y.getAction()),z=parseInt(y.getAction().substring(y.getAction().indexOf(":")+1)),e.ctatdebug("Target time: "+z),y.setAction(y.getAction().substring(0,y.getAction().indexOf(":"))),e.ctatdebug("Timing ..."),setTimeout(f.processInterfaceAction,z,g),setTimeout(b.propagateShellEvent,z,"InterfaceAction",g,n)):(e.ctatdebug("Processing regular (non-timed) interface action"),
!0===CTATMessageHandler.inStartState?(e.ctatdebug("inStartState==true => storing for later playback ..."),c.push(g)):(f.processInterfaceAction(g),b.propagateShellEvent("InterfaceAction",g,n)));break;case "UntutoredAction":e.ctatdebug("Found: UntutoredAction");y=g.getSAI();-1!=y.getAction().indexOf(":")?(e.ctatdebug("Processing and storing timed interface action : "+y.getAction()),z=parseInt(y.getAction().substring(y.getAction().indexOf(":")+1)),e.ctatdebug("Target time: "+z),y.setAction(y.getAction().substring(0,
y.getAction().indexOf(":"))),e.ctatdebug("Timing ..."),setTimeout(f.processUntutoredAction,z,g),setTimeout(b.propagateShellEvent,z,"UntutoredAction",g,n)):(e.ctatdebug("Processing regular (non-timed) interface action"),!0===CTATMessageHandler.inStartState?(e.ctatdebug("inStartState==true => storing for later playback ..."),c.push(g)):(f.processUntutoredAction(g),b.propagateShellEvent("UntutoredAction",g,n)));break;case "InterfaceIdentification":e.ctatdebug("Found: InterfaceIdentification");b.propagateShellEvent("InterfaceIdentification",
g);break;case "AuthorModeChange":e.ctatdebug("Found: AuthorModeChange");f.globalReset();b.propagateShellEvent("AuthorModeChange",g);break;case "ResetAction":e.ctatdebug("Found: ResetAction");f.globalReset();b.propagateShellEvent("ResetAction",g);break;case "ShowHintsMessage":e.ctatdebug("Found: ShowHintsMessage");y=!1;z=[];for(B=0;B<x.length;B++)if(v=x[B],"HintsMessage"==a.getElementName(v))for(v=a.getElementChildren(v),E=0;E<v.length;E++){var C=v[E];"value"==a.getElementName(C)&&(z.push(a.getNodeTextValue(C)),
y=!0)}!0===y?f.processHintResponse(g,z):e.ctatdebug("Error: incomplete hint message received");b.propagateShellEvent("ShowHintsMessage",g);break;case "ConfirmDone":e.ctatdebug("Found: ConfirmDone");f.processConfirmDone(g);b.propagateShellEvent("ConfirmDone",g);break;case "VersionInfo":e.ctatdebug("Found: VersionInfo");f.processVersionInfo(x);b.propagateShellEvent("VersionInfo",g);break;case "TutoringServiceAlert":e.ctatdebug("Found: TutoringServiceAlert");f.processTutoringServiceAlert(x);b.propagateShellEvent("TutoringServiceAlert",
g);break;case "TutoringServiceError":y=g.getProperty("Action");e.ctatdebug("Found: TutoringServiceError - actor "+n+", action "+y);var A;y&&(A=CTATSAI.delayedActionRegExp.exec(y))&&2<A.length&&1<A[2]?(z=parseInt(A[2]),g.setProperty("Action",A[1]),e.ctatdebug("Delaying TutoringServiceError by "+z+" ..."),setTimeout(f.processTutoringServiceError,z,g),setTimeout(b.propagateShellEvent,z,"TutoringServiceError",g,n)):(f.processTutoringServiceError(g),b.propagateShellEvent("TutoringServiceError",g,n));break;
...
"ws://"+CTATConfiguration.get("remoteSocketURL")+":"+CTATConfiguration.get("remoteSocketPort"),ctatdebug("closing connection w/ url: "+y),b.closeWSConnection(y,function(){var a=window.frameElement.getAttribute("id");"function"==typeof CustomEvent&&(a=new CustomEvent("refreshIframe",{detail:a}),window.parent.document.dispatchEvent(a))},"interfaceReboot"));break;case "NoOp":n=g&&g.getTransactionID();l=g&&g.getSAI();ctatdebug("NoOp transactionID "+n+", SAI "+l);return}(y=/student[0-9]+/i.exec(n))&&y[0]==
n&&f.forwardToTutor(g)}}}}};this.processStateGraph=function(d){e.ctatdebug("processStateGraph ()");if(void 0===d||null===d)e.ctatdebug("Error: state graph property list is undefined");else if(e.ctatdebug("Processing node: "+d.nodeName),null===a.getElementChildren(d))e.ctatdebug("Error: state graph property list is undefined");else{d=a.getElementChildren(d);for(var c=0;c<d.length;c++){var b=d[c],g=a.getElementName(b),h=a.getNodeTextValue(b);e.ctatdebug("State graph attribute: "+g+" = "+h);"suppressStudentFeedback"==
g&&(CTATGlobals.suppressStudentFeedback="false"==h?!1:!0);"confirmDone"==g&&(e.ctatdebug("Confirm done: "+h),CTATGlobals.confirmDone="true"==h?!0:!1);"Skills"==g&&(null===CTATSkillSet.skills&&(CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(b),f.updateSkillWindow())}}};this.processStartProblem=function(a){e.ctatdebug("processStartProblem ()");f.processStartProblem()};this.processInterfaceIdentification=function(a){};this.processInterfaceDescription=function(d){e.ctatdebug("processInterfaceDescription ("+
d.length+")");for(var c="Unknown",b="Unknown",f=null,g=0;g<d.length;g++){var h=d[g];e.ctatdebug("Inspecting element: "+a.getElementName(h));"WidgetType"==a.getElementName(h)&&(e.ctatdebug("Widget type: "+a.getNodeTextValue(h)),c=a.getNodeTextValue(h));"CommName"==a.getElementName(h)&&(e.ctatdebug("Instance name: "+a.getNodeTextValue(h)),b=a.getNodeTextValue(h));if("serialized"==a.getElementName(h)){e.ctatdebug("Prepareing to de-serialize component ...");for(var l=a.getElementChildren(h),r=0;r<l.length;r++){var y=
l[r];-1!=a.getElementName(y).indexOf("CTAT")&&(f=y)}}"interface"==a.getElementName(h)&&(e.ctatdebug("Storing interface for post start-state reconstruction ..."),CTATGlobals.interfaceElement=h);"script"==a.getElementName(h)&&(e.ctatdebug("Storing and loading main javascript code as defined by the BRD ..."),scriptElement=a.getNodeTextValue(h))}null!==f?this.deserializeComponent(c,b,f):e.ctatdebug("Error: unable to find CTAT serialization point of attachement");e.ctatdebug("processInterfaceDescription () done")};
this.deserializeComponent=function(d,c,b){e.ctatdebug("deserializeComponent ("+d+","+c+")");if(!0===CTATGlobals.ignoreInterfaceDescriptions)e.ctatdebug("ignoreInterfaceDescriptions==true");else if(null===a.getElementAttr(b,"x"))e.ctatdebug("Warning: this component does not have x,y information. Probably an older component");else{var f=a.getElementAttr(b,"x"),g=a.getElementAttr(b,"y"),h=a.getElementAttr(b,"width"),n=a.getElementAttr(b,"height"),l=a.getElementAttr(b,"tabIndex"),m=a.getElementAttr(b,
"zIndex");null===l&&(l=-1);null===m&&(m=0);var z=new CTATComponentDescription;z.type=d;z.name=c;z.x=Math.floor(f);z.y=Math.floor(g);z.tabIndex=l;z.zIndex=m;z.width=Math.floor(h);z.height=Math.floor(n);CTATShellTools.registerComponentDescription(z);b=a.getElementChildren(b);for(f=0;f<b.length;f++){g=b[f];a.getElementName(g);if("Parameters"==a.getElementName(g))for(this.ctatdebug("Processing component parameters ..."),h=a.getElementChildren(g)[0],h=a.getElementChildren(h),n=0;n<h.length;n++){var B=
h[n];if("CTATComponentParameter"==a.getElementName(B)){this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");for(var m=l=void 0,B=a.getElementChildren(B),v=0;v<B.length;v++){var E=B[v];"name"==a.getElementName(E)&&(this.ctatdebug("Found parameter name: "+a.getNodeTextValue(E)),l=a.getNodeTextValue(E));"value"==a.getElementName(E)&&(this.ctatdebug("Found parameter value: "+a.getNodeTextValue(E)),m=a.getNodeTextValue(E).trim())}this.ctatdebug("Parameter name: "+l+", value: "+
m);void 0!==l&&(z.params[l]=m,"group"==l&&(z.groupName=m))}}if("Styles"==a.getElementName(g))for(this.ctatdebug("Processing component styles ..."),g=a.getElementChildren(g)[0],g=a.getElementChildren(g),h=0;h<g.length;h++)if(m=g[h],"CTATStyleProperty"==a.getElementName(m)){this.ctatdebug("Processing style property (CTATStyleProperty) ...");l=n="";m=a.getElementChildren(m);for(B=0;B<m.length;B++)v=m[B],"name"==a.getElementName(v)&&(n=a.getNodeTextValue(v)),"value"==a.getElementName(v)&&(l=a.getNodeTextValue(v).trim());
this.ctatdebug("Style (name: "+n+", value: "+l+")");""!==n&&(z.styles[n]=l)}}e.ctatdebug("deserializeComponent ("+d+","+c+") done")}};this.processStartStateActions=function(){e.ctatdebug("processStartStateActions ("+c.length+")");if(0===c.length)e.ctatdebug("No start state messages, bump");else if(0<CTATMessageHandler.startStateHandlers.length)for(var a=0;a<CTATMessageHandler.startStateHandlers.length;a++)CTATMessageHandler.startStateHandlers[a].processStartStateActions(c);else{for(var a=g(),d=0;d<
...
!function(){function b(c){var a;a=c;if(e[a])a=e[a];else{for(var d=a,h,g=[],n=0;d;){if(null!==(h=f.text.exec(d)))g.push(h[0]);else if(null!==(h=f.modulo.exec(d)))g.push("%");else if(null!==(h=f.placeholder.exec(d))){if(h[2]){var n=n|1,m=[],p=h[2],q;if(null!==(q=f.key.exec(p)))for(m.push(q[1]);""!==(p=p.substring(q[0].length));)if(null!==(q=f.key_access.exec(p)))m.push(q[1]);else if(null!==(q=f.index_access.exec(p)))m.push(q[1]);else throw new SyntaxError("[sprintf] failed to parse named argument key");else throw new SyntaxError("[sprintf] failed to parse named argument key");
h[2]=m}else n|=2;if(3===n)throw Error("[sprintf] mixing positional and named placeholders is not (yet) supported");g.push({placeholder:h[0],param_no:h[1],keys:h[2],sign:h[3],pad_char:h[4],align:h[5],width:h[6],precision:h[7],type:h[8]})}else throw new SyntaxError("[sprintf] unexpected placeholder");d=d.substring(h[0].length)}a=e[a]=g}d=arguments;h=1;for(var g=a.length,m="",u,x,r,y,p=0;p<g;p++)if("string"===typeof a[p])m+=a[p];else if("object"===typeof a[p]){q=a[p];if(q.keys)for(n=d[h],u=0;u<q.keys.length;u++){if(void 0==
n)throw Error(b('[sprintf] Cannot access property "%s" of undefined value "%s"',q.keys[u],q.keys[u-1]));n=n[q.keys[u]]}else n=q.param_no?d[q.param_no]:d[h++];f.not_type.test(q.type)&&f.not_primitive.test(q.type)&&n instanceof Function&&(n=n());if(f.numeric_arg.test(q.type)&&"number"!==typeof n&&isNaN(n))throw new TypeError(b("[sprintf] expecting number but found %T",n));f.number.test(q.type)&&(r=0<=n);switch(q.type){case "b":n=parseInt(n,10).toString(2);break;case "c":n=String.fromCharCode(parseInt(n,
10));break;case "d":case "i":n=parseInt(n,10);break;case "j":n=JSON.stringify(n,null,q.width?parseInt(q.width):0);break;case "e":n=q.precision?parseFloat(n).toExponential(q.precision):parseFloat(n).toExponential();break;case "f":n=q.precision?parseFloat(n).toFixed(q.precision):parseFloat(n);break;case "g":n=q.precision?String(Number(n.toPrecision(q.precision))):parseFloat(n);break;case "o":n=(parseInt(n,10)>>>0).toString(8);break;case "s":n=String(n);n=q.precision?n.substring(0,q.precision):n;break;
case "t":n=String(!!n);n=q.precision?n.substring(0,q.precision):n;break;case "T":n=Object.prototype.toString.call(n).slice(8,-1).toLowerCase();n=q.precision?n.substring(0,q.precision):n;break;case "u":n=parseInt(n,10)>>>0;break;case "v":n=n.valueOf();n=q.precision?n.substring(0,q.precision):n;break;case "x":n=(parseInt(n,10)>>>0).toString(16);break;case "X":n=(parseInt(n,10)>>>0).toString(16).toUpperCase()}f.json.test(q.type)?m+=n:(!f.number.test(q.type)||r&&!q.sign?y="":(y=r?"+":"-",n=n.toString().replace(f.sign,
"")),u=q.pad_char?"0"===q.pad_char?"0":q.pad_char.charAt(1):" ",x=q.width-(y+n).length,x=q.width?0<x?u.repeat(x):"":"",m+=q.align?y+n+x:"0"===u?y+x+n:x+y+n)}return m}function g(c,a){return b.apply(null,[c].concat(a||[]))}var f={not_string:/[^s]/,not_bool:/[^t]/,not_type:/[^T]/,not_primitive:/[^v]/,number:/[diefg]/,numeric_arg:/[bcdiefguxX]/,json:/[j]/,not_json:/[^j]/,text:/^[^\x25]+/,modulo:/^\x25{2}/,placeholder:/^\x25(?:([1-9]\d*)\$|\(([^)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-gijostTuvxX])/,
key:/^([a-z_][a-z_\d]*)/i,key_access:/^\.([a-z_][a-z_\d]*)/i,index_access:/^\[(\d+)\]/,sign:/^[+-]/},e=Object.create(null);"undefined"!==typeof exports&&(exports.sprintf=b,exports.vsprintf=g);"undefined"!==typeof window&&(window.sprintf=b,window.vsprintf=g,"function"===typeof define&&define.amd&&define(function(){return{sprintf:b,vsprintf:g}}))}();var CTATTransactionListener=function(b){function g(){if("undefined"!=typeof TransactionMailerUsers&&"function"==typeof TransactionMailerUsers.create){var a=TransactionMailerUsers.create("Assets",m,CTATConfiguration.get("process_detectors_url"),CTATConfiguration.get("authenticity_token"),CTATConfiguration.get("detectors"),CTATConfiguration.get("provider_key"),JSON.stringify(CTAT.ToolTutor.tutor.getProblemSummary().getSkills().toJSON("pSummarySkills")));try{return p=a}catch(z){return console.trace("Error creating transaction mailer: "+
z),p=null}}}function f(a){return a&&"function"==typeof a.getTransactionID?a.getTransactionID():null}function e(a){n.ctatdebug("formatTimeStamp ("+a+")");return sprintf("%04d-%02d-%02d %02d:%02d:%02d.%03d UTC",a.getUTCFullYear(),a.getUTCMonth()+1,a.getUTCDate(),a.getUTCHours(),a.getUTCMinutes(),a.getUTCSeconds(),a.getUTCMilliseconds())}function c(a,d){for(var c,e,b=1;;++b){var f=d+"_type"+b,g=d+"_name"+b;c=CTATConfiguration.get(f);e=CTATConfiguration.get(g);if(!c||!e)break;a[f]=c;a[g]=e}1==b&&(c=CTATConfiguration.get(d+
"_type"),e=CTATConfiguration.get(d+"_name"),a[f]=c?c:"",a[g]=e?e:"");return a}function a(){n.ctatdebug("CTATTransactionListener.createContextMessage()");var a={},d=new Date;n.ctatdebug("TX.makeMetaElement ()");var b={};b.date_time=e(d);b.session_id=CTATConfiguration.get("session_id");b.user_guid=CTATConfiguration.get("user_guid");a.meta=b;a.context={};d=a.context;b=CTATLogMessageBuilder.contextGUID;if(!b)throw Error("Context message ID not yet defined");d.context_message_id=b;d=a.context;b=CTATConfiguration.get("class_name");
...
d.problem_context=prop?prop:"";prop=CTATConfiguration.get("problem_tutorflag");d.problem_tutorFlag=prop?prop:"";c(d,"study_condition");var d=a.context,b=0,f=CTATConfiguration.getCustomFields();if(f){d.custom_fields={};for(var g in f)f.hasOwnProperty(g)&&(d.custom_fields[g]=f[g],++b)}n.ctatdebug("CTATTransactionListener.createCustomFields() nAdded "+b+", cfs "+f);return a}function d(a,d){if(a&&"function"==typeof a.toLowerCase&&0<=a.toLowerCase().indexOf("hint"))return!0;if(!d)return!1;if(0<=d.getMessageType().toLowerCase().indexOf("hint"))return!0;
var c=d.getSelection().toLowerCase();return 0<=d.getAction().toLowerCase().indexOf("buttonpress")&&(0<=c.indexOf("hint")||0<=c.indexOf("help"))}function h(a,d){var c=a.getProperty(d),e=c?c.split(CTATTransactionListener.valueDelimiter):[];n.ctatdebug("CTATTransactionListener.getPropertyAsArray("+d+") withValues "+c+", result "+e);return e}function l(a,d){for(var c=h(a,d),e="",b=0;b<c.length;++b)e+=c[b];n.ctatdebug("CTATTransactionListener.getProperty("+d+") valueElts "+c+", result "+e);return e}CTATBase.call(this,
"CTATTransactionListener","");var n=this,m=b,p=null,q=null,u={},x=0,r=CTATConfig.parserType_is_XML()?new CTATXML:new CTATJSON;this.getMailer=function(){return p};this.onmessage=function(a){n.ctatdebug("CTATTransactionListener.onmessage("+a.toString()+")");(a=a.data&&3<=a.data.length?new CTATSAI(a.data[0],a.data[1],a.data[2]):null)&&CTATCommShell.shell.processComponentAction(a,!1,!0,null,"ATTEMPT","Detector")};p||(p=g());this.isReady=function(){return null!=n.mailerProxy};this.toString=function(){return"transactions sent to ["+
n.process_transactions_url+":]"};this.processCommShellEvent=function(c,b,g){n.ctatdebug("CTATTransactionListener.processCommShellEvent("+c+", "+b+", "+g+")");try{var m=null;switch(c){case "InterfaceAction":case "AssociatedRules":case "UntutoredAction":case "NextPressed":case "PreviousPressed":var y=b;b&&b.constructor!=CTATMessage&&(y=b.constructor!=Element?r.parse(y):y,y=new CTATMessage(y));n.ctatdebug("CTATTransactionListener.makeOrCompleteTransaction("+c+") pointer "+n+", problemInfo "+q);var z=
b=null,B=!1;if(z=f(y)){!q&&(q=a());var F,K;b:switch(c){case "UntutoredAction":K=!1;break b;case "InterfaceAction":K="tutor-performed"!=l(y,"subtype").toLowerCase();break b;default:K=!0}if(F=!(B=!K)){var H;K=z;var w=u[K];w?(delete u[K],--x,n.ctatdebug("CTATTransactionListener.removeIncompleteTransaction("+K+") count now "+x),H=w):H=null;F=(b=H)&&(B=!0)}F||(b={meta:q.meta,context:q.context});switch(c){case "AssociatedRules":case "NextPressed":case "PreviousPressed":g=b;g.tutor_data&&console.log("Warning: CTATTransactionListener.addTutorInfo("+
...
var G=g.tutor_data;F=[];var I=CTAT.ToolTutor.tutor&&CTAT.ToolTutor.tutor.getProblemSummary()?CTAT.ToolTutor.tutor.getProblemSummary().getSkills():null,S=y.getSkillsObject().getSkillSet();for(H=0;H<S.length;++H){var Q=S[H],L=CTATSkillSet.skills?CTATSkillSet.skills.getSkill(Q.getSkillName()):null;if(L){w={};w.name=L.getSkillName();w.category=L.getCategory();var D=null==w.category||""==w.category.trim()?w.name:w.name+" "+w.category,N=I?I.getSkill(D):null,P;N?(w.pKnown=isNaN(P=N.getPKnown())?"":P,w.pGuess=
isNaN(P=N.getPGuess())?"":P,w.pSlip=isNaN(P=N.getPSlip())?"":P,w.pLearn=isNaN(P=N.getPLearn())?"":P,w.history=isNaN(P=N.getHistory())?"":P,w.opportunityCount=isNaN(P=N.getOpportunityCount())?"":P):(w.pKnown=isNaN(P=L.getPKnown())?"":P,w.pGuess=isNaN(P=L.getPGuess())?"":P,w.pSlip=isNaN(P=L.getPSlip())?"":P,w.pLearn=isNaN(P=L.getPLearn())?"":P);n.ctatdebug("CTATTransactionListener.createSkills() ssSk "+L+", tracerSk "+N+", skElt "+w);F.push(w)}}G.skills=F;g.tutor_data.step_id=l(y,"StepID");g.tutor_data.rule_names=
h(y,"Rules");var V=g.tutor_data,R=y.getCustomFields();n.ctatdebug("CTATTransactionListener.createCustomFields() result "+R);V.custom_fields=R;break;default:b.meta.date_time=e(new Date);G=b;if(!(G.transaction_id=f(y)))throw Error("Message has no transaction_id: eventType "+c+", msg\n  "+y);G.semantic_event="UntutoredAction"==c?"UNTUTORED-ACTION":d(c,y)?"HINT-REQUEST-HINTS":"ATTEMPT-RESULT";G.actor=g?g:"student";G.tool_data&&console.log("Warning: CTATTransactionListener.addToolInfo("+c+") tx has tool_data with time "+
G.tool_data.tool_event_time);G.tool_data={};G.tool_data.tool_event_time=e(new Date);G.tool_data.selection=l(y,"Selection");G.tool_data.action=l(y,"Action");G.tool_data.input=l(y,"Input")}var T;if(B)T=b;else{var G=z,O=u[G];O&&(console.log("Warning: CTATTransactionListener.storeIncompleteTransaction() found tx with ID "+G,O),--x);u[G]=b;++x;n.ctatdebug("CTATTransactionListener.storeIncompleteTransaction("+G+") count now "+x);T=null}m=T}else m=null;break;case "StateGraph":case "StartProblem":q=a();break;
case "ProblemRestoreEnd":n.initializing=!1}m&&!n.initializing&&p.sendTransaction(m)}catch(U){console.log("Error in CTATTransactionListener.processCommShellEvent("+c+"): "+U,U.stack)}};ctatdebug("**<end of CTATTransactionListener constructor, process_transactions_url "+m+", mailerProxy "+p)};Object.defineProperty(CTATTransactionListener,"scriptParam",{enumerable:!1,configurable:!1,writable:!1,value:"process_transactions_url"});
...
a.setText(this.label)};this.processComponentAction=function(d,c,e,f,g,h){a.ctatdebug("processComponentAction("+d.getName()+" -> "+d.getSelection()+","+d.getAction()+","+d.getInput()+")");this.showFeedback("");e=CTATGuid.guid();null!=commLoggingLibrary?x&&(a.ctatdebug("We're not in the start state, logging the action ..."),"scrim"==d.getSelection()?ctatdebug("Not logging any scrim actions (for now)"):void 0!=g?commLoggingLibrary.logSemanticEvent(e,d,g,"","","",h):"hint"==d.getSelection()||"null.nextButton"==
d.getSelection()||"null.previousButton"==d.getSelection()?commLoggingLibrary.logSemanticEvent(e,d,"HINT_REQUEST","","","",h):commLoggingLibrary.logSemanticEvent(e,d,"ATTEMPT","","","",h)):this.ctatdebug("Info: no logging library available!");g=new CTATTutoringServiceMessageBuilder;!1!==c&&c!==CTAT.Component.Base.Tutorable.Options.TutorComponent.DO_NOT_TUTOR?(d=g.createInterfaceActionMessage(e,d),a.propagateShellEvent("InterfaceAction",d)):(d=g.createUntutoredActionMessage(e,d),a.propagateShellEvent("UntutoredAction",
d));b.sendXML(d);CTAT.SAI&&"function"==typeof CTAT.SAI.storeForReplay&&CTAT.SAI.storeForReplay(d)};this.onEditSuccess=function(d){a.ctatdebug("onEditSuccess ("+d+")");null==nameTranslator?a.ctatdebug("Error: CTAT name translator not available"):-1!=d.indexOf(":")?(a.ctatdebug("Bump"),a.showFeedback("You're asking for a hint for multiple cells, please select only a single cell.")):(d=nameTranslator.translateToCTAT(d),a.ctatdebug("Info A1 notiation mapped to (if needed): "+d),d=new CTATSAI("hint","ButtonPressed",
...
var c=new CTATSAI("ConfirmDone","ButtonPressed","no");commLoggingLibrary.logSemanticEvent(d,c,"ATTEMPT","")};this.processGetURL=function(d){a.ctatdebug("processGetURL()");-1!=d.getURL().indexOf("http://")?b.retrieveFile(d.getURL().substring(7),a.processClientBRDLoad):b.retrieveFile(d.getURL(),a.processClientBRDLoad)};this.processClientBRDLoad=function(d){a.ctatdebug("processClientBRDLoad()");var c=b.getURL();b.sendXML("<message><verb>NotePropertySet</verb><properties><MessageType>GetURLResponse</MessageType><URL><![CDATA[ "+
c+" ]]\x3e</URL><content><![CDATA[ "+window.btoa(d)+" ]]\x3e</content></properties></message>")};this.processCorrectAction=function(d){a.ctatdebug("processCorrectAction()");d.setGradeResult("correct");a.clearFeedbackComponents();null!=q&&(ctatdebug("Calling custom grading processor ..."),q("CORRECT",d));var c=d.getSelection();if(l[c]&&null!=n)n("CORRECT",d),this.propagateShellEvent("CORRECT",d);else{var e=CTATShellTools.findComponent(c);if(null!=e)for(ctatdebug("Processing "+e.length+" components ..."),
c=0;c<e.length;c++)ctatdebug("Check "+e[c].getName()),e[c]?e[c].setCorrect&&e[c].setCorrect(d):a.ctatdebug("Internal error, component pointer is null");else a.ctatdebug("Error: component is null for selection "+c)}};this.processInCorrectAction=function(d){a.ctatdebug("processInCorrectAction()");d.setGradeResult("incorrect");null!=q&&(ctatdebug("Calling custom grading processor ..."),q("INCORRECT",d));var c=d.getSelection();if(l[c]&&null!=n)n("INCORRECT",d);else{var e=CTATShellTools.findComponent(c);
if(null!==e)for(c=0;c<e.length;c++)ctatdebug("Calling setIncorrect on component ("+e[c].getClassName()+")..."),e[c].setIncorrect&&e[c].setIncorrect(d);else a.ctatdebug("Error: component is null for selection "+c)}};this.processHighlightMsg=function(d){a.ctatdebug("processHighlightMsg()");var c=d.getSelection(),e=CTATShellTools.findComponent(c);if(null!=e)for(c=0;c<e.length;c++)"function"==typeof e[c].setHintHighlight&&e[c].setHintHighlight(!0,d);else a.ctatdebug("Error: component is null for selection "+
c);this.showFeedback(d.getHighlightMsg())};this.processUnHighlightMsg=function(d){a.ctatdebug("processUnHighlightMsg()");var c=d.getSelection(),e=CTATShellTools.findComponent(c);if(null!=e)for(c=0;c<e.length;c++)"function"==typeof e[c].setHintHighlight&&e[c].setHintHighlight(!1,null,d);else a.ctatdebug("Error: component is null for selection "+c)};this.processAssociatedRules=function(d,c,f,g){var h="";a.ctatdebug("processAssociatedRules()");if(0==commMessageHandler.getInStartState()){logHintSAI=d.getSAI();
var n,l=new CTATActionEvaluationData("");a.ctatdebug("Found tutor advice: "+f);"Hint"==c||"HintWindow"==c?(ctatdebug("Preparing log message to indicate a hint response","commShell"),l.setCurrentHintNumber(hintIndex+1),l.setTotalHintsAvailable(hints.length),l.setEvaluation("HINT"),n="HINT_MSG",hints[hintIndex]&&(f=hints[hintIndex])):("Correct"==d.getIndicator()?l.setEvaluation("CORRECT"):l.setEvaluation("INCORRECT"),n="RESULT");ctatdebug("Adding custom field names ...");var m=[],r=[];m.push("step_id");
r.push(d.getProperty("StepID"));var p=d.getInput();ctatdebug("CTATCommShell.processAssociatedRules() tutorInput: "+p);p&&(m.push("tutor_input"),r.push(p.toString()));if(p=d.getRules())m.push("rule_names"),r.push(p.toString());var p=d.getCustomFields(),y;for(y in p)m.push(y),r.push(p[y]);y=d.getSkillsObject();a.updateSkillWindow(y);ctatdebug("Sending log message ...");null!=commLoggingLibrary?x?h=commLoggingLibrary.logTutorResponse(d.getTransactionID(),logHintSAI,n,"",l,f,y,m,r):d.suppressLogging():
this.ctatdebug("Info: no logging library available!");"done"==logHintSAI.getSelection()&&"ButtonPressed"==logHintSAI.getAction()&&"Correct"==d.getIndicator()&&(n=e.createProblemSummaryRequestMessage(),b.sendXML(n,!1))}else a.updateSkillWindow(null);if((g=g&&CTATShellTools.findComponent(g))&&g.length)for(n=0;n<g.length;n++)ctatdebug("Calling processAssociatedRules on component ("+g[n].getClassName()+")..."),g[n].processAssociatedRules&&g[n].processAssociatedRules(d,c,f,h);a.ctatdebug("processAssociatedRules() done");
return h};this.processBuggyMessage=function(d){a.ctatdebug("processBuggyMessage()");this.showFeedback(d.getBuggyMsg())};this.processSuccessMessage=function(d){a.ctatdebug("processSuccessMessage()");this.showFeedback(d.getSuccessMessage())};this.processUntutoredAction=function(d,c){a.processInterfaceAction(d,c)};this.processInterfaceAction=function(d,c){a.ctatdebug('CTATCommShell.processInterfaceAction ("'+d.getMessageType()+'")');var e=d.getProperty("trigger"),e=d.getProperty("subtype")||(e&&"data"==
e.toLowerCase()?"tutor-performed":"");null!=commLoggingLibrary?x&&commLoggingLibrary.logSemanticEvent(d.getTransactionID(),d.getSAI(),"ATTEMPT",e):this.ctatdebug("Info: no logging library available!");if("root"==d.getSelection()||"_root"==d.getSelection()){a.ctatdebug("Info: selection is 'root', we'll call the function straight up ...");for(var e=[window,CTATCommShell.commShell],b=d.getAction(),f=d.getInput(),g=0;g<e.length&&"function"!=typeof e[g][b];++g);if(g>=e.length)a.ctatdebug("Internal error: unable to find function: "+
b);else{a.ctatdebug("Calling as: "+b+"("+f+")");try{e[g][b](f)}catch(A){a.ctatdebug("Internal error: unable to execute function: "+A.message)}}}else if(e=CTATShellTools.findComponent(d.getSelection()),null===e)a.ctatdebug("Internal error: unable to find pointer to component object");else if(0==e.length)a.ctatdebug("Error: no component found to call interface action on");else{b=e.length;a.ctatdebug("Call the action on the component(s) -> ("+b+")...");for(f=0;f<b;f++)if(a.ctatdebug("About to call "+
d.getAction()+" ("+d.getInput()+") on: "+d.getSelection()),g=e[f],"function"==typeof g.executeSAI&&g.executeSAI(d),a.ctatdebug("Method executed, continuing with post-processing ..."),1==commMessageHandler.getInStartState()){var h=d.getAction()||"";/^(updatetext|updatecombobox|updatecheckbox)/i.test(h)&&!g.getDivWrap().className.includes("CTATTextField")&&g.setEnabled(!c)}a.ctatdebug("processInterfaceAction() Done")}};this.removeComponent=function(a){CTATTutor.removeComponent(a)};this.processInterfaceIdentification=
function(d){a.ctatdebug("processInterfaceIdentification()")};this.processAuthorModeChange=function(d){a.ctatdebug("processAuthorModeChange()")};this.processShowHintsMessage=function(d){a.ctatdebug("processShowHintsMessage()")};this.processConfirmDone=function(d){a.ctatdebug("processConfirmDone()")};this.processVersionInfo=function(d){a.ctatdebug("processVersionInfo()")};this.updateLastActionTimestamp=function(){g&&g.updateLastActionTimestamp()};this.processTutoringServiceAlert=function(d){a.ctatdebug("processTutoringServiceAlert()");
for(var c="",e=0;e<d.length;e++){var b=d[e];"ErrorType"==h.getElementName(b)&&h.getNodeTextValue(b);"Details"==h.getElementName(b)&&(c=h.getNodeTextValue(b))}CTATScrim.scrim.scrimUp(c)};this.processTutoringServiceError=function(d){a.ctatdebug("processTutoringServiceError()");var c=d.getProperty("ErrorType");d=d.getProperty("Details");CTATScrim.scrim.scrimDown();CTATScrim.scrim.errorScrimUp(c+" - "+d)};this.processProblemSummaryResponse=function(c,e){a.ctatdebug("processProblemSummaryResponse() iscb "+
e);if(commLoggingLibrary&&!e)commLoggingLibrary.then(a.processProblemSummaryResponse(c,!0));else if(CTATLMS.processProblemSummary&&CTATLMS.processProblemSummary(c.getXMLObject()),CTATLMS.closeLMSConnection&&CTATLMS.closeLMSConnection(),null!=p){var b=c.getXMLObject(),g=b.getElementsByTagName("ProblemSummary"),h=b.getElementsByTagName("cmi.core.lesson_status"),n=b.getElementsByTagName("cmi.core.score.raw"),l=b.getElementsByTagName("cmi.core.exit"),b=b.getElementsByTagName("cmi.core.session_time"),
g=$("<div>").html(g[0].innerHTML).text(),h="<cmi.core.lesson_status>"+$("<div>").html(h[0].innerHTML).text()+"</cmi.core.lesson_status>",n="<cmi.core.score.raw>"+$("<div>").html(n[0].innerHTML).text()+"</cmi.core.score.raw>",l="<cmi.core.exit>"+$("<div>").html(l[0].innerHTML).text()+"</cmi.core.exit>",b="<cmi.core.session_time>"+$("<div>").html(b[0].innerHTML).text()+"</cmi.core.session_time>";p(g,"<scorm>"+h+n+l+b+"</scorm>");p=null}else l=new CTATXML,null!=d?d(l.xmlToString(c.getXMLObject()),f.sendSummary.bind(f,
c)):f.sendSummary(c)};this.setGotProblemRestoreEnd=function(a){x=a};this.getGotProblemRestoreEnd=function(){return x};this.processProblemRestoreEnd=function(d){a.ctatdebug("processProblemRestoreEnd() scrimIsUp "+scrimIsUp);x=!0;a.getCommLibrary()&&a.getCommLibrary().sendTutorReady();a.hasTutorShopCable()||CTATScrim.scrim.scrimDown()};this.hasTutorShopCable=function(){var a=CTATConfiguration.getCustomFields();return CTATLMS.is.TutorShop()&&a&&a["Team ID"]};this.clearFeedbackComponents=function(){a.ctatdebug("clearFeedbackComponents ()");
CTATShellTools.showHints(null)};this.processHintResponse=function(d,c){a.ctatdebug("processHintResponse()");unhighlightall();CTATShellTools.showHints(c);var e=d.getSAI();if(null!=e)if(e=e.getSelection(),null!=e)if(a.ctatdebug("Highlighting selection for hint: "+e),e=CTATShellTools.findComponent(e),null!=e)for(var b=0;b<e.length;b++)1==CTATCommShell.detailedFeedback&&"function"==typeof e[b].setHintHighlight&&e[b].setHintHighlight(!0,d);else a.ctatdebug("Unable to find component name in list: "+e);
...
c));else a.ctatdebug("Unable to find component name in list: "+e)};this.globalReset=function(){a.ctatdebug("globalReset ()");CTATMessageHandler.scriptElement=""};this.nextProblem=function(d){a.ctatdebug("nextProblem ()");if(CTATGlobalFunctions.isBlank(d))a.ctatdebug("Message is blank, requesting next problem ..."),d=flashVars.getRawFlashVars().run_problem_url,b.send(d);else{a.ctatdebug("Message contains html data, writing ...");try{document.close()}catch(y){alert("Error closing document: "+y.message)}try{document.write(d)}catch(y){alert("Error writing document: "+
y.message)}}};this.updateSkillWindow=function(d){a.ctatdebug("updateSkillWindow()");CTATSkillSet.skills.untouchSkills();var c=CTATShellTools.findComponentByClass("CTATSkillWindow");null!==c?null!=d?c.updateSkillSet(d):c.drawComponent():a.ctatdebug("Info: no skill window available")};this.processComponentFocus=function(d){a.ctatdebug("processComponentFocus("+d.getName()+","+d.getClassName()+")");"CTATTextInput"==d.getClassName()||"CTATTextField"==d.getClassName()||"CTATTextArea"==d.getClassName()?
(CTATGlobals.selectedTextInput=d,null!==mobileAPI&&!0===mobileAPI.getEnabled()&&mobileAPI.processTextFocus(d.getX(),d.getY(),d.getWidth(),d.getHeight())):CTATGlobals.selectedTextInput=null;a.ctatdebug("processComponentFocus() done")};this.showFeedback=function(d){null!=d&&void 0!=d&&/\S/.test(d)&&" "!=d?(a.ctatdebug("showFeedback("+d+") -> l: "+d.length),CTATShellTools.showFeedback(d),null!=m&&m(d)):a.ctatdebug("showFeedback(): False alarm: empty message. This can happen when the commshell is trying to clear the hint window and there is no hint window.")};
this.assignFeedbackHandler=function(d){a.ctatdebug("assignFeedbackHandler()");m=d};this.gradeSAI=function(d,c,e){a.ctatdebug("gradeSAI()");l[d]=e;d=new CTATSAI(d,c,e);a.processComponentAction(d,!0,!0)};this.assignGradingHandler=function(d){a.ctatdebug("assignGradingHandler()");n=d};this.assignAnonymousGradingProcessor=function(a){q=a};this.assignDoneProcessor=function(a){d=a};this.addEventListener=function(a,d){};this.addGlobalEventListener=function(d){a.ctatdebug("addGlobalEventListener( "+d+")");
...
CTATComponentReference.getComponentFromID=function(b){var g=CTATComponentReference.components;return g.hasOwnProperty(b)?(b=g[b],b.getElement()?b.getElement():null):null};CTATComponentReference.add=function(b,g){var f=new CTATComponentReference(b,g);return CTATComponentReference.components[f.getDiv().getAttribute("id")]=f};var CTATCompBase=function(b,g,f,e,c,a){CTATBase.call(this,b,g);var d=f||0,h=e||0,l=c||-2,n=a||-2,m=50,p=25,q=!1,u=!1,x="",r=!1,y=!0,z=null,B="",v=null;this.isTabIndexable=!0;var E=0,C=null,A=this,F=null,K="hidden",H=CTATGlobalFunctions.gensym.z_index(),w=CTATGlobalFunctions.gensym.div_id(),G=CTATGlobalFunctions.gensym.z_index(),I=CTATGlobalFunctions.gensym.div_id();this.setIsAbstractComponent=function(a){q=a};this.isAbstractComponent=function(){return q};this.setIsFeedbackComponent=function(a){u=
a};this.isFeedbackComponent=function(){return u};this.setTabIndex=function(a){!0===this.isTabIndexable?(v=a,0>v?(v=CTATGlobals.Tab.Tracker,CTATGlobals.Tab.Tracker++):CTATGlobals.Tab.Tracker=v):v=-1};this.getTabIndex=function(){return v||this.getComponent().getAttribute("tabindex")};this.setZIndex=function(a){A.ctatdebug("Setting z index to: "+a);E=a;null!==z&&(z.style.zIndex=a)};this.getZIndex=function(){return E};this.setDefaultWidth=function(a){m=a};this.getDefaultWidth=function(){return m};this.setDefaultHeight=
...
function(a){C=a;this.setEnabled(this.getEnabled())};this.getTopDivZIndex=function(){return H};this.getTopDivID=function(){return w};this.setComponentGroup=function(a){B=a;C&&(C.name=a)};this.assignText=function(a){x=a};this.init=function(){A.ctatdebug("THIS IS THE BASE INIT METHOD")};this.initialize=function(){A.ctatdebug("initialize ()");A.configFromDescription();A.init();A.processSerialization();A.render();A.processTabOrder();A.ctatdebug("initialize () done")};this.getInitialized=function(){return r};
this.setInitialized=function(a){A.ctatdebug("setInitialized ("+a+")");r=a;!0!==r||z?A.ctatdebug("Not wrapping, initialized="+r+", divWrapper = "+z):(A.ctatdebug("Wrapping a component and appending it to the top container div if one was never set ..."),(a=findPointOfAttachment(this.getName()))?(A.ctatdebug("Attaching component to existing MovieClip ..."),A.wrapComponent(a.getDivWrapper())):(A.ctatdebug("Attaching component to main div ..."),0<$("#"+ctatcontainer).length&&A.wrapComponent(getSafeElementById(ctatcontainer))));
A.getDivWrap().classList.add("CTATComponent");A.ctatdebug("setInitialized () done")};this.addSafeEventListener=function(a,d,c){A.ctatdebug("addSafeEventListener ("+a+")");A.ctatdebug("Adding event listener to: "+c);c?c.addEventListener(a,d):(C?(A.ctatdebug("Adding eventlistener to component instead of target"),C.addEventListener(a,d)):A.ctatdebug("Error: pointer to component is null, can't add event listener"),A.ctatdebug("addSafeEventListener () done"))};this.drawComponent=function(){};this.addComponentReference=
function(a,d){A.ctatdebug("addComponentReference ("+a.getName()+" -> "+d.getAttribute("id")+")");CTATComponentReference.add(a,d);A.ctatdebug("addComponentReference ()")};this.getComponentFromID=function(a){return CTATComponentReference.getComponentFromID(a)};this.processSerialization=function(){A.ctatdebug("processSerialization()");A.ctatdebug("implement in child class")};this.move=function(a,c){d=Number(a);h=Number(c);if(void 0===c||null===c||isNaN(h))if(0<=a.indexOf(",")){var e=a.split(",");d=Number(e[0]);
h=Number(e[1])}else h=0;d=isNaN(d)?0:d;h=isNaN(h)?0:h;z&&(z.style.left=d+"px",z.style.top=h+"px")};this.setSize=function(a,d){var c=Number(a),e=Number(d);(void 0===d||null===d||isNaN(e))&&0<=a.indexOf(",")&&(e=a.split(","),c=Number(e[0]),e=Number(e[1]));A.ctatdebug("setSize ("+c+","+e+")");isNaN(c)||A.setWidth(c);isNaN(e)||A.setHeight(e)};this.SetVisible=this.setVisible=function(a){a=CTATGlobalFunctions.toBoolean(a);K=!0===a?"block":"hidden";F&&F.setAttribute("style","border: 0px; position: absolute; "+
(a?"":"visibility:hidden; ")+"; left:"+d+"px; top:"+h+"px; z-index:"+G+";");z.style.visibility=!0===a?"unset":"hidden"};this.FadeIn=function(a){A.SetVisible(!0)};this.FadeOut=function(a){A.SetVisible(!1)};this.reset=function(){};this.setX=function(a){this.x=a;z.style.left=this.x+"px";!0===r&&this.render()};this.setY=function(a){this.y=a;z.style.top=this.y+"px";!0===r&&this.render()};this.setWidth=function(a){A.ctatdebug("setWidth ("+a+")");l=a;z?z.style.width=l+"px":A.ctatdebug("Internal error: no div wrapper available to set width")};
this.setHeight=function(a){A.ctatdebug("setHeight ("+a+")");n=a;z?z.style.height=n+"px":A.ctatdebug("Internal error: no div wrapper available to set height")};this.setText=function(a){x=a;return this};this.getValue=function(){return C?C.value:""};this.backgrade=!1;this.unHighlightAll=function(){$(".CTAT--hint").each(function(){for(var a=$(this),d=null;0<a.length&&null===d;)a.data("CTATComponent")?d=a.data("CTATComponent"):a=a.parent();d&&d.setHintHighlight&&d.setHintHighlight(!1,null)})};this.processOnFocus=
...
this.component&&(this.component.style.fontWeight=a?"bold":null);return this};this.setItalicized=function(a){CTATGlobalFunctions.toBoolean(a);this.component&&(this.component.style.fontStyle=n.italicized?"italic":null);return this};var m=this;b=function(a){var d=a||{};return{setHandler:function(a,c){d[a]=c},set:function(a){if(d.hasOwnProperty(a)){if(d[a]){var c=Array.prototype.slice.call(arguments,1);return d[a].apply(m,c)}m.ctatdebug("Error: NULL handler for "+a)}else m.ctatdebug("Error: No handler set for "+
...
(this.setTabIndex(d),a.attr("tabindex",null));d=a.attr("name");void 0!==d&&this.setComponentGroup(d);for(var c in this.data_ctat_handlers)d=a.data("ctat-"+c),void 0!==d&&this.data_ctat_handlers[c].apply(this,[d])}};this.data_ctat_handlers.enabled=function(a){this.setEnabled(CTATGlobalFunctions.toBoolean(a))};this.disableTextAlterations=function(a){for(var d="autocomplete off autocapitalize off autocorrect off spellcheck false".split(" "),c=0;c<d.length;c+=2){var e=d[c],b=a.attr(e);b||"false"===String(b).toLowerCase()||
a.attr(e,b=d[c+1]);d[c+1]=b}this.ctatdebug("'#"+a.attr("id")+"'.processAttributes("+d+")");return d};this.processParameters=function(a){if(a)if(a instanceof CTATComponentDescription){m.setName(a.name);a=a.params;for(var d in a)this.setParameter(d,a[d])}else this.ctatdebug("Error: Invalid description sent to CTAT.Components.Hierarchy.Graphical.processDescription: "+a)};this.processStyles=function(a){if(a)if(a instanceof CTATComponentDescription){a=a.styles;for(var d in a)this.setStyle(d,a[d])}else this.ctatdebug("Error: Invalid description sent to CTAT.Components.Hierarchy.Graphical.processDescription: "+
...
a)};this.setParameterHandler("DisableOnCorrect",this.setDisableOnCorrect);var u=!0;this.getShowHintHighlight=function(){return u};this.setShowHintHighlight=function(a){u=CTATGlobalFunctions.toBoolean(a)};this.setParameterHandler("ShowHintHighlight",this.setShowHintHighlight);this.data_ctat_handlers["show-hint-highlight"]=function(a){u=CTATGlobalFunctions.toBoolean(a)};var x=CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED;this.getComponentStatus=function(){return x};this.setComponentStatus=
function(a){x=a};this.isCorrect=function(){return x===CTAT.Component.Base.Tutorable.Options.Status.CORRECT};this.isIncorrect=function(){return x===CTAT.Component.Base.Tutorable.Options.Status.INCORRECT};this.isNotGraded=function(){return x===CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED};this.setCorrect=function(a){this.setNotGraded();"CTATTableGoogle"!=this.getClassName()&&this.executeSAI(a);x=CTAT.Component.Base.Tutorable.Options.Status.CORRECT;!0===this.getDisableOnCorrect()&&this.setEnabled(!1);
!1===CTATGlobals.suppressStudentFeedback&&n&&this.showCorrect(a);this.ctatdebug("setCorrect() post showCorrect");this.component&&(a=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.correct,{detail:{sai:a,component:this},bubbles:!0,cancelable:!0}),this.getDivWrap().dispatchEvent(a))};this.setIncorrect=function(a){this.ctatdebug("setIncorrect()");this.setNotGraded();"CTATTableGoogle"!=this.getClassName()&&this.executeSAI(a);x=CTAT.Component.Base.Tutorable.Options.Status.INCORRECT;!1===CTATGlobals.suppressStudentFeedback&&
n&&this.showInCorrect(a);this.component&&(a=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.incorrect,{detail:{sai:a,component:this},bubbles:!0,cancelable:!0}),this.getDivWrap().dispatchEvent(a))};this.setNotGraded=function(){this.ctatdebug("setNotGraded ()");this.setHintHighlight(!1);if(!this.isNotGraded()&&(x=CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED,this.removeCorrect(),this.removeInCorrect(),this.component)){var a=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.ungrade,
{detail:{component:this},bubbles:!0,cancelable:!0});this.getDivWrap().dispatchEvent(a)}};this.showHintHighlight=function(a,d){this.component.classList.remove("CTAT--correct");this.component.classList.remove("CTAT--incorrect");a?this.component.classList.add("CTAT--hint"):this.component.classList.remove("CTAT--hint")};this.setHintHighlight=function(a,d){this.ctatdebug("setHintHighlight ("+a+")");if(u){var c=CTATGlobalFunctions.toBoolean(a);if(this.component){var e=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.highlight,
{detail:{isHighlighted:c,component:this},bubbles:!0,cancelable:!0});this.getDivWrap().dispatchEvent(e)}c!==q&&(q=c,this.showHintHighlight(c,d))}};this.moveHintHighlight=function(a,d){this.ctatdebug("moveHintHighlight ("+a+")");CTATGlobals.Tab.previousFocus=CTATGlobals.Tab.Focus;CTATGlobals.Tab.Focus=p;p.component.focus?CTATGlobals.Tab.Focus.getComponent().focus():CTATGlobals.Tab.Focus.getDivWrap().focus();if(u){var c=CTATGlobalFunctions.toBoolean(a);if(this.component){var e=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.highlight,
...
CTATButton.prototype=Object.create(CTATButtonBasedComponent.prototype);CTATButton.prototype.constructor=CTATButton;CTAT.ComponentRegistry.addComponentType("CTATButton",CTATButton);var CTATTextBasedComponent=function(b,g,f,e,c,a,d){CTAT.Component.Base.Tutorable.call(this,b,g,f,e,c,a,d);var h=this,l="",n="#000000",m=16,p=!0,q=255,u=!0;this.setAction("UpdateTextField");this.backgrade=!0;this.setFontColor=function(a){n=a;$(h.getComponent()).css("color",a)};this.getFontColor=function(){return n};this.setFontSize=function(a){a.includes("px")||(a+="px");m=a;$(h.getComponent()).css("font-size",a)};this.getFontSize=function(){return m};this.assignText=function(a){l=a;this.setInput(a)};
this.UpdateTextArea=this.UpdateTextField=function(a){this.setText(a)};this.setTabOnEnter=function(a){p=CTATGlobalFunctions.toBoolean(a)};this.setStyleHandler("TabOnEnter",this.setTabOnEnter);this.data_ctat_handlers["tab-on-enter"]=this.setTabOnEnter;this.assignEditable=function(a){u=a};this.setMaxCharacters=function(a){q=a};this.setStyleHandler("MaxCharacters",this.setMaxCharacters);this.getText=function(){return l};this.getEditable=function(){return u};this.getTabOnEnter=function(){return p};this.getMaxCharacters=
function(){return q};this.setEditable=function(a){h.assignEditable(CTATGlobalFunctions.toBoolean(a));null!==h.getComponent()&&(!0===h.getEditable()?h.getComponent().contentEditable="true":h.getComponent().contentEditable="false")};this.setStyleHandler("Enabled",this.setEditable);this.setEnabled=function(a){h.assignEnabled(a);null!==h.getComponent()&&(h.getComponent().disabled=!a,this.setEditable(a))};var x=this.processAction.bind(this);this.processAction=function(a,d){h.ctatdebug("processAction ()");
this.updateSAI();CTATGlobalFunctions.isBlank(this.getValue())||x(a,d)};this.processKeypress=function(a){h.ctatdebug("processKeypress ()");var d=a.target.getAttribute("id");h.ctatdebug(d);var c=h.getComponentFromID(d);if(null===c)h.ctatdebug("Error: component reference is null");else switch(h.ctatdebug(c.getName()+" keydown ("+("google"==CTATConfig.platform?0:window.event?window.event.keyCode:a.which)+" -> "+a.eventPhase+") ID: "+d),a.which){case 37:h.ctatdebug("left arrow key pressed!");break;case 39:h.ctatdebug("right arrow key pressed!");
...
n.style.borderRadius="10px";n.style.marginTop="5px";n.addEventListener("click",this.sendText);a.setComponent(d);a.setComponent(h);a.setComponent(l);a.addComponentReference(a,d);a.addComponentReference(a,h);a.addComponentReference(a,l);c.appendChild(d);c.appendChild(h);a.render();m&&this.addEventScreen(!1)};this.updateSAISend=function(d){a.ctatdebug("updateSAISend ()");var c=a.getDivWrap();this.setSelection(c.id);this.setAction("sendMessage");c=CTATConfiguration.get("user_guid");this.setInput(c+": "+
d);d=this.getSAI();a.ctatdebug("SAI: "+d.toTSxmlString())};var p=this.processAction.bind(this);this.processSend=function(d,c,e){a.ctatdebug("processSend ()");a.updateSAISend(d);d="computer"===d.split("_").pop();CTATGlobalFunctions.isBlank(l.value)&&!d||p(c,e)};this.addOwnMessage=function(a){var c=document.createElement("div");c.innerText=a;c.style.borderRadius="5px";c.style.position="relative";c.style.backgroundColor="#ffcb87";c.style.marginBottom="5px";c.style.marginTop="2px";c.style.maxWidth="90%";
c.style.wordWrap="break-word";c.style.padding="5px 8px";c.style.display="inline-block";c.style.cssFloat="right";c.style.clear="both";c.style.fontFamily="Verdana";a=document.createElement("br");d.appendChild(c);d.appendChild(a);d.scrollTop=d.scrollHeight};this.addOtherMessage=function(a){var c=a.indexOf(":"),e=a.substr(0,c)+" ",c=a.substr(c+2);a=document.createElement("div");a.innerHTML=e.bold()+c;a.style.borderRadius="5px";a.style.position="relative";a.style.backgroundColor="#c7edfc";a.style.marginBottom=
"5px";a.style.marginTop="2px";a.style.maxWidth="90%";a.style.wordWrap="break-word";a.style.padding="5px 8px";a.style.display="inline-block";a.style.fontFamily="Verdana";e=document.createElement("br");d.appendChild(a);d.appendChild(e);d.scrollTop=d.scrollHeight};this.sendCompMessage=function(a){var c=document.createElement("div");c.innerHTML="computer: ".bold()+a;c.style.borderRadius="5px";c.style.position="relative";c.style.backgroundColor="#d5dde8";c.style.marginBottom="5px";c.style.marginTop="2px";
c.style.maxWidth="90%";c.style.wordWrap="break-word";c.style.padding="5px 8px";c.style.display="inline-block";c.style.fontFamily="Verdana";a=document.createElement("br");d.appendChild(c);d.appendChild(a);d.scrollTop=d.scrollHeight};this.sendCompMessageBroadcast=function(d){if(""!==d){a.processSend(d+"_computer");var c=CTAT.Component.Base.Tutorable.Options.TutorComponent;a.getTutorComponent()===c.DO_NOT_TUTOR&&a.sendCompMessage(d)}};this.sendText=function(d){var c=l.value;""!==c&&(c=d+": "+c,a.processSend(c),
d=CTAT.Component.Base.Tutorable.Options.TutorComponent,a.getTutorComponent()===d.DO_NOT_TUTOR&&a.addOwnMessage(c));l.value="";n.classList.remove("CTAT--incorrect")};this.sendMessage=function(d){if("computer"===d.split("_").pop()){var c=d.indexOf(":"),e=d.lastIndexOf("_");d=d.slice(c+2,e);a.sendCompMessage(d)}else a.addOtherMessage(d);n.classList.remove("CTAT--incorrect")}};CTATChatPanel.prototype=Object.create(CTAT.Component.Base.Tutorable.prototype);CTATChatPanel.prototype.constructor=CTATChatPanel;
...
CTATGlobalFunctions.gensym.div_id());d.setAttribute("onkeypress","return noenter(event)");d.onchange=this.processComboSelection;d.addEventListener("click",function(d){a.ctatdebug("CB["+a.getName()+"].onclick() "+d+", gradeOnNextClickInfo "+a.getGradeOnNextClick());a.getGradeOnNextClick()&&a.processComboSelection()});d.classList.add("CTAT-combobox");p&&!l&&d.setAttribute("size",p);if(!l){var c=this.getDivWrap().innerHTML;this.getDivWrap().innerHTML="";c.trim()&&(d.innerHTML=c)}m&&this.addLabels(m,
n);!0===a.getEnabled()?d.disabled=!1:d.disabled=!0;a.addComponentReference(a,d);a.setComponent(d);a.getDivWrap().appendChild(d);this.component=d;d.addEventListener("focus",a.processFocus)};this.getConfigurationActions=function(){var a=[];if(m){var d=new CTATSAI;d.setSelection(this.getName());d.setInput(m);d.setAction("setLabels");a.push(d)}return a};this.getHTMLComponent=function(){return d};this.addLabels=function(a,d){for(var c=a.split(d?d:n),e=0;e<c.length;e++)this.addItem(c[e])};this.addBlank=
...
a.type&&(a.disabled=!0),0<a.children.length)for(var d=0;d<a.children.length;d++)e.setDisabled(a.children[d])}catch(m){}};e.removeDisabled=function(a){a.disabled=!1;if(0<a.children.length)for(var d=0;d<a.children.length;d++)e.removeDisabled(a.children[d])};e.animatedRemove=function(a){$("#"+a).animate({opacity:.1,zoom:1.3},500,"swing",function(){var d=document.getElementById(a);d.parentNode.removeChild(d)})};var c=null;this.init=function(){c=this.getDivWrap();if(!$(c).attr("name")){var a=CTATDragSource.default_groupname;
...
""),d=d.replace(/[() ]/g,""));d=new CTAT.Math.Fraction(d);d.selected=c;0<d&&a.push(d);return d});return a};this.updateValue=function(){return h=this.getPieces().map(function(a){return B(a.getAttributeNS(null,"data-value"),CTATGlobalFunctions.toBoolean(a.getAttributeNS(null,"data-selected")))}).join("+")};var y=function(a,d){var c=CTATGlobalFunctions.toBoolean(d);CTATGlobalFunctions.toBoolean(a.getAttributeNS(null,"data-selected"));!0===c?(a.setAttributeNS(null,"data-selected",!0),$(a).css("fill",
x.color),$(a).css("fill-opacity",x.colorAlpha)):($(a).css("fill",x.deselectedColor),$(a).css("fill-opacity",x.deselectedColorAlpha),a.setAttributeNS(null,"data-selected",!1))};this.clickHandler=function(a){!0===x.getEnabled()&&(a=CTATGlobalFunctions.toBoolean(this.getAttributeNS(null,"data-selected")),y(this,!a),x.setActionInput("SetPieces",x.updateValue()),x.processAction())};this.updateSAI=function(){x.setActionInput("SetPieces",x.updateValue())};this.addPieceElem=function(a,d,c){a.setAttributeNS(null,
"data-selected",c);a.setAttributeNS(null,"data-value",d.toString());a.dataValue=d;this.getEnabled()&&(a.style.cursor="pointer");a.addEventListener("click",this.clickHandler);u.push(a)};var z=this.setEnabled;this.setEnabled=function(a){z(a);u.forEach(function(d){d.style.cursor=a?"pointer":"default"})};this.clear=function(){u=[]};var B=function(a,d){var c=a.toString();!1===d&&(c="(0*"+c+")");return c};this.AddPiece=function(a,d){if(a){var c=new CTAT.Math.Fraction(a);if(0<CTAT.Math.round(c.valueOf())){var e=
h.split("+");e.push(B(c,d));x.setValue(e.join("+"))}}};this.AddToValue=function(a,d){if(a){var c=new CTAT.Math.Fraction(a);if(0<CTAT.Math.round(c.valueOf())){var e=h.split("+");e.push(B(c,d));h=e.join("+")}}return h};var v=-1,E=function(a){isNaN(a)&&this.get_denominator();a=Math.max(a,1);1<v&&(a=Math.min(a,v));return a}.bind(this);this.set_max_denominator=function(a){a=parseInt(a);isNaN(a)||(v=a)};this.set_denominator=function(a){x.setHintHighlight(!1);var d="string"===typeof a?parseInt(a):a;if(!isNaN(d)&&
(d=E(d),this.get_denominator()!=a)){var c=x.evaluate();x.clear();a=[];c.set_denominator(d);for(var e=new CTAT.Math.Fraction(1,d),b=Math.floor(c.numerator),f=d-b,g=0;g<b;g++)a.push(B(e,!0));d=new CTAT.Math.Fraction(c.numerator-b,d);d.equals(0)||(a.push(B(d,!0)),a.push(B(e.subtract(d),!1)),f--);for(d=0;d<f;d++)a.push(B(e,!1));this.setValue(a.join("+"));x.setActionInput("SetPieces",h);x.processAction();return h}};this.get_denominator=function(){return u.reduce(function(a,d,c,e){return Math.min(a,d.dataValue.denominator)},
Infinity)};this.change_denominator=function(a){return this.set_denominator(this.get_denominator()+Number(a))};this.set_number_pieces=function(a){x.setHintHighlight(!1);a="string"===typeof a?parseInt(a):a;if(!isNaN(a)){a=E(a);var d=x.numActive();x.clear();for(var c=[],e=new CTAT.Math.Fraction(1,a),b=0;b<a;b++)c.push(B(e,0<d)),d--;this.setValue(c.join("+"));x.setActionInput("SetPieces",h);x.processAction();return h}};this.change_number_pieces=function(a){this.set_number_pieces(u.length+a)};this.set_numerator=
function(a){return this.change_numerator(a-this.getSelectedPieces().length)};this.change_numerator=function(a){0!==a&&(0<a?u.every(function(d){!1===r(d)&&(y(d,!0),a--);return 0<a}):(u.reverse(),u.every(function(d){!0===r(d)&&(y(d,!1),a++);return 0>a}),u.reverse()))};this.SetPieces=function(a){x.setValue(a)};f=function(a){return(a=$(this.getDivWrap()).attr(a))?a.split(/\s*;\s*/).map(function(a){return a.trim()}):[]};b=f.bind(this,"data-ctat-ctrl-denominator");g=f.bind(this,"data-ctat-ctrl-partition");
f=f.bind(this,"data-ctat-ctrl-numerator");e=function(a,d){return 0<=a().indexOf(d)};var C=e.bind(null,b),A=e.bind(null,g),F=e.bind(null,f),K=function(a){var d=null;if(a instanceof CTAT.Component.Base.Tutorable)a!=this&&(d=a.getName());else if(a instanceof CTATSAI)a.getSelection()!=x.getName()&&(d=a.getSelection());else if(a instanceof String)a!=x.getName()&&(d=a);else if(a instanceof Element)a!=x.getComponent()&&(d=a.id);else return null;if(d){if(C(d))return H.bind(this,this.change_denominator,this.set_denominator);
if(F(d))return H.bind(this,this.change_numerator,this.set_numerator);if(A(d))return H.bind(this,this.change_number_pieces,this.set_number_pieces)}return null}.bind(this);b=CTAT.Component.Base.Tutorable.EventType;CTATConfiguration.get("previewMode")||document.addEventListener(b.action,function(a){var d=a.detail.sai;a=K(a.detail.component);d&&null!==a&&a(d)},!1);var H=function(a,d,c){var e=parseInt(c.getInput());if(!isNaN(e)){switch(c.getAction()){case "ButtonPressed":a.call(this,e);break;case "Update":case "UpdateTextField":case "UpdateTextArea":d.call(this,
...
CTATHintButton.prototype=Object.create(CTAT.Component.Base.Clickable.prototype);CTATHintButton.prototype.constructor=CTATHintButton;CTAT.ComponentRegistry.addComponentType("CTATHintButton",CTATHintButton);var CTATHintWindow=function(b,g,f,e,c){CTAT.Component.Base.Graphical.call(this,"CTATHintWindow","__undefined__",b,g,f,e,c);var a=this;a.isTabIndexable=!1;var d=CTATConfig.parserType_is_XML()?new CTATXML:new CTATJSON,h=new CTATTutorMessageBuilder,l=null,n=null,m=null,p=null,q=null,u=CTATGlobals.languageManager.getString("NEXT"),x=CTATGlobals.languageManager.getString("PREVIOUS"),r=null;this.data_ctat_handlers["next-content"]=function(a){r=a;p&&(p.innerHTML=a)};var y=null;this.data_ctat_handlers["previous-content"]=
function(a){y=a;m&&(m.innerHTML=a)};this.getCurrentHint=function(){return l.innerHTML};this.init=function(){a.ctatdebug("init ("+a.getName()+")");a.setInitialized(!0);a.setIsAbstractComponent(!0);q=this.getDivWrap();q.id||q.setAttribute("id",CTATGlobalFunctions.gensym.div_id());q.setAttribute("onkeypress","return noenter(event)");a.setComponent(q);a.addComponentReference(a,q);l=document.createElement("div");q.appendChild(l);l.classList.add("CTATHintWindow--hint-content");var d=document.createElement("div");
d.classList.add("CTATHintWindow--hint-button-area");q.appendChild(d);if(y)m=document.createElement("button"),m.classList.add("CTATHintWindow--previous"),m.innerHTML=y;else{m=document.createElement("button");m.classList.add("CTATHintWindow--previous");var c=document.createElement("span");c.classList.add("CTATHintWindow--button-icon");c.textContent="\u25c0";m.appendChild(c);x&&(c.style.cssFloat="left",m.appendChild(document.createTextNode(x)))}m.addEventListener("click",function(a){CTATShellTools.showPrevHint()},
!1);d.appendChild(m);n=document.createElement("div");n.classList.add("CTATHintWindow--hint-indicator");d.appendChild(n);r?(p=document.createElement("button"),p.classList.add("CTATHintWindow--next"),p.innerHTML=r):(p=document.createElement("button"),p.classList.add("CTATHintWindow--next"),c=document.createElement("span"),c.classList.add("CTATHintWindow--button-icon"),c.textContent="\u25b6",u&&(c.style.cssFloat="right",p.appendChild(document.createTextNode(u))),p.appendChild(c));p.addEventListener("click",
function(a){CTATShellTools.showNextHint()},!1);d.appendChild(p);var e=function(a){this.disabled=!a;a||(this.classList.remove("CTAT-hint-button--hover"),this.classList.remove("CTAT-hint-button--clicked"))};[m,p].forEach(function(a){a.setEnabled=e.bind(a);a.classList.add("CTATHintWindow--button");a.classList.add("CTAT-hint-button");a.addEventListener("mouseenter",function(a){a.target.classList.add("CTAT-hint-button--hover")});a.addEventListener("mouseleave",function(a){a.target.classList.remove("CTAT-hint-button--hover");
...
m.setEnabled(!1);p.setEnabled(!1)};this.setStyleHandler("OuterBorderColor",this.setBorderColor);this.SetText=this.showFeedback=function(d){a.ctatdebug("showFeedback ("+d+")");l&&(l.innerHTML=CTATGlobals.languageManager.filterString(d));m.setEnabled(!1);p.setEnabled(!1);n.innerHTML=""};this.showHint=function(d){a.ctatdebug("showHint ()");n.innerHTML="";hints=d||[];hintIndex=0;m.setEnabled(!1);p.setEnabled(!1);hints=hints.filter(function(a){return""!==a});if(!hints||0>=hints.length)hints=[],l.innerHTML=
"";else for(this.setEnabled(!0),l.innerHTML=CTATGlobals.languageManager.filterString(hints[hintIndex]),1<hints.length?(a.ctatdebug("We have more than one hint, enabling next button"),p.setEnabled(!0)):a.ctatdebug("We only have one hint, leaving next button disabled"),d=0;d<hints.length;d++){var c=document.createElement("span");c.classList.add("CTATHintWindow--hint-indicator-bullet");c.innerHTML=0===d?"&#9679;":"&#9675;";n.appendChild(c)}};this.setEnabled=function(d){a.assignEnabled(d);null===a.getComponent()?
a.ctatdebug("Error pointer.getComponent()==null"):a.getComponent().disabled=!d};this.goPrevious=function(){a.ctatdebug("goPrevious ()");hintIndex--;p.setEnabled(!0);0>=hintIndex?(hintIndex=0,m.setEnabled(!1)):m.setEnabled(!0);l.innerHTML=CTATGlobals.languageManager.filterString(hints[hintIndex]);var c=n.querySelectorAll(".CTATHintWindow--hint-indicator-bullet");c[hintIndex+1].innerHTML="&#9675;";c[hintIndex].innerHTML="&#9679;";var e=new CTATTutoringServiceMessageBuilder,c=CTATGuid.guid(),b=new CTATSAI("previousButton",
"ButtonPressed","-1"),e=e.createInterfaceActionMessage(c,b),b=new CTATSAI("previousButton","ButtonPressed","hint request");commLoggingLibrary.logSemanticEvent(c,b,"HINT_REQUEST","");CTATCommShell.commShell.propagateShellEvent("InterfaceAction",e);b=a.getCurrentHint();c=h.createAssociatedRulesMessageForHint([b],logHintSAI,"student",null,"",c,hints.length,hintIndex+1);c=new CTATMessage(d.parse(c));CTATCommShell.commShell.processAssociatedRules(c,"HintWindow",b);CTATCommShell.commShell.propagateShellEvent("PreviousPressed",
c)};this.goNext=function(){a.ctatdebug("goNext ()");hintIndex++;m.setEnabled(!0);hintIndex>hints.length-1&&(hintIndex=hints.length-1);hintIndex>hints.length-2?p.setEnabled(!1):p.setEnabled(!0);l.innerHTML=CTATGlobals.languageManager.filterString(hints[hintIndex]);var c=n.querySelectorAll(".CTATHintWindow--hint-indicator-bullet");c[hintIndex-1].innerHTML="&#9675;";c[hintIndex].innerHTML="&#9679;";var e=new CTATTutoringServiceMessageBuilder,c=CTATGuid.guid(),b=new CTATSAI("nextButton","ButtonPressed",
"-1"),e=e.createInterfaceActionMessage(c,b),b=new CTATSAI("nextButton","ButtonPressed","hint request");commLoggingLibrary.logSemanticEvent(c,b,"HINT_REQUEST","");CTATCommShell.commShell.propagateShellEvent("InterfaceAction",e);b=a.getCurrentHint();c=h.createAssociatedRulesMessageForHint([b],logHintSAI,"student",null,"",c,hints.length,hintIndex+1);c=new CTATMessage(d.parse(c));CTATCommShell.commShell.processAssociatedRules(c,"HintWindow",b);CTATCommShell.commShell.propagateShellEvent("NextPressed",
c)}};CTATHintWindow.prototype=Object.create(CTAT.Component.Base.Graphical.prototype);CTATHintWindow.prototype.constructor=CTATHintWindow;CTAT.ComponentRegistry.addComponentType("CTATHintWindow",CTATHintWindow);var CTATIFrameManager=function(){var b={},g=this;this.initFrame=function(f,e,c){var a=f?f.getAttribute("id"):null;a?b[a]={domNode:f,initialDom:e,initialMode:c}:console.error("iFrames managed by CTATIFrameManager must exist and have unique ids");f.setAttribute("data-ctat-target",c);this.writeData(f,e)};this.refresh=function(f){var e=b[f];e.domNode?(e.domNode.setAttribute("src","about:blank"),this.writeData(e.domNode,e.initialDom)):console.warn("CTATIFrameManager: iFrame id "+f+" not found")};this.writeData=
...
b.getName()+")");b.getInitialized()||(e=b.getDivWrap(),c=document.createElement("div"),c.id=e.id+"_math",e.appendChild(c),g=new Guppy(c.id,{events:{done:function(){var a=b.getValue();/^\s*$/.test(String(a))||(b.setActionInput("UpdateTextField",a),b.processAction(),m=0)},focus:function(a){a.focused&&CTATMathInput.__osk&&a.target===g&&CTATMathInput.__osk.guppy!==g&&CTATMathInput.__osk.attach(g)}},settings:{empty_content:""}}),a=document.createElement("div"),a.id=e.id+"_new",e.appendChild(a),d=document.createElement("div"),
d.id=e.id+"_left",d.classList.add("CTATMathInput-left"),l=document.createElement("div"),l.id=e.id+"_equals",l.classList.add("CTATMathInput-equals"),h=document.createElement("div"),h.id=e.id+"_right",h.classList.add("CTATMathInput-right"),this.ctatdebug("Final location: "+b.getX()+","+b.getY()+" with text: "+b.getValue()),e.addEventListener("keydown",function(a){++m;b.ctatdebug("dirty "+m)}),c.addEventListener("blur",function(a){n||(a=b.getValue(),/^\s*$/.test(String(a))||1>m||(b.setActionInput("UpdateTextField",
a),b.processAction(),m=0))}),b.setInitialized(!0),b.setComponent(e),b.addComponentReference(b,e),f&&this.addEventScreen(!1))};this.GuppyStyleInput=function(a){var d;if(a.includes("/")){for(var c=a.indexOf("/"),e=c;0<e;e--)if("+"===a[e]||"-"===a[e]){d=a.slice(0,e+1)+"("+a.slice(e+1,c)+")/"+b.GuppyStyleInput(a.slice(c+1,a.length));break}!d&&(d="("+a.slice(0,c)+")/"+b.GuppyStyleInput(a.slice(c+1,a.length)))}else d=a;return d};this.getValue=function(){try{return g.asciimath()}catch(v){return""}};this.updateSAI=
function(){this.setActionInput("UpdateTextField",b.getValue())};this.setMath=function(c){console.log("setMath ("+c+")");g.import_text(c);b.getEnabled()||(c=g.xml(),c.includes('<f group="operations" type="=" ast_type="operator"><b p="latex">=</b><b p="asciimath"> = </b></f>')?(c=c.split('<f group="operations" type="=" ast_type="operator"><b p="latex">=</b><b p="asciimath"> = </b></f>').map(function(a,d){return 0===d?a+"</m>":"<m>"+a}),Guppy.Doc.render(c[0],d.id),Guppy.Doc.render('<m><f group="operations" type="=" ast_type="operator"><b p="latex">=</b><b p="asciimath"> = </b></f></m>',
l.id),Guppy.Doc.render(c[1],h.id)):Guppy.Doc.render(c,a.id))};this.getConfigurationActions=function(){var a=[],d=$(this.getDivWrap());if(d.attr("value")){var c=new CTATSAI;c.setSelection(this.getName());c.setAction("UpdateTextField");c.setInput(d.attr("value"));a.push(c)}return a};this.UpdateTextField=function(a){this.setMath(a)};this.reset=function(){b.configFromDescription();b.processSerialization();g.import_text("")};var q=function(){var b=g.xml();c.parentNode===e&&e.removeChild(c);b.includes('<f group="operations" type="=" ast_type="operator"><b p="latex">=</b><b p="asciimath"> = </b></f>')?
(d.parentNode!==e&&(e.appendChild(d),e.appendChild(l),e.appendChild(h)),b=b.split('<f group="operations" type="=" ast_type="operator"><b p="latex">=</b><b p="asciimath"> = </b></f>').map(function(a,d){return 0===d?a+"</m>":"<m>"+a}),Guppy.Doc.render(b[0],d.id),Guppy.Doc.render('<m><f group="operations" type="=" ast_type="operator"><b p="latex">=</b><b p="asciimath"> = </b></f></m>',l.id),Guppy.Doc.render(b[1],h.id)):(a.parentNode!==e&&e.appendChild(a),Guppy.Doc.render(b,a.id));CTATMathInput.__osk&&
CTATMathInput.__osk.guppy===g&&CTATMathInput.__osk.detach()},u=this.setEnabled;this.setEnabled=function(f){console.log("mathinput setEnabled");u.call(this,f);b.getInitialized()&&(f?(c.parentNode!==e&&e.appendChild(c),a.parentNode===e?e.removeChild(a):d.parentNode===e&&(e.removeChild(d),e.removeChild(l),e.removeChild(h))):q())};var x=this.setCorrect;this.setCorrect=function(){n=!0;x.apply(this,arguments)};var r=this.showCorrect;this.showCorrect=function(){r.apply(this,arguments);a.style.color="darkgreen";
d.style.color="darkgreen";l.style.color="darkgreen";h.style.color="darkgreen"};var y=this.setIncorrect;this.setIncorrect=function(){n=!1;y.apply(this,arguments)};var z=this.showIncorrect;this.showIncorrect=function(){z.apply(this,arguments);c.style.color="red"};var B=this.showHintHighlight;this.showHintHighlight=function(){B.apply(this,arguments);c.style.color="initial"}};CTATMathInput.prototype=Object.create(CTAT.Component.Base.Tutorable.prototype);CTATMathInput.prototype.constructor=CTATMathInput;
...
function(){var a=[],d=$(this.getDivWrap());if(d.attr("value")){var c=new CTATSAI;c.setSelection(this.getName());c.setAction("UpdateTextField");c.setInput(d.attr("value"));a.push(c)}return a};this.processAction.bind(this);this.processAction=function(a,d){if("GET"===m){var c=this.nlp_url,c=c.includes("${input}")?c.replace("${input}",this.getValue()):c.concat(this.getValue()),e=this.getName();(function(a){$.get(c,function(d){console.log("NLP DATA: ",d);a(d)})})(function(a){var d=new CTATSAI;d.setSelection(e);
d.setAction("NLPclassification");d.setInput(a.result);CTATCommShell.commShell.processComponentAction(d)})}if("POST"===m){var c=this.nlp_url,b=n,b=b.includes("${input}")?b.replace("${input}",this.getValue()):b.concat(this.getValue()),c=c.concat(b),e=this.getName();(function(a){$.post(c,function(d){a(d)})})(function(a){var d=new CTATSAI;d.setSelection(e);d.setAction("NLPclassification");d.setInput(a);CTATCommShell.commShell.processComponentAction(d)})}};this.setCellContainer=function(a){h=a};this.getCellContainer=
...
h=""+String(a.denominator);g.style.fontSize="0.6em";g.setAttributeNS(null,"text-align","center");var n=document.createElementNS(d,"tspan"),l=document.createElementNS(d,"tspan");n.appendChild(document.createTextNode(c));l.appendChild(document.createTextNode(h));g.appendChild(n);g.appendChild(l);n.setAttributeNS(null,"text-anchor","middle");n.setAttributeNS(null,"x",e.x);n.setAttributeNS(null,"y",e.y);n.setAttributeNS(null,"dy","-1em");l.setAttributeNS(null,"text-anchor","middle");l.setAttributeNS(null,
"x",e.x);l.setAttributeNS(null,"y",e.y);c.length>h.length?n.style.textDecoration="underline":l.style.textDecoration="overline"}else g.appendChild(document.createTextNode(c.toString())),b.appendChild(tlabel),g.setAttributeNS(null,"x",e.x),g.setAttributeNS(null,"y",e.y);f.label=g}}return b};var u=function(){if(null!==this.X_Axis&&null!==this.X_Axis.svg_group){var a=this.getBoundingBox(),c=window.getComputedStyle(this._axis_line_group),c=parseInt(c.getPropertyValue("stroke-width")),a=CTAT.Geom.Rectangle.inflate(a,
-c,-c),e=new DOMPoint(a.width/2,a.height/2),b=e.add(CTAT.Geom.Point.polar(Math.min(40,a.height,a.width)/4,this.theta)),f=Math.sin(this.theta),g=-Math.cos(this.theta),m=f*e.x+g*e.y,p=-a.height*g,r=-f*a.width,c=new DOMPoint(a.left,e.y),e=new DOMPoint(a.right,e.y);if(0<Math.abs(CTAT.Math.round(p))){var p=new DOMPoint(a.left,(m-f*a.left)/g),y=new DOMPoint(a.right,(m-f*a.right)/g);if(a.contains(p)||a.contains(y))b.distance(p)<b.distance(y)?(c=y,e=p):(c=p,e=y)}0<Math.abs(CTAT.Math.round(r))&&(r=new DOMPoint((m-
g*a.top)/f,a.top),f=new DOMPoint((m-g*a.bottom)/f,a.bottom),a.contains(r)||a.contains(f))&&(b.distance(r)<b.distance(f)?(c=f,e=r):(c=r,e=f));if(this.X_Axis.start.x!=c.x||this.X_Axis.start.y!=c.y||this.X_Axis.end.x!=e.x||this.X_Axis.end.y!=e.y)this.X_Axis.start=c,this.X_Axis.end=e,this.X_Axis.svg_group.innerHTML="",a=document.createDocumentFragment(),b=document.createElementNS(d,"line"),b.setAttributeNS(null,"x1",c.x),b.setAttributeNS(null,"y1",c.y),b.setAttributeNS(null,"x2",e.x),b.setAttributeNS(null,
...
[];c=document.createDocumentFragment();c.appendChild(h.generate());c.appendChild(l.generate());c.appendChild(n.generate());this._tick_mark_group.innerHTML="";this._tick_mark_group.appendChild(c);c=this._point_group.children;for(e=0;e<c.length;e++)a=c[e],b=this.X_Axis.getPosition(a.value),f=new DOMPoint(a.cx.baseVal.value,a.cy.baseVal.value),1<b.distance(f)&&(a.cx.baseVal.value=b.x,a.cy.baseVal.value=b.y)}}.bind(this),x=0,r=null,y=new DOMPoint(-30,-30),z=!1,B=function(a){y.x=a.clientX;y.y=a.clientY},
v=function(a){cancelAnimationFrame(x);r.style.visibility="hidden";z=!1},E=function(a){if(!0===this.getEnabled()&&0<m){this.setHintHighlight(!1);var c;q?(a=K(a.clientX,a.clientY),c=a.location,a=a.data):(a=A(a.clientX,a.clientY),c=this.X_Axis.getProjectedPoint(a),a=this.X_Axis.getAxisValue(a));var e=document.createElementNS(d,"circle");e.classList.add("CTATNumberLine--point");e.setAttributeNS(null,"cx",c.x);e.setAttributeNS(null,"cy",c.y);e.setAttributeNS(null,"r",p);e.value=a;if(this._point_group.children.length>=
...
d.setInput(c.attr("data-ctat-denominator")),a.push(d));return a};var C=-1<navigator.userAgent.toLowerCase().indexOf("firefox"),A=function(a,d){this.svgPoint=this.svgPoint?this.svgPoint:this.component.createSVGPoint();this.svgPoint.x=a;this.svgPoint.y=d;var c=this._axis_line_group.getScreenCTM().inverse();this.svgPoint=this.svgPoint.matrixTransform(c);c=new DOMPoint(this.svgPoint.x,this.svgPoint.y);if(C){var e=$(this.component),b=parseInt(e.css("borderLeftWidth"))+parseInt(e.css("paddingLeft"))+parseInt(e.css("marginLeft")),
e=parseInt(e.css("borderTopWidth"))+parseInt(e.css("paddingTop"))+parseInt(e.css("marginTop"));c.x-=b;c.y-=e}return c}.bind(this),F=function(a,d){return this.getProjectedPoint(A(a,d))}.bind(this.X_Axis),K=function(a,d){for(var c=F(a,d),e=null,b=Number.POSITIVE_INFINITY,f,g,h=0;h<this._tickmarks.length;h++)f=this._tickmarks[h],g=c.distance(f.location),g<b&&(e=f,b=g);return e}.bind(this),H=function(){if(z&&!0===this.getEnabled()){if(q){var a=K(y.x,y.y);r.setAttributeNS(null,"transform","translate"+
CTAT.Geom.Point.to2DString(a.location,!0))}else r.setAttributeNS(null,"transform","translate"+CTAT.Geom.Point.to2DString(F(y.x,y.y),!0));x=requestAnimationFrame(H)}}.bind(this);this.render=function(){u()};this.calcXCoordinate=function(d){d=new a(d);var c=this.getWidth()-30,c=Math.abs(c-30),e=max.subtract(min);return 30+d.subtract(min).divide(e)/c};this.calcNum=function(a){var d=this.getWidth()-30,d=Math.abs(d-30);a=max.subtract(min).multiply((a-30)/d);return min.add(a)};var w=function(a,d){switch(d.getClassName()){case "CTATMessage":d=
...
this.setEnabled(!1):this.setEnabled(!0)));break;case "Points":d=this._point_group.children;for(c=0;c<d.length;c++){var e=d[c];e.classList.remove("CTAT--incorrect");e.classList.remove("CTAT--hint");e.classList.add("CTAT--correct")}break;case "set_minimum":W(R()).forEach(c);break;case "set_maximum":W(V()).forEach(c);break;case "set_large_step":W(T()).forEach(c);break;case "set_small_step":W(O()).forEach(c);break;case "set_denominator":W(U()).forEach(c);break;default:console.log("Unhandled Action in",
...
e.classList.add("CTAT--incorrect")}break;case "set_minimum":W(R()).forEach(c);break;case "set_maximum":W(V()).forEach(c);break;case "set_large_step":W(T()).forEach(c);break;case "set_small_step":W(O()).forEach(c);break;case "set_denominator":W(U()).forEach(c);break;default:console.log("Unhandled Action in",this.getName(),d)}};var G=this.setEnabled;this.setEnabled=function(a){G(a);r&&z&&(r.style.visibility=this.getEnabled()?null:"hidden")};this.set_minimum=function(a){this.Minimum=a;this.render()};
...
e=this.getBoundingBox(),b=Math.min(e.width/2,e.height/2)-(c+d+4),f=new DOMPoint(e.width/2,e.height/2),c=this.parseValue(),g=document.createDocumentFragment();c.reduce(function(d,c,e,n){if(1<=c.valueOf())e=document.createElementNS(q,"circle"),e.classList.add("CTATPieChart--piece"),e.cx.baseVal.value=f.x,e.cy.baseVal.value=f.y,e.r.baseVal.value=b,this.addPieceElem(e,c,c.selected),g.appendChild(e);else{e=document.createElementNS(q,"path");e.classList.add("CTATPieChart--piece");g.appendChild(e);window.getComputedStyle(e);
var l=2*Math.PI*d.valueOf();n=f.add(CTAT.Geom.Point.polar(b,l));c.reduce();var m=f.add(CTAT.Geom.Point.polar(b,2*Math.PI*c.valueOf()+l)),p=f.clone();if(0<a&&a<b){l=CTAT.Geom.Point.polar(a,l+Math.PI*c.valueOf());p=p.add(l);n=n.add(l);var r=function(a,d,c){return a.distance(d)<a.distance(c)?d:c};n=CTAT.Geom.Point.circle_intersection(p,n,f,b).reduce(r.bind(this,n));m=m.add(l);m=CTAT.Geom.Point.circle_intersection(p,m,f,b).reduce(r.bind(this,m))}l=CTAT.Geom.Point.to2DString;p="M "+l(p);r=new DOMPoint(b,
b);p+=" L "+l(n);p+=" A "+l(r)+" 0 "+(.5<c.valueOf()?1:0)+",1 "+l(m);e.setAttributeNS(null,"d",p+" Z");h.addPieceElem(e,c,c.selected)}return d.add(c)},new CTAT.Math.Fraction);this.baseGroup.innerHTML="";this.baseGroup.appendChild(g)}};this.getExplode=function(){return a};this.getDropShadowDistance=function(){return d};this.setExplode=function(d){d=Number(d);if(!isNaN(d)){var c=d!==a;a=d;c&&this.drawPieces()}return this};this.setStyleHandler("explode",this.setExplode);this.data_ctat_handlers.explode=
...
g.getLevel()+" ...");var q=document.createElement("div");q.classList.add("CTATSkillWindow--skill");var u=document.createElement("div");u.classList.add("CTATSkillWindow--bar");var x=document.createElement("div"),r=g.getLevel();r<b?x.classList.add("CTATSkillWindow--bar--nonmastered"):x.classList.add("CTATSkillWindow--bar--mastery");x.style.width=r>b?"100%":100*r+"%";u.appendChild(x);q.appendChild(u);e.appendChild(q);u=document.createElement("div");u.textContent=g.getDisplayName()||"no-name";u.classList.add("CTATSkillWindow--label");
q.appendChild(u)}d.innerHTML="";d.appendChild(e)}}}};CTATSkillWindow.prototype=Object.create(CTAT.Component.Base.Graphical.prototype);CTATSkillWindow.prototype.constructor=CTATSkillWindow;CTAT.ComponentRegistry.addComponentType("CTATSkillWindow",CTATSkillWindow);var CTATSubmitButton=function(b,g,f,e,c){CTATButton.call(this,b,g,f,e,c);this.setClassName("CTATSubmitButton");CTATConfiguration.get("previewMode");var a=this;this.setParameterHandler("target_components",function(a){this.getDivWrap().setAttribute("data-ctat-target",a);return this});var d=this.init;this.init=function(){d();this.setParameter("tutorComponent",CTAT.Component.Base.Tutorable.Options.DO_NOT_TUTOR);this.component.addEventListener("focus",this.processFocus)};var h=function(d){var c=a.getTargets();
...
(d.innerHTML=c)};this.getValue=function(){var a=content=""+this.getDivWrap().innerHTML;n&&(content=content.replace(/<span.*?class="ctattextfield-marker".*?>.*?<\/span>/g,""),a=n+";"+content);return a};var u=this.updateSAI.bind(this);this.updateSAI=function(){n?a.setAction("TextSelected"):a.setAction("UpdateTextArea");u()};this.setStyleHandler("ShowScrollbars",function(d){!0===CTATGlobalFunctions.toBoolean(d)?a.modifyCSSAttribute("overflow","scroll"):a.modifyCSSAttribute("overflow","hidden")})};
...
this.ctatdebug("Final location: "+a.getX()+","+a.getY()+" with text: "+a.getText());c.attr("value")&&this.setText(c.attr("value"));var f=$(d);"autofocus defaultValue maxLength pattern placeholder readOnly size title".split(" ").forEach(function(a){var d=c.attr(a);d&&f.attr(a,d)});a.setInitialized(!0);a.addComponentReference(a,d);a.getDivWrap().appendChild(d);a.addSafeEventListener("keypress",a.processKeypress,d);a.addSafeEventListener("focus",a.processFocus,d);$(d).on("input",function(d){a.setNotGraded()});
l&&this.addEventScreen(!1)};this.getConfigurationActions=function(){var a=[],d=$(this.getDivWrap());if(d.attr("value")){var c=new CTATSAI;c.setSelection(this.getName());c.setAction("UpdateTextField");c.setInput(d.attr("value"));a.push(c)}return a};this.setCellContainer=function(a){h=a};this.getCellContainer=function(){return h};this.setText=function(c){a.ctatdebug("setText ("+c+")");a.assignText(c);d.value=c};this.getValue=function(){return d.value};this.reset=function(){a.configFromDescription();
...
d.object&&(b=c.aliases[e]);b?a[b]=d:console.warn("no alias found for "+JSON.stringify(d))});return a}function e(c,a){var d={},e="NotNode"===a.nodeType||"FromNotNode"===a.nodeType;switch(a.nodeType){case "BetaNode":case "NotNode":case "ExistsNode":var f=a.rightMemory,g,m=[],p;for(p in f)g=f[p].data.match,m.push(b(g));d.factBindings=m;break;case "JoinNode":var m=a.leftMemory,q,u=[];for(f in m)for(g in q=m[f].data.rightMatches,q)p=q[g].match,u.push(b(p));d.factBindings=u;break;case "FromNode":case "FromNotNode":f=
a.fromMemory;u=[];for(m in f)for(q in g=f[m],g)p=g[q][1],p.match&&u.push(b(p.match));d.factBindings=u;break;default:d.factBindings=[]}d.isMatch=d.factBindings.length&&!e||!d.factBindings.length&&e;return d}return function(c,a){var d=!0,b=c.getRuleData(a),f="";if(b){var g=b.memoryNodes,b=[].concat(b.patterns),m={},p=null,q,u,x,r=/("([^"]*)"):/g;try{for(var y=0;y<b.length;y++){var f=f+(p?"\n\t":'\npattern: "'),z=b[y];z.disjuncts&&(f+="or (\n\t",p=y-1+z.disjuncts.length,b.splice.apply(b,[].concat([y,
1],$jscomp.arrayFromIterable(z.disjuncts))),z=b[y]);f+=z.string+(p?"":'"');q=z.alias;m[q]||(m[q]=0);u=e(z,g[q][m[q]++]);u.isMatch||(f+=" NOT");f+=" MATCHED";(x=u.factBindings).length&&(f+=" - Possible bindings: ",x.forEach(function(a,d){for(var c in a)if("__i__"!==c){for(var e=JSON.stringify(a[c].object),b;b=r.exec(e);)e=e.replace(b[1],b[2]);f+="\n\t"+(p?"\t":"")+c+": "+e+" (fact ID "+a[c].id+")"}f+="\n"}));y===p&&(f+='\n)"',p=null);if(!u.isMatch){d=!1;break}}return f+"\nRule "+(d?"":"not ")+"matched"}catch(B){throw console.log("got here: "+
f),B;}}else return"Rule "+a+" not found"}}();this.printBreakpoints=function(b){return"breakpoints set for rules: "+b.getBreakpoints().join(", ")}};var CTATNoolsTracerWrapper=function(b){this.printAgenda=function(){b.printAgenda("override")};this.printConflictTree=function(g,f){b.printConflictTree("override",g,f)};this.printPregenTrees=function(g,f){b.printPregenTrees("override",g,f)};this.printTutorSAIs=function(g){b.printTutorSAIs("override",g)};this.printFact=function(g){b.printFact(g)};this.getFact=function(g){return b.getFact(g)};this.printFacts=function(g){b.printFacts(g)};this.getFacts=function(g){return b.getFacts(g)};this.printRules=
...
a){var d,b,f,g,m;"number"===typeof a&&(e=this.findExpression(e,[])[a])&&(a=e.path,delete e.path);if(0===(null!=a?a.length:void 0))return c;if(null!=(m=null!=a?a.shift():void 0))return d=this.clone(!1),"string"===typeof m?(d[m]=null!=(b=this[m])?b.replaceExpression(e,c,a):void 0,d.simpleFlatten()):"object"===typeof m&&2===m.length?(d[m[0]]=d[m[0]].slice(0),d[m[0]][m[1]]=null!=(f=this[m[0]])?f[m[1]].replaceExpression(e,c,a):void 0,d.simpleFlatten()):"object"===typeof m&&3===m.length?(d[m[0]]=d[m[0]].slice(0),
[].splice.apply(d[m[0]],[g=m[1],m[2]-g].concat(c)),c,d.simpleFlatten()):this};b.prototype.deleteExpression=function(b,c){var a,d,e,f,g;"number"===typeof c&&(b=this.findExpression(b,[])[c])&&(c=b.path,delete b.path);if(0===(null!=c?c.length:void 0))return null;if(null!=(g=null!=c?c.shift():void 0))return a=this.clone(!1),"string"===typeof g?(a[g]=null!=(d=this[g])?d.deleteExpression(b,c):void 0,a.removeNull()):"object"===typeof g&&2===g.length?(a[g[0]]=a[g[0]].slice(0),a[g[0]][g[1]]=null!=(e=this[g[0]])?
...
c.prototype.single=function(a){return 1===a.length&&a[0].addition()};c.prototype.distributeFactors=function(a){var c;c=a[0].addition()?a[0].terms.map(function(a){return a.multiplication()?a.pushNegation().factors:[a]}):[[a[0]]];a.slice(1).forEach(function(a){var d;return a.addition()?1===c.length?c=a.terms.map(function(a){var d;d=c[0].map(function(a){return a.clone()});a.multiplication()?d.push.apply(d,a.pushNegation().factors):d.push(a);return d}):c=c.reduce(function(c,d){c.push.apply(c,a.terms.map(function(a){var c;
c=d.map(function(a){return a.clone()});a.multiplication()?c.push.apply(c,a.pushNegation().factors.map(function(a){return a.clone()})):c.push(a.clone());return c}));return c},[]):1===c.length?a.multiplication()?(d=c[0]).push.apply(d,a.pushNegation().factors):c[0].push(a):c.forEach(function(d,b){var e;return a.multiplication()?(e=c[b]).push.apply(e,a.pushNegation().factors.map(function(a){return a.clone()})):c[b].push(a.clone())})});return c};c.prototype.packTerms=function(a){var d;d=CTATAlgebraTreeNode.diff(this.rules,
...
new b.CTATVariableNode(b.variableTable,f[a]);break;case 26:this.$=new b.CTATConstantNode(Number(f[a]));break;case 27:this.$=new b.CTATUnknownNode}},table:[{3:1,4:2,6:3,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{1:[3]},{5:[1,15]},{5:[2,8],7:[1,16],8:[1,17],9:[1,18],10:[1,19],11:[1,20],12:[1,21],13:n,15:m},g(p,[2,11],{22:9,19:26,16:q,18:u,20:x,21:r,24:c,25:a,27:d,28:h,29:l}),g(y,[2,17]),{13:f,15:e,17:29,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{13:f,15:e,17:30,19:8,22:9,24:c,25:a,27:d,28:h,
29:l},g(y,[2,20]),g(y,[2,23],{23:[1,31]}),{13:f,15:e,17:32,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{6:33,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},g(z,[2,25]),g(z,[2,26]),g(z,[2,27]),{1:[2,1]},{6:34,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{6:35,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{6:36,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{6:37,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{6:38,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,
28:h,29:l},{6:39,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{13:f,14:40,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{13:f,14:41,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{13:f,15:e,17:42,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{13:f,15:e,17:43,19:8,22:9,24:c,25:a,27:d,28:h,29:l},g(y,[2,14]),{13:f,15:e,17:44,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{13:f,15:e,17:45,19:8,22:9,24:c,25:a,27:d,28:h,29:l},g(y,[2,18]),g(y,[2,19]),{13:f,15:e,17:46,19:8,22:9,24:c,25:a,27:d,28:h,29:l},g(y,[2,22]),
{13:n,15:m,26:[1,47]},{5:[2,2],13:n,15:m},{5:[2,3],13:n,15:m},{5:[2,4],13:n,15:m},{5:[2,5],13:n,15:m},{5:[2,6],13:n,15:m},{5:[2,7],13:n,15:m},g(p,[2,9],{22:9,19:26,16:q,18:u,20:x,21:r,24:c,25:a,27:d,28:h,29:l}),g(p,[2,10],{22:9,19:26,16:q,18:u,20:x,21:r,24:c,25:a,27:d,28:h,29:l}),g(y,[2,12]),g(y,[2,13]),g(y,[2,15]),g(y,[2,16]),g(y,[2,21]),g(z,[2,24])],defaultActions:{15:[2,1]},parseError:function(a,c){if(c.recoverable)this.trace(a);else{var d=Error(a);d.hash=c;throw d;}},parse:function(a){var c=[0],
d=[null],b=[],e=this.table,f="",g=0,h=0,n=0,l=b.slice.call(arguments,1),m=Object.create(this.lexer),p={},r;for(r in this.yy)Object.prototype.hasOwnProperty.call(this.yy,r)&&(p[r]=this.yy[r]);m.setInput(a,p);p.lexer=m;p.parser=this;"undefined"==typeof m.yylloc&&(m.yylloc={});r=m.yylloc;b.push(r);var y=m.options&&m.options.ranges;this.parseError="function"===typeof p.parseError?p.parseError:Object.getPrototypeOf(this).parseError;for(var q,x,u,B,z={},T,O;;){u=c[c.length-1];if(this.defaultActions[u])B=
this.defaultActions[u];else{if(null===q||"undefined"==typeof q)q=m.lex()||1,"number"!==typeof q&&(q=this.symbols_[q]||q);B=e[u]&&e[u][q]}if("undefined"===typeof B||!B.length||!B[0]){var U;O=[];for(T in e[u])this.terminals_[T]&&2<T&&O.push("'"+this.terminals_[T]+"'");U=m.showPosition?"Parse error on line "+(g+1)+":\n"+m.showPosition()+"\nExpecting "+O.join(", ")+", got '"+(this.terminals_[q]||q)+"'":"Parse error on line "+(g+1)+": Unexpected "+(1==q?"end of input":"'"+(this.terminals_[q]||q)+"'");
this.parseError(U,{text:m.match,token:this.terminals_[q]||q,line:m.yylineno,loc:r,expected:O})}if(B[0]instanceof Array&&1<B.length)throw Error("Parse Error: multiple actions possible at state: "+u+", token: "+q);switch(B[0]){case 1:c.push(q);d.push(m.yytext);b.push(m.yylloc);c.push(B[1]);q=null;x?(q=x,x=null):(h=m.yyleng,f=m.yytext,g=m.yylineno,r=m.yylloc,0<n&&n--);break;case 2:O=this.productions_[B[1]][1];z.$=d[d.length-O];z._$={first_line:b[b.length-(O||1)].first_line,last_line:b[b.length-1].last_line,
first_column:b[b.length-(O||1)].first_column,last_column:b[b.length-1].last_column};y&&(z._$.range=[b[b.length-(O||1)].range[0],b[b.length-1].range[1]]);u=this.performAction.apply(z,[f,h,g,p,B[1],d,b].concat(l));if("undefined"!==typeof u)return u;O&&(c=c.slice(0,-2*O),d=d.slice(0,-1*O),b=b.slice(0,-1*O));c.push(this.productions_[B[1]][0]);d.push(z.$);b.push(z._$);B=e[c[c.length-2]][c[c.length-1]];c.push(B);break;case 3:return!0}}}},f=function(){return{EOF:1,parseError:function(a,c){if(this.yy.parser)this.yy.parser.parseError(a,
...
""};b.diff=function(b,c){return b.filter(function(a){return!c.includes(a)})};b.uniq=function(b){return g.call(new Set(b))};b.removeIndex=function(b,c){var a;b=b.slice(0);[].splice.apply(b,[c,c-c+1].concat(a=[]));a;return b};b.difference=function(b,c){return b.filter(function(a){return!c.some(function(c){return c===a})})};b.intersection=function(b){return b[0].filter(function(c){return b.every(function(a){return a.some(function(a){return a.equals(c)})})})};b.commonLength=function(b){var c;c=null;return b.every(function(a){return(null!=
c?c:c=a.length)===a.length})&&c};b.sameNegation=function(b){return 2===b.length&&b[0].negationNode()===b[1].negationNode()};b.oppositeNegation=function(b){return 2===b.length&&b[0].negationNode()!==b[1].negationNode()};b.replaceTerms=function(b,c,a){var d,e,f,g,m;g=[];d=0;for(e=b.length;d<e;d++)m=b[d],(!(f=c.find(function(a){return a[0]===m}))||a&&(m=m.junctionNode(this.removeIndex(m.terms,f[1]))))&&g.push(m);return g};b.prototype.addOperand=function(b,c,a){null==a&&(a=null);return new CTATLogicFlattenNode(b,
...
g[a],d.lexer.matched);this.$=new d.CTATLogicRelationNode("NOT",null,f[a],f[a-1]);break;case 10:this.$=f[a];break;case 11:this.$=f[a-1].setParens();break;case 12:this.$=new d.CTATLogicVariableNode(d.variableTable,f[a]);break;case 13:this.$=new d.CTATLogicConstantNode(!0,f[a]);break;case 14:this.$=new d.CTATLogicConstantNode(!1,f[a])}},table:[{3:1,4:2,13:f,14:4,15:e,17:c,18:a,19:d},{1:[3]},{5:[1,9],6:h,7:l,8:n,9:m,10:p,11:q,12:u},{4:17,13:f,14:4,15:e,17:c,18:a,19:d},g(x,[2,10]),{4:18,13:f,14:4,15:e,
17:c,18:a,19:d},g(x,[2,12]),g(x,[2,13]),g(x,[2,14]),{1:[2,1]},{4:19,13:f,14:4,15:e,17:c,18:a,19:d},{4:20,13:f,14:4,15:e,17:c,18:a,19:d},{4:21,13:f,14:4,15:e,17:c,18:a,19:d},{4:22,13:f,14:4,15:e,17:c,18:a,19:d},{4:23,13:f,14:4,15:e,17:c,18:a,19:d},{4:24,13:f,14:4,15:e,17:c,18:a,19:d},{4:25,13:f,14:4,15:e,17:c,18:a,19:d},g(x,[2,9]),{6:h,7:l,8:n,9:m,10:p,11:q,12:u,16:[1,26]},g(x,[2,2]),g(r,[2,3],{6:h,8:n}),g(r,[2,4],{6:h}),g([5,10,11,12,16],[2,5],{6:h,7:l,8:n}),g([5,11,12,16],[2,6],{6:h,7:l,8:n,9:m,
10:p}),g([5,12,16],[2,7],{6:h,7:l,8:n,9:m,10:p,11:q}),g([5,16],[2,8],{6:h,7:l,8:n,9:m,10:p,11:q,12:u}),g(x,[2,11])],defaultActions:{9:[2,1]},parseError:function(a,c){if(c.recoverable)this.trace(a);else{var b=Error(a);b.hash=c;throw b;}},parse:function(a){var c=[0],b=[null],d=[],e=this.table,f="",g=0,h=0,n=0,l=d.slice.call(arguments,1),m=Object.create(this.lexer),p={},r;for(r in this.yy)Object.prototype.hasOwnProperty.call(this.yy,r)&&(p[r]=this.yy[r]);m.setInput(a,p);p.lexer=m;p.parser=this;"undefined"==
typeof m.yylloc&&(m.yylloc={});r=m.yylloc;d.push(r);var y=m.options&&m.options.ranges;this.parseError="function"===typeof p.parseError?p.parseError:Object.getPrototypeOf(this).parseError;for(var q,x,u,N,P={},V,R;;){u=c[c.length-1];if(this.defaultActions[u])N=this.defaultActions[u];else{if(null===q||"undefined"==typeof q)q=m.lex()||1,"number"!==typeof q&&(q=this.symbols_[q]||q);N=e[u]&&e[u][q]}if("undefined"===typeof N||!N.length||!N[0]){var T;R=[];for(V in e[u])this.terminals_[V]&&2<V&&R.push("'"+
this.terminals_[V]+"'");T=m.showPosition?"Parse error on line "+(g+1)+":\n"+m.showPosition()+"\nExpecting "+R.join(", ")+", got '"+(this.terminals_[q]||q)+"'":"Parse error on line "+(g+1)+": Unexpected "+(1==q?"end of input":"'"+(this.terminals_[q]||q)+"'");this.parseError(T,{text:m.match,token:this.terminals_[q]||q,line:m.yylineno,loc:r,expected:R})}if(N[0]instanceof Array&&1<N.length)throw Error("Parse Error: multiple actions possible at state: "+u+", token: "+q);switch(N[0]){case 1:c.push(q);b.push(m.yytext);
d.push(m.yylloc);c.push(N[1]);q=null;x?(q=x,x=null):(h=m.yyleng,f=m.yytext,g=m.yylineno,r=m.yylloc,0<n&&n--);break;case 2:R=this.productions_[N[1]][1];P.$=b[b.length-R];P._$={first_line:d[d.length-(R||1)].first_line,last_line:d[d.length-1].last_line,first_column:d[d.length-(R||1)].first_column,last_column:d[d.length-1].last_column};y&&(P._$.range=[d[d.length-(R||1)].range[0],d[d.length-1].range[1]]);u=this.performAction.apply(P,[f,h,g,p,N[1],b,d].concat(l));if("undefined"!==typeof u)return u;R&&(c=
c.slice(0,-2*R),b=b.slice(0,-1*R),d=d.slice(0,-1*R));c.push(this.productions_[N[1]][0]);b.push(P.$);d.push(P._$);N=e[c[c.length-2]][c[c.length-1]];c.push(N);break;case 3:return!0}}},checkStrict:function(a,c,b){var d=b+"\n"+"-".repeat(c.first_column)+"^",e=["'LPAREN'","'VARIABLE'","'TRUE'","'FALSE'"],d="Parse error on line "+c.first_line+":\n"+d+"\nExpecting "+e.join(", ")+" got '"+b[c.first_column]+"'";this.yy.strictMode&&!a.checkParens()&&this.parseError(d,{text:b,token:a.operator,line:c.first_line,
...
function(){var d;try{return(d=this.getTree(b)).createExpression.apply(d,[a].concat(g.call(c.map(function(a){return function(c){return a.getTree(c)}}(this)))))}catch(h){return null}}.call(this))};b.prototype.logicReplaceExpression=function(b,c,a,d){var e;null==d&&(d=null);d=(null!=d?d:null!=(e=c.path)?e.slice(0):void 0)||0;return this.getExpression(b,function(){try{return this.getTree(b).replaceExpression(this.getTree(c),this.getTree(a),d)}catch(l){return null}}.call(this))};b.prototype.logicDeleteExpression=
...
b,c)};return c}(CTATChemTreeNode);"undefined"!==typeof module&&null!==module?module.exports=b:this.CTATChemLogNode=b}).call(this);var CTATChemGrammar=function(){function b(){this.yy={}}var g=function(a,b,c,d){c=c||{};for(d=a.length;d--;c[a[d]]=b);return c},f=[1,6],e=[1,7],c=[1,11],a=[1,12],d=[1,14],h=[1,13],l=[1,15],n=[1,16],m=[1,17],p=[1,25],q=[1,26],u=[5,7,8,9,10,11,12,13,15,31],x=[1,27],r=[1,28],y=[1,31],z=[1,32],B=[5,7,8,9,10,11,12,13,15,16,18,21,22,28,29,30,31,32,33,34,35],v=[1,36],E=[5,7,8,9,10,11,12,13,15,16,18,21,22,25,28,29,30,31,32,33,34,35],C=[1,39],A=[1,40],F=[5,7,8,9,10,11,12,13,15,16,18,21,22,25,27,28,29,30,31,
...
new d.CTATChemLogNode(f[b-1],"LN");break;case 33:this.$=f[b-1];break;case 34:this.$=new d.CTATChemVariableNode(d.variableTable,a.replace(/\&/g,""),0,1,1,"&");break;case 35:this.$=new d.CTATChemConstantNode(a);break;case 36:this.$=new d.CTATChemVariableNode(d.variableTable,a.replace(/\$/g,""),0,1,1,"$")}},table:[{3:1,4:2,6:3,13:f,14:4,15:e,17:5,19:8,20:9,26:10,28:c,29:a,30:d,32:h,33:l,34:n,35:m},{1:[3]},{5:[1,18]},{5:[2,8],7:[1,19],8:[1,20],9:[1,21],10:[1,22],11:[1,23],12:[1,24],13:p,15:q},g(u,[2,
11],{26:10,19:29,20:30,16:x,18:r,21:y,22:z,28:c,29:a,30:d,32:h,33:l,34:n,35:m}),g(B,[2,18]),{13:f,15:e,17:33,19:8,20:9,26:10,28:c,29:a,30:d,32:h,33:l,34:n,35:m},{13:f,15:e,17:34,19:8,20:9,26:10,28:c,29:a,30:d,32:h,33:l,34:n,35:m},g(B,[2,21]),g(B,[2,22],{24:35,25:v}),g(E,[2,30],{27:[1,37]}),{13:C,15:A,20:41,23:38,26:10,28:c,29:a,30:d,32:h,33:l,34:n,35:m},{30:[1,42]},{30:[1,43]},{6:44,13:f,14:4,15:e,17:5,19:8,20:9,26:10,28:c,29:a,30:d,32:h,33:l,34:n,35:m},g(F,[2,34]),g(F,[2,35]),g(F,[2,36]),{1:[2,1]},
...
28:c,29:a,30:d,32:h,33:l,34:n,35:m},{13:f,14:52,15:e,17:5,19:8,20:9,26:10,28:c,29:a,30:d,32:h,33:l,34:n,35:m},{13:f,15:e,17:53,19:8,20:9,26:10,28:c,29:a,30:d,32:h,33:l,34:n,35:m},{13:f,15:e,17:54,19:8,20:9,26:10,28:c,29:a,30:d,32:h,33:l,34:n,35:m},g(B,[2,14]),g(B,[2,15],{24:35,25:v}),{13:f,15:e,17:55,19:8,20:9,26:10,28:c,29:a,30:d,32:h,33:l,34:n,35:m},{13:f,15:e,17:56,19:8,20:9,26:10,28:c,29:a,30:d,32:h,33:l,34:n,35:m},g(B,[2,19]),g(B,[2,20]),g(B,[2,26]),g(B,[2,27]),{13:C,15:A,20:41,23:57,26:10,28:c,
29:a,30:d,32:h,33:l,34:n,35:m},g(E,[2,29]),{13:C,15:A,20:41,23:58,26:10,28:c,29:a,30:d,32:h,33:l,34:n,35:m},{13:C,15:A,20:41,23:59,26:10,28:c,29:a,30:d,32:h,33:l,34:n,35:m},g(E,[2,25]),{6:60,13:f,14:4,15:e,17:5,19:8,20:9,26:10,28:c,29:a,30:d,32:h,33:l,34:n,35:m},{6:61,13:f,14:4,15:e,17:5,19:8,20:9,26:10,28:c,29:a,30:d,32:h,33:l,34:n,35:m},{13:p,15:q,31:[1,62]},{5:[2,2],13:p,15:q},{5:[2,3],13:p,15:q},{5:[2,4],13:p,15:q},{5:[2,5],13:p,15:q},{5:[2,6],13:p,15:q},{5:[2,7],13:p,15:q},g(u,[2,9],{26:10,19:29,
20:30,16:x,18:r,21:y,22:z,28:c,29:a,30:d,32:h,33:l,34:n,35:m}),g(u,[2,10],{26:10,19:29,20:30,16:x,18:r,21:y,22:z,28:c,29:a,30:d,32:h,33:l,34:n,35:m}),g(B,[2,12]),g(B,[2,13]),g(B,[2,16]),g(B,[2,17]),g(E,[2,28]),g(E,[2,23]),g(E,[2,24]),{13:p,15:q,31:[1,63]},{13:p,15:q,31:[1,64]},g(F,[2,33]),g(F,[2,31]),g(F,[2,32])],defaultActions:{18:[2,1]},parseError:function(a,b){if(b.recoverable)this.trace(a);else{var c=Error(a);c.hash=b;throw c;}},parse:function(a){var b=[0],c=[null],d=[],e=this.table,f="",g=0,
h=0,n=0,l=d.slice.call(arguments,1),m=Object.create(this.lexer),p={},r;for(r in this.yy)Object.prototype.hasOwnProperty.call(this.yy,r)&&(p[r]=this.yy[r]);m.setInput(a,p);p.lexer=m;p.parser=this;"undefined"==typeof m.yylloc&&(m.yylloc={});r=m.yylloc;d.push(r);var q=m.options&&m.options.ranges;this.parseError="function"===typeof p.parseError?p.parseError:Object.getPrototypeOf(this).parseError;for(var x,y,u,v,z={},A,B;;){u=b[b.length-1];if(this.defaultActions[u])v=this.defaultActions[u];else{if(null===
x||"undefined"==typeof x)x=m.lex()||1,"number"!==typeof x&&(x=this.symbols_[x]||x);v=e[u]&&e[u][x]}if("undefined"===typeof v||!v.length||!v[0]){var C;B=[];for(A in e[u])this.terminals_[A]&&2<A&&B.push("'"+this.terminals_[A]+"'");C=m.showPosition?"Parse error on line "+(g+1)+":\n"+m.showPosition()+"\nExpecting "+B.join(", ")+", got '"+(this.terminals_[x]||x)+"'":"Parse error on line "+(g+1)+": Unexpected "+(1==x?"end of input":"'"+(this.terminals_[x]||x)+"'");this.parseError(C,{text:m.match,token:this.terminals_[x]||
x,line:m.yylineno,loc:r,expected:B})}if(v[0]instanceof Array&&1<v.length)throw Error("Parse Error: multiple actions possible at state: "+u+", token: "+x);switch(v[0]){case 1:b.push(x);c.push(m.yytext);d.push(m.yylloc);b.push(v[1]);x=null;y?(x=y,y=null):(h=m.yyleng,f=m.yytext,g=m.yylineno,r=m.yylloc,0<n&&n--);break;case 2:B=this.productions_[v[1]][1];z.$=c[c.length-B];z._$={first_line:d[d.length-(B||1)].first_line,last_line:d[d.length-1].last_line,first_column:d[d.length-(B||1)].first_column,last_column:d[d.length-
1].last_column};q&&(z._$.range=[d[d.length-(B||1)].range[0],d[d.length-1].range[1]]);u=this.performAction.apply(z,[f,h,g,p,v[1],c,d].concat(l));if("undefined"!==typeof u)return u;B&&(b=b.slice(0,-2*B),c=c.slice(0,-1*B),d=d.slice(0,-1*B));b.push(this.productions_[v[1]][0]);c.push(z.$);d.push(z._$);v=e[b[b.length-2]][b[b.length-1]];b.push(v);break;case 3:return!0}}}},f=function(){return{EOF:1,parseError:function(a,b){if(this.yy.parser)this.yy.parser.parseError(a,b);else throw Error(a);},setInput:function(a,
...
e,!0)};b.prototype.polyTermsEqual=function(f,e){return this.parser.parse(f).simplify(b.partial).equals(this.parser.parse(e).simplify(b.partial))};b.prototype.algebraicMatches=function(b,e){return this.chemEquivalent(b,e,!0)};b.prototype.expressionMatches=b.prototype.algebraicMatches;b.prototype.chemGetQuadraticCoefficients=function(b,e){var c,a,d,f,g,n,m,p,q,u,x,r;c=e?this.chemSimplify(b,!1,!0):b;a=this.chemParse(c);c=null;u=[];r=null;"EQUAL"===a.operator&&("PLUS"===a.left.operator&&"CONST"===a.right.operator&&
...
a.evaluate());return b};a={a:a,b:d,c:f};n=["a","b","c"];for(f=g=0;3>g;f=++g)if(c.terms[f]){x=q=null;d=m=0;for(p=n.length;0<=p?m<p:m>p;d=0<=p?++m:--m)if(a[n[d]]&&(q=a[n[d]](c.terms[f]))){x=d;break}if(null===q)return null;u[x]=q;delete a[n[x]]}if(!u[0]||!u[1])return null;u[2]||(u[2]=0);return u}return null};b.prototype.chemSolveQuadratic=function(b,e,c){var a;a=Math.pow(e,2)-4*b*c;c=[];0===a?c.push(""+-e/(2*b)):0<a?(a=Math.sqrt(a),c.push(""+(-e+a)/(2*b)),c.push(""+(-e-a)/(2*b))):(a=Math.sqrt(Math.abs(a)),
...
(function(){var b,g,f,e,c,a,d,h,l,n,m,p,q,u=[].slice;a=/^([-+])?(?:(\d+)(?:$|\s))?(?:(\d+)\/(\d+))?$/;c=/^\d+(\.\d\d)?$/;d=RegExp("((\\d+)\\.?(\\d+)?|\\.(\\d+))([Ee]([+-]?\\d+))?","g");p=/^[+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?$/;e=/^s*([+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?)s*\/s*([+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?)s*$/;m=/^[+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?/;n=/^\s*\(\s*([+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?)\s*\,\s*([+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?)\s*\)\s*$/;l=
...
b})};b.matchWithoutPrecision=function(a,b){var c,d;return(c=String(a).match(p))&&(d=String(b).match(p))&&(a=q(c)>q(d)?(+a).toFixed(f(d)):String(a))&&g(a,b,function(a,b){return a===b})};b.constantsConform=function(){var a,b;a=arguments[0];b=2<=arguments.length?u.call(arguments,1):[];b=b.map(function(a){return"string"===typeof a?new RegExp(a,"i"):a});return(a.match(d)||[]).every(function(a){return b.some(function(b){return b.test(a)})})};b.constantsDollar=function(a){return this.constantsConform(a,
...
b){return function(){var d;d=1<=arguments.length?c.call(arguments,0):[];return a.apply(b,d)}}(CTATFormulaActions[b],CTATFormulaActions))}b.prototype.evaluate=function(b,d,n,m){var h,l,u,x,r,y,z,B,v,E,C,A;try{B="undefined"!==typeof window&&null!==window?window:global;h=function(){var a;a=[];for(x in B)a.push(x);return a}().concat(["selection","action","input"]);v=b.split(e);l=0;for(r=v.length;l<r;l++)for(z=v[l],C=null!=(E=z.match(g))?E:[],u=0,y=C.length;u<y;u++)x=C[u],0>a.call(f,x)&&0>a.call(h,x)&&
0>a.call(this.keys,x)&&CTATFormulaFunctions.assign(x,void 0);for(x in A=this.variableTable.getTable())B[x]=A[x];return function(a,b,c){c.prototype=a.prototype;c=new c;a=a.apply(c,b);return Object(a)===a?a:c}(Function,["selection","action","input"].concat(c.call(this.keys),["return "+b.trim().replace(/[\\]/g,"\\$&")]),function(){}).apply(B,[d,n,m].concat(c.call(this.values)))}catch(F){return console.log(F),null}finally{for(x in B)null!=x&&0>a.call(h,x)&&(A[x]=B[x],delete B[x])}};b.prototype.interpolateSplitPattern=
/<%=|%>/;b.prototype.interpolate=function(a,b,c,d){var e,f,g,h,n;h=a.split(this.interpolateSplitPattern);n=[];a=f=0;for(g=h.length;f<g;a=++f)e=h[a],n.push(a%2?this.evaluate(e,b,c,d):e);return n.join("")};return b}();"undefined"!==typeof module&&null!==module?module.exports=b:this.CTATFormulaParser=b}).call(this);var CTATNoolsTracer=function(b,g,f){var e,c,a,d;function h(a){wa=[];M.setDoBacktracking(!1);J("debug","starting initial match");xa=function(){J("debug","done initial match");ja=ka=!0;M.setPruneOldActivations(X.prune_old_activations);M.setDoBacktracking(X.use_backtracking);M.setSearchAllPermutations(X.search_all_permutations);fa=!0;"function"===typeof a&&a()};E()}function l(){J("debug","start conflict tree pregeneration...");ha=!0;ca=[];var a=0;0===la.length&&la.push({selection:"not_specified",action:"not_specified",
input:"not_specified"});var b=function(){++a>=la.length?c():n(la[a],b)},c=function(){J("debug","done conflict tree pregeneration");ha=!1;ya();ya=function(){}};X.use_hint_fact?(a--,n(null,b,!0)):n(la[a],b)}function n(a,b,c){M.prepForMatch();w();var d;d=c?v():B(a,!0);E(null,function(){M.retract(d);ja=!0;var e=M.getConflictTree();c?ca.__hintTree=[Y,e]:ca.push([a,Y,e]);b()})}function m(a,b,c){var d=null,e=null,f=null;if("untutored_action"===c)return B(a,!1),l(),!0;"hint"===c&&ca.__hintTree&&(e=F(!0,a.selection,
ca.__hintTree[0]));if(!e)for(var g=0;g<ca.length;g++){var h=ca[g][0],n=ca[g][1],m=n.firstPredictedSolution,n=n.selectionMap;!f&&("hint"!==c||0<m.hints.length)&&(f=m);if(H(a,h).isMatch){!e&&("hint"!==c||0<m.hints.length)&&(e=m);for(var p in n){if(n.hasOwnProperty(p))for(h=n[p],m=0;m<h.length;m++){var q=h[m];if("tutored_action"===c){if(H(a,q.sai,q.saiComparator).isMatch){d=q;break}}else!e&&0<q.hints.length&&(e=q)}if(d||"hint"===c&&e)break}}}if(d)J("debug","Matched w/ pregen tree, refiring chain: "+
d.activationIds.join(" , ")),qa=d,la=[],M.prepForMatch(),w(),B(a,!0),E(null,function(){J("debug","done refiring activations, returning result");var a=qa.sai.isCorrect?"correct":"bug";1===d.halted&&(d.halted=2);ka="correct"===a;ja=!0;qa=ba=null;b(a,d);l()},d.activationIds);else return e||(f||(f=new va),e=f),"tutored_action"===c?(J("debug","didn't get a match :( "),b("no_model",e)):b(e),!0}function p(a,b){"string"===typeof a&&(e[e.length-1].successOrBugMsg={message:a,priority:b||0})}function q(a){e[e.length-
1].priority=a}function u(a){var b=e[e.length-1].sai;a.selection&&(b.selection=a.selection);a.action&&(b.action=a.action);a.input&&(b.input=a.input)}function x(a,b,c,d,e,f,g){J("debug","handleImports for "+b);c=c||{};e=e||{count:0,chunks:[]};f=f||0;g=g||0;for(var h=/\bimport\s?\(('|")?([^()'"\s]*)\1?\);/g,n,m=[];null!=(n=h.exec(a));){var l=Z.relativeToAbsolute(n[2],b);c[l]?J("debug","skipping duplicate import: "+l):(m.push(l),c[l]=!0);a=a.replace(n[0],"");h.lastIndex-=n[0].length}e.chunks[f]||(e.chunks[f]=
[]);e.chunks[f][g]=a;e.count+=m.length;J("debug",b+" is importing "+m.length+" files");if(0<m.length)for(a={i:0};a.i<m.length;a={url$17:a.url$17,i:a.i},a.i++)a.url$17=m[a.i],$.ajax(a.url$17,{dataType:"text",success:function(a){return function(b){x(b,a.url$17,c,d,e,f+1,a.i);e.count--;0==e.count&&d(r(e.chunks))}}(a),error:function(a,b,c){J("error","Error in _handleImports() : ");J("error",b)}});else 0==f&&d(r(e.chunks))}function r(a){for(var b="",c;0<a.length;)for(c=a.pop();0<c.length;)b+=c.shift()+
"\n";return b}function y(a,b){var c={getRuntime:function(){return Ea},getStudentInput:function(){return aa.getLastStudentSAI()},getStudentSAIs:function(){return aa.getStudentSAIs()},checkSAI:K,setTutorSAI:u,setSuccessOrBugMsg:p,setChainPriority:q,setProblemAttribute:G,getInitialized:function(){return aa.getInitialized()},backtrack:function(){M.setAboutToBacktrack()},assert:Q,modify:D,bulkModify:N,retract:L,undoAll:V,addPregenSAI:T,halt:P,pruneOldActivations:R,setCTNodeData:I};[CTATAlgebraParser,CTATLogicParser,
CTATChemParser,CTATFormulaParser].forEach(function(a){var b=new a;a={};for(var d in b)a.f=d,"function"===typeof b[a.f]&&(c[a.f]=function(a){return function(){return b[a.f].apply(b,arguments)}}(a)),a={f:a.f}});try{na=nools.compile(a,{name:b||"CTATFlow",scope:c})}catch(Ma){return J("error","Error compiling rule file"),fa=!1,Ma}z();return!0}function z(){var a,b;a=na.__scope;var c={};na.__rules.forEach(function(a){c[a.name]=!0});if(a&&a.skill_definitions)if(a=a.skill_definitions,a instanceof Array)a.forEach(function(a){b=
...
" named by skill "+a.skillName+" does not exist in model");})});else throw Error("Global variable 'skill_definitions' must be of type Array");}function B(a,b){J("debug","Assert sai ("+(b?"":"un")+"tutored) : "+JSON.stringify(a));var c=sa[a.selection];if(c&&M.factExists(c))c.action=a.action,c.input=a.input,c.tutored=b,M.modify(c);else{c=na.getDefined("StudentValues");if(!c)throw Error("StudentValues type not defined");c=new c(a.selection,a.action,a.input);c.tutored=b;M.assert(c,"_student_input_"+Fa);
sa[a.selection]=c;ha||Fa++}return ba=c}function v(){J("debug","Asserting hint fact...");if(!ta){var a=na.getDefined("IsHintMatch");if(!a)throw Error("IsHintMatch type not defined");ta=new a}return M.assert(ta,"_isHintMatch")}function E(a,b,c){ma=!1;M.match(function(a){ha||(Aa=M.getConflictTree());if(a)throw J("error","nools encountered an error: "+a),a;b&&"function"===typeof b?b():ma&&(pa&&J("override","search complete, returning result"),xa())},a,!1,ja,c);ja=!1}function C(a){var b="no_model",c,d;
Y.matchChain?(c=Y.matchChain,b="correct"):(Y.bugMatchChains.length&&(c=Y.bugMatchChains.sort(function(a,b){return b.priority-a.priority})[0],b="bug",d=c.msg),c=F(!1),d&&(c.msg=d));ka="correct"===b;c.tpas=Ba;ja=!0;ba=null;a(b,c)}function A(a,b,c){c=F(!0,c);b&&(ka=Ca=!1,ja=!0,ba=null,X.use_hint_fact&&M.retract(ta));a(c)}function F(a,b,c){J("debug","getBiasedPrediction selecting chain to return.  includeHints is "+a+", optSelection is "+b);var d,e=c||Y,f=e.selectionMap;b=b||(ba?ba.selection:"");c=e.firstPredictedSolution;
var e=e.firstTutorSelection,g=function(b){var c=f[b],d=-1,e=null;J("debug","\tchecking selection: "+b);if(c)for(b=0;b<c.length;b++){var g=c[b];J("debug","\t\tchecking chain: "+JSON.stringify(g));g.priority>d&&(a&&0<g.hints.length||g.sai.isCorrect)&&(e=g,d=g.priority,J("debug","\t\t^^^^^^^^valid chain found"))}return e};"hint"!==b&&f[b]&&(d=g(b));if(!d){c&&(d=a?g(e):c);for(s in f){if(d)break;d=g(s)}d?J("debug","returning chain: "+JSON.stringify(d)):(J("debug","\tno chain found, returning blank chain"),
d=new va)}return d}function K(b,c,d){var f=!1,g=b.selection,h=b.action,n=b.input,m=e,m=m[m.length-1],l="not_specified"===g||"not_specified"===h||"not_specified"===n;J("sai_check","check SAI against: "+JSON.stringify(b));if(X.pregen_conflict_tree)return J("sai_check","in pregen mode, skipping check  (was "+(d?"":"not")+" a buggy step)"),m.sai={selection:g,action:h,input:n,isCorrect:!d&&!l},m.comparator=c,qa&&(J("sai_check","currently re-firing; updating sai in matched chain..."),qa.sai=m.sai),!0;if(!ba)return J("sai_check",
"no student input to check, returning false"),!1;J("sai_check","student input: "+JSON.stringify(ba));m.sai={selection:null!==g&&void 0!==g&&"not_specified"!==g&&"don't_care"!==g?g:"",action:null!==h&&void 0!==h&&"not_specified"!==h&&"don't_care"!==h?h:"",input:null!==n&&void 0!==n&&"not_specified"!==n&&"don't_care"!==n?n:"",isCorrect:!d&&!l};Ca?J("sai_check","Skipping check, we're hint matching"):(f=H(ba,b,c),J("sai_check",(f.isMatch?"Match":"No match")+", "+(d?"was":"was not")+" a buggy step"),a=
f.isMatch?d?"buggy":"match":null,M.setNodeMatcherResult(f,d));return f.isMatch}function H(a,b,c){var d=b.selection,e=b.action,f=b.input,g=a.selection,h=a.action,n=a.input,m=["-","-","-"],l={student:a,tutor:b,isMatch:!1,matchedFields:null},n=isNaN(n)?n:parseInt(n,10),f=isNaN(f)?f:parseInt(f,10),p=function(a,b,c){return"don't_care"===a?"*":"not_specified"===a?" ":a===b?c:"-"};m[0]=p(d.toLowerCase(),g.toLowerCase(),"S");m[1]=p(e.toLowerCase(),h.toLowerCase(),"A");m[2]=p(f,n,"I");l.matchedFields=m;if(c&&
"function"===typeof c)l.isMatch=c(a,b);else for(l.isMatch=!0,a=0;3>a;a++)if("-"===m[a]){l.isMatch=!1;break}return l}function w(){Y=new ua;e=[];c=[];a=null;ma=d=!1}function G(a,b){J("debug","setProblemAttribute ("+a+", "+b+")");X[a]=b}function I(a){M.setNodeData(a)}function S(){for(var b=e,c=Y.selectionMap,f,g,h={message:"",priority:Number.NEGATIVE_INFINITY},n,m=[],l=[],p=[],q=[],u=[],r,x={selection:"",action:"",input:""},v=null,A={},G=d?ha?1:2:0,I=0,w=0;w<b.length;w++)f=b[w],g=f.sai,l.push(f.ruleName),
(n=za[f.ruleName])&&p.push(n.name+" "+n.category),p=p.concat(f.skills),q=q.concat(f.hints),u=u.concat(f.tpas),m.push(f.activationId),f.successOrBugMsg&&f.successOrBugMsg.priority>h.priority&&(h=f.successOrBugMsg),g&&(g.selection&&(r=x.selection=g.selection),g.action&&(x.action=g.action),g.input&&(x.input=g.input),x.isCorrect=g.isCorrect,f.comparator&&"function"===typeof f.comparator&&(v=f.comparator)),f.customFields.forEach(function(a){return A[a.name]=a.value}),I=f.priority>I?f.priority:I;q.sort(function(a,
b){var c=b.precedence-a.precedence;0===c&&(c=a.pos-b.pos);return c});r?Y.firstTutorSelection||(Y.firstTutorSelection=r):r="_default_key";c[r]||(c[r]=[]);b=new va(x,l,p,q,h,A,m,v,u,G,I);x.isCorrect&&!Y.firstPredictedSolution&&(Y.firstPredictedSolution=b);c[r].push(b);switch(a){case "buggy":Y.bugMatchChains.push(b);break;case "match":Y.matchChain=b}Y.numChains++;Ba=u;J("debug","stored last chain: \n\trules: "+l+"\n\tskills: "+p+"\n\thints: "+q.map(function(a){return a.msg})+"\n\tfinalSAI: "+JSON.stringify(x)+
"\n\tmatchType: "+a+"\n\tmsg: "+h+"\n\tpriority: "+I)}function Q(a){X.use_backtracking&&M.pushUndo("assert",a);return M.assert(a)}function L(a){X.use_backtracking&&M.pushUndo("retract",a);return M.retract(a)}function D(a,b,c){if(X.use_backtracking)M.pushUndo("modify",a,b);else if(3>arguments.length)return M.modify.apply(M,arguments);a[b]=c;return M.modify(a)}function N(a,b){if(X.use_backtracking)M.pushUndo("bulkModify",a,Object.keys(b));else if(2>arguments.length)return M.modify.apply(M,arguments);
for(var c in b)a[c]=b[c];return M.modify(a)}function P(){d=!0;ha?M.setAboutToBacktrack():(M.halt(!0),ma=!0)}function V(){M.undoAll(!0)}function R(){var a=M.pruneOldActivations();J("debug","pruned old activations: "+a.join(","))}function T(){if(!ha)for(var a=0;a<arguments.length;a++){var b=arguments[a];!b.selection&&(b.selection="not_specified");!b.action&&(b.action="not_specified");!b.input&&(b.input="not_specified");la.push(b)}}function O(){S()}function U(a){Da||c.pop();Da=!1;Ba=[];J("backtrack",
"backtracking, initiated by "+(a?"model":"engine"))}function W(a,b,c,d){var f;try{f=JSON.stringify(a)}catch(Na){f="< Error converting fact to JSON >"}J("assert",b+" fact asserted with ID "+d+": "+f);c=e[e.length-1];switch(b){case "tpa":J("tpa","TPA asserted: "+JSON.stringify(a));fa?X.use_backtracking?c.tpas.push(a):La(a):wa.push(Z.buildStartStateMsg(a));break;case "hint":fa&&(a.pos=+(e.length+"."+c.hints.length),c.hints.push(a));break;case "skill":fa&&c.skills.push(a.name+" "+a.category);break;case "customfield":fa&&
c.customFields.push(a)}}function ea(a,b,c,d){J("modify",b+" fact modified with ID "+d)}function ia(a,b,c,d){J("retract",b+" fact retracted with ID "+d)}function ga(b){J("state_save","Hit branch point, agenda: "+JSON.stringify(b.agenda)+", factIdCntr: "+b.state.factIdCounter);c.push({numLinks:e.length,matchType:a})}function da(b){J("state_restore","State restored, agenda: "+JSON.stringify(b.agenda)+", factIdCntr: "+b.state.factIdCounter);b=c;b=b[b.length-1];links=e;links.splice(b.numLinks);a=b.matchType}
function oa(a,b,c){J("fire","Firing activation: "+c);e.push(new Ka(a,c));Da=!0}function ra(a,b,c){J("agenda_insert",a+" added to agenda, is "+(b?" ":"not ")+"new, was "+(c?" ":"not ")+"skipped")}function Ha(a){J("agenda_retract",a+" removed from agenda")}function Ia(){J("agenda_empty","No more activations in agenda, all branches have been explored");ma=!0}function Ja(a){J("override","hit breakpoint on rule "+a+" (call resume() to resume matching)")}var ua=function(){this.firstTutorSelection=null;
this.selectionMap={};this.matchChain=null;this.bugMatchChains=[];this.numChains=0;this.firstPredictedSolution=null},va=function(a,b,c,d,e,f,g,h,n,m,l){this.sai=a||{selection:"",action:"",input:""};this.rules=b||[];this.skills=c||[];this.hints=d||[];this.msg=e?e.message:"";this.customFields=f||{};this.activationIds=g||[];this.saiComparator=h||null;this.tpas=n||[];this.halted=m;this.priority=l||0},Ka=function(a,b){this.ruleName=a;this.activationId=b;this.hints=[];this.tpas=[];this.skills=[];this.customFields=
[]},J=b,La=g,Ea=f,aa=this,fa=!1,na=null,M=null,sa={},Y=new ua,ba=null,Fa=0;e=[];c=[];a=null;var Da=d=!1,Z=null,wa=[],X={use_backtracking:!0,prune_old_activations:!1,use_hint_fact:!1,search_all_permutations:!0,hint_out_of_order:!1,substitute_input:!1,auto_hint:"none",auto_hint_threshold:3},ka=!0,Ca=!1,ta=null,za={},Ba=[],pa=!1,ja=!0,xa=function(){},ma=!1,la=[],ha=!1,ya=function(){},ca=[],qa=null,Aa=null,Ga;this.getSession=function(){return M};this.getInitialized=function(){return fa};this.getSkills=
function(){return za};this.getProblemAttribute=function(a){return X[a]};this.getProblemStateStatus=function(){return Ea.getOutputStatus()};this.init=function(a,b,c){J("debug","noolstracer init w/ source file: "+a);if(nools){Z=new CTATNoolsTracerUtil;var d=Z.relativeToAbsolute(a);$.ajax(a,{dataType:"text",success:function(e){x(e,d,null,function(d){J("debug","compiling model...");!0!==(d=y(d,a))?(J("error","CTATNoolsTracer: Error compiling model"),c(d)):(J("debug","done compile"),aa.createSession()||
c("CTATNoolsTracer: Error creating session"),registerTracerWrapper(new CTATNoolsTracerWrapper(aa)),h(function(){J("override","tracer initialized, log flags: ");getTracerLogFlags();printBreakpoints();b(wa,X);var a=new Event("noolsModelLoaded");window.dispatchEvent(a);X.pregen_conflict_tree&&l()}))})},error:function(a,b,d){ctatdebug("Error retrieving rule file: ");ctatdebug(b);c(b)}})}else J("error","Error: nools is not defined"),c("nools is not defined")};this.createSession=function(){J("debug","creating session...");
(M=na.getSession({iAmEventListeners:!0,assert:W,retract:ia,modify:ea,state_save:ga,state_restore:da,backtrack:U,fire:oa,agenda_insert:ra,agenda_retract:Ha,agenda_empty:Ia,endOfChain:O,breakpoint:Ja}))&&J("debug","session created");return!!M};this.evaluate=function(a,b,c){J("debug","noolsTracer.evaluate, matchType = "+c+", sai "+JSON.stringify(a)+", "+ka);Ga=Date.now();if(X.pregen_conflict_tree)return m(a,b,c);var d=C.bind(aa,b);M.prepForMatch();switch(c){case "hint":if(ka||X.use_hint_fact)Ca=!0,d=
A.bind(aa,b,!0),X.use_hint_fact&&v();else return J("debug","re-using hints from last match"),A(b,!1,a.selection),!0;case "tutored_action":w();B(a,!0);xa=function(){M.prepForMatch();M.restoreAgenda();aa.printTraceTime();aa.printAgenda("agenda_post");aa.printConflictTree("conflict_tree");d()};pa||(aa.printAgenda("agenda_pre"),E());break;case "untutored_action":return B(a,!1),!0}return!1};this.setListener=function(a,b){M&&M.on(a,b)};this.getStudentSAIs=function(){return sa};this.getLastStudentSAI=function(){return ba};
this.getTutorSAIs=function(){return Y.selectionMap};this.reset=function(a){aa.createSession();fa=!1;sa={};Y=new ua;ba=null;ka=!0;h(a)};this.printTraceTime=function(){var a=(Date.now()-Ga)/1E3;J("time","trace took "+a+" seconds.")};this.printAgenda=function(a){J(a,Z.printAgenda(M))};this.printConflictTree=function(a,b,c){J(a,"\n"+Aa.toString(b,c))};this.printPregenTrees=function(a,b,c){ca.__hintTree&&J(a," hint tree: \n"+ca.__hintTree[1].toString(b,c));ca.forEach(function(d){J(a," tree for sai: "+
JSON.stringify(d[0])+"\n"+d[2].toString(b,c))})};this.printTutorSAIs=function(a,b){var c="";Aa.getMatchChains().forEach(function(a){var d=a.match.tutor;c+="\n"+d.selection+" ; "+d.action+" ; "+d.input;b&&(c+=" \n "+a.rules.join(",")+"\n")});J(a,c)};this.printFact=function(a){J("override",Z.printFact(M,a))};this.printFacts=function(a){J("override",Z.printFacts(M,a))};this.printRules=function(a){J("override",Z.printRules(M,a))};this.getFact=function(a){return Z.getFact(M,a)};this.getFacts=function(a){return Z.getFacts(M,
a)};this.printCtNodeMatch=function(a){J("override",Z.printCtNodeMatch(M,a))};this.printRuleNodes=function(a){J("override",Z.printRuleNodes(M,a))};this.printBreakpoints=function(){J("override",Z.printBreakpoints(M))};this.setInStepMode=function(a){a=a&&"false"!==a;J("override","Stepper mode "+(a?"on":"off"));!pa||a||ma||E();pa=a};this.takeSteps=function(a){pa?ba?(a=a||1,J("override","taking "+a+" steps"),E(a)):J("override","no new student input, ignoring"):J("override","not in step mode, ignoring")};
this.setBreakpoint=function(a,b){a?(b=b||"first",M.setBreakpoint(a,b)?J("override","breakpoint "+("none"===b?"cleared":"set")+" for rule "+a):J("override","breakpoint not "+("none"===b?"cleared":"set")+" -- rule "+a+" doesn't exist")):J("override","need a rule name to break on")};this.resume=function(){pa?J("override","can't resume; engine is in stepper mode"):ma?J("override","not at a breakpoint, ignoring"):E()};this.getIAmPregenerating=function(){return ha};this.setDonePregenCallback=function(a){J("debug",
"setDonePregenCallback()");ya=a}};var CTATLogger=function(b){var g={},f=0;b&&b.forEach(function(b){g[b]=!1});this.isSet=function(b){return!!g[b]};this.set=function(e){if(b&&!(e in g))return!1;f++;return g[e]=!0};this.unset=function(e){if(b&&!(e in g))return!1;f--;return!(g[e]=!1)};this.getFlags=function(){return g};this.getNFlagsSet=function(){return f};this.log=function(b,c){(g[b]||"override"===b)&&console.log(("override"!==b?"["+b+"]: ":"")+c)}};var CTATRuleTracerGlobals={},NOOLS_LOG_FLAGS="time conflict_tree assert modify retract state_save state_restore backtrack agenda_insert agenda_retract agenda_empty fire error debug sai_check agenda_pre agenda_post tpa".split(" "),CTATNoolsTracerLogger=new CTATLogger(NOOLS_LOG_FLAGS),globalTracerRef=null;function registerTracerWrapper(b){globalTracerRef=b}function setTracerLogFlag(b){b=CTATNoolsTracerLogger.set(b)?"set flag "+b:"Error - invalid flag: "+b;CTATNoolsTracerLogger.log("override",b)}
...
function printMatch(b){globalTracerRef.printMatch(b)}function whyNot(b){globalTracerRef.printRuleNodes(b)}function setStepperMode(b){globalTracerRef.setStepperMode(b)}function takeSteps(b,g){globalTracerRef.takeSteps(b,g)}function setBreakpoint(b,g){globalTracerRef.setBreakpoint(b,g)}function printBreakpoints(){globalTracerRef.printBreakpoints()}function resume(){globalTracerRef.resume()}function getProblemStateStatus(){return globalTracerRef.getProblemStateStatus()};var CTATRuleTracer=function(b,g){function f(b,c,d,f){var g=f.msg,l=f.sai,p=new CTATSAI(l.selection,l.action,l.input),u=b.getStudentSAI(),r=f.customFields,x=""+l.selection+(l.selection&&l.action?" ":"")+l.action+"";n("debug","ruleTracer.handleResult, result = "+d+"\n\ttutorSAI = "+JSON.stringify(l)+"\n\tmsg = "+g+"\n\tassociated rules = "+f.rules+"\n\tassociated skills = "+f.skills+"\n\tstep ID = "+x+"\n\ttpas = "+f.tpas+"\n\tcustom fields = "+JSON.stringify(r)+"\n\thalted = "+f.halted);b.setStepID(x);
b.setTutorSAI("correct"!==d||m.getProblemAttribute("substitute_input")?p:u);b.setSuccessOrBuggyMsg(g);b.setAssociatedRules(f.rules);b.setAssociatedSkills(f.skills);b.setCustomFields(r);switch(d){case "correct":b.setResult(CTATExampleTracerLink.CORRECT_ACTION);b.setTraceOutcome(CTATExampleTracerLink.CORRECT_ACTION);q={all:0};break;case "bug":case "no_model":e(b,u,"bug"===d),n("debug","consecutive errors: \n\t"+Object.keys(q).map(function(a){return a+": "+q[a]}).join("\n\t")),h()}0<CTATNoolsTracerLogger.getNFlagsSet()&&
n("override","------ end of trace ------\n");2===f.halted&&f.tpas.forEach(function(b){a(b)});c()}function e(a,b,c){b.getSelection().includes("done")&&"ButtonPressed"===b.getAction()&&a.setDoneStepFailed(!0);c?(a.setResult(CTATExampleTracerLink.BUGGY_ACTION),a.setTraceOutcome(CTATExampleTracerLink.BUGGY_ACTION)):(a.setResult(CTATExampleTracerLink.NO_MODEL),a.setTraceOutcome(CTATExampleTracerLink.NO_MODEL));a=b.getSelection();q.all++;q[a]?q[a]++:q[a]=1}function c(a,b,c){var d=c.hints.map(function(a){return a.msg}),
e=c.rules,f=c.skills;c=c.sai;a.getStudentSAI();var g=""+c.selection+(c.selection&&c.action?" ":"")+c.action+"";n("debug","ruleTracer.handleHintResult,\n\ttutorSAI = "+JSON.stringify(c)+"\n\tassociated rules = "+e+"\n\tassociated skills = "+f+"\n\tstep ID = "+g+"\n\thints = "+JSON.stringify(d));a.setTutorSAI(new CTATSAI(c.selection,c.action,c.input));a.setResult(CTATExampleTracerLink.HINT_ACTION);a.setTraceOutcome(d.length?CTATExampleTracerLink.HINT_ACTION:CTATExampleTracerLink.NO_MODEL);a.setReportableHints(d);
a.setActor(CTATMsgType.DEFAULT_STUDENT_ACTOR);a.setStepID(g);a.setAssociatedSkills(f);a.setAssociatedRules(e);q={all:0};b(a,a.getTransactionID())}function a(a){l&&l.addTPAToMessageTank(a.selection,a.action,a.input,"tutor-performed")}function d(a){return{selection:a.getSelection()||"",action:a.getAction()||"",input:a.getInput()||""}}function h(){var a=m.getProblemAttribute("auto_hint"),b=m.getProblemAttribute("auto_hint_threshold");if("all"===a?q.all>=b:"selection"===a&&Object.keys(q).some(function(a){return"all"!==
a&&q[a]>=b}))n("debug","at consecutive error threshold, sending hint request..."),CTATCommShell.commShell.processComponentAction(new CTATSAI("hint","ButtonPressed","hint request"))}var l=g,n=CTATNoolsTracerLogger.log,m=null,p=null,q={all:0},u=this;this.getEngine=function(){return m};this.initEngine=function(c,d,e){switch(b){case "nools":m=new CTATNoolsTracer(n,a,l)}var f=function(a,b){console.log("CTATRuleTracer.doneInit");var c=m.getSkills();if(!CTATConfiguration.get("skills"))if(CTATSkillSet.skills){n("debug",
"skills not defined in flashVars, using model definitions");var e=[];for(skillName in c){var f=c[skillName];CTATSkillSet.skills.addSkillAsObject(f);e.push(new CTATExampleTracerSkill(f.category,f.name,f.pGuess,f.level,f.pSlip,f.pLearn,null))}l.getProblemSummary().setSkills(new CTATSkills(e));CTATCommShell.commShell.updateSkillWindow(null)}else n("debug","CTATSkillSet.skills not defined, skipping initSkills");d(a,b)};m&&m.init(c,f,e)};this.getModelInitialized=function(){return m&&m.getInitialized()};
this.getProblemStateStatus=function(){return l.getOutputStatus()};this.setListener=function(a,b){m.setListener(a,b)};this.evaluate=function(a,b){var c=d(a.getStudentSAI()),e=f.bind(u,a,b),c=m.evaluate.bind(m,c,e,"tutored_action");if(m.getIAmPregenerating())m.setDonePregenCallback(c);else return c()};this.doHint=function(a,b,e){a.setTransactionID(b);return m.evaluate(d(a.getStudentSAI()),c.bind(this,a,e),"hint")};this.handleUntutoredAction=function(a){n("debug","ruleTracer.handleUntutoredAction( "+
JSON.stringify(a)+" )");m.evaluate({selection:a.selection[0],action:a.action[0],input:a.input[0]},null,"untutored_action")};this.checkOutOfOrder=function(a,b){var c;m.getProblemAttribute("hint_out_of_order")?(c=d(a.getStudentSAI()),c=!m.getTutorSAIs()[c.selection]):c=!1;b(c)};this.setDefaultBuggyMsg=function(a){a&&"string"===typeof a&&(p=a)};this.getDefaultBuggyMsg=function(){return p};this.reset=function(a){m.reset(a)}};var CTATHintPolicyEnum=function(){};Object.defineProperty(CTATHintPolicyEnum,"HINTS_UNBIASED",{enumerable:!0,configurable:!1,writable:!1,value:"Always Follow Best Path"});Object.defineProperty(CTATHintPolicyEnum,"HINTS_BIASED_BY_CURRENT_SELECTION_ONLY",{enumerable:!0,configurable:!1,writable:!1,value:"Bias Hints by Current Selection Only"});Object.defineProperty(CTATHintPolicyEnum,"HINTS_BIASED_BY_PRIOR_ERROR_ONLY",{enumerable:!0,configurable:!1,writable:!1,value:"Bias Hints by Prior Error Only"});
...
d,e);case CTATExpressionMatcher.LT_RELATION:case CTATExpressionMatcher.GT_RELATION:if(null==g||null==d)break;return h.compareNumberOrString(g,d,e);case CTATExpressionMatcher.LTE_RELATION:case CTATExpressionMatcher.GTE_RELATION:if(null==g)return null==d;if(null!=d)return h.compareNumberOrString(g,d,e)}}catch(x){}return!1}CTATSingleMatcher.call(this,b,g);var e=CTATExpressionMatcher.EQ_RELATION,e=CTATExpressionMatcher.BOOL_RELATION,c=g,a=null,d=!1,h=this;this.getLastInput=function(){h.ctatdebug("CTATExpressionMatcher.getLastInput() returns "+
...
x+", now "+a);x=a};this.setVisualData=function(a){v=a};this.getVisualData=function(){return v}};
...
a);return a};this.setReportableLink=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableLink("+a+")");m=a};this.setReportableInterpretation=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableInterpretation("+a+")");p=a};this.setStepID=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setStepID("+a+")");q=a?a.toString():""};this.setReportableVariableTable=function(a){z=a.clone()};this.setSuccessOrBuggyMsg=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setSuccessOrBuggyMsg("+
...
u);return u};this.setTraceOutcome=function(a){x=a};this.getTraceOutcome=function(){return x};this.setEvaluatedInput=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setEvaluatedInput("+a+")");if(null===y||"undefined"===typeof y)y=[];y.push(a)};this.addPreloadedLinkMatch=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in addPreloadedLinkMatch("+a+")");if(null===r||"undefined"===typeof r)r=[];r.push(a)};this.setInterpolatedSAI=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedSAI("+
...
m);return m};this.getReportableVariableTable=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableVariableTable() returning "+z);return z};this.getReportableInterpretation=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableInterpretation() returning "+p);return p};this.getStepID=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning "+q);return q};this.getTutorSelection=function(){return null===l||"undefined"===typeof l?null:l.getSelectionArray()};
...
b.getVariableTable(),a.getStudentSAI())),b==e&&(w.ctatdebug('ETT.finishEvaluate() successOrBuggyMsg "'+c+'"'),a.setSuccessOrBuggyMsg(c)))});if(b){C.push(a.getStudentSAI());d!=e.getLastMatchedLink()&&(e.addLink(d),a.setResult(d.getActionType()),a.setTraceOutcome(d.getActionType()));if(c.toString()===CTATExampleTracerLink.CORRECT_ACTION.toString()||c.toString()===CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString()){w.ctatdebug("In evaluate -- in first branch doUpdate()");g.forEach(function(a){a.getLastMatchedLink().getType().toString()===
CTATExampleTracerLink.BUGGY_ACTION.toString()&&(w.ctatdebug("In evaluate -- deleting an incorrect interp"),g["delete"](a))});w.ctatdebug("In evaluate -- to call setInterpretations(), if 0 < newInterps.size "+g.size);0<g.size&&(q(g),K=e);for(var h in E)E.hasOwnProperty(h)&&delete E[h];w.ctatdebug("In evaluate -- out of DoUpdate if branch")}else{w.ctatdebug("In evaluate -- in else branch of doUpdate");a.setNumberOfInterpretations(0);for(var l in E)E.hasOwnProperty(l)&&delete E[l];g.forEach(function(a){E[a.getLastMatchedLink().getUniqueID()]=
a.getLastMatchedLink()})}c.toString()===CTATExampleTracerLink.BUGGY_ACTION.toString()&&C.splice(C.length-1,1)}a.isSolverResult()||(w.ctatdebug("In evaluate inside the NOT solver result if condition "+c),a.setResult(c),a.setTraceOutcome(c));w.ctatdebug("In evaluate out the solver result if condition");a.setReportableLink(d);a.setAssociatedSkills(d.getSkillNames());a.setStepID(d.getUniqueID());a.setReportableInterpretation(e);a.setInterpolatedSAI(e.getInterpolatedSAI());a.setReportableVariableTable(e.getVariableTable());
...
c+", sai "+b.getStudentSAI()+", exitOnIncorrectDone "+A.exitOnIncorrectDone()+", hideButRequireSteps "+A.hideButRequireSteps()+", nInterps "+e.size);if(!b.getStudentSAI().isDone())return w.ctatdebug("checkDoneStep() not isDone(), so setDoneStepFailed(false) & return null "),null;if(A.exitOnIncorrectDone())return w.ctatdebug("checkDoneStep() exitOnIncorrectDone() with setDoneStepFailed(false), so return CORRECT"),a(b,d,null,e);if(!c&&A.hideButRequireSteps()){c=A.getDoneLinks();w.ctatdebug("checkDoneStep getDoneLinks().size "+
c.size);c=c.values();for(var f;!(f=c.next()).done;)if(A.pathToLinkIsSubset(f.value,H))return a(b,d,f.value,e)}1>e.size&&b.setDoneStepFailed(!0);return null}function a(a,b,c,d){var f;a.setDoneStepFailed(!1);1>d.size?(d=w.getInterpretationsInternal(),f=w.getBestInterpretation()):f=p(d);f.setInterpolatedSAI(new CTATSAI("done","ButtonPressed","-1"));return e(a,b,CTATExampleTracerLink.CORRECT_ACTION,c,f,d)}function d(a,b,d){w.ctatdebug("CTATExampleTracerTracer --\x3e _evaluate("+a+", "+b+", "+d+")");F=
a;var f=new Set,g=a.getPreloadedLinkMatches();w.ctatdebug("interps # : "+v.length);w.ctatdebug("interps: "+v);v.forEach(function(c){w.ctatdebug("In evaluate -- entered the interpretations loop");if("undefined"===typeof g||null===g)w.ctatdebug("In evaluate -- entered if check for saiLinkMatches"),g=l(a.getStudentSAI(),a.getActor(),b,c.getVariableTable(),a),w.ctatdebug("In evaluate -- exiting if check for saiLinkMatches");else for(var e=0;e<g.length;++e)h(a.getStudentSAI(),!0,g[e],g[e].getActor(),c.getVariableTable());
w.ctatdebug("Link matches # : "+g.length);g.forEach(function(b){w.ctatdebug("In evaluate -- entered the saiLinkMatches loop + "+b);if(!A.relaxOrderConstraints()&&c.getTraversalCount(b)>=b.getMaxTraversals())return w.ctatdebug("In evaluate -- skipped a saiLinkMatches loop \n Skipped due to max traversals"+b.getMaxTraversals()),!1;var e=c.clone();e.setInterpolatedSAI(null);w.ctatdebug("In evaluate size of getPaths "+e.getPaths().size);e.getPaths().forEach(function(c){w.ctatdebug("In evaluate -- looping through the newInterp.getPaths()\n Examining path: "+
c);!1===n(b,e,c,!1,a)&&(w.ctatdebug("In evaluate -- in if condition, checking if isPathOK"),e.getPaths()["delete"](c),w.ctatdebug("In evaluate -- out of if condition, checking if isPathOK\n Tried to delete path."))});w.ctatdebug("In evaluate -- done looping through the newInterp.getPaths(), size "+e.getPaths().size);if(0<e.getPaths().size){w.ctatdebug("In evaluate -- if number of paths is greater than 0");e.addLink(b);w.ctatdebug("In evaluate -- new link added");if(!0===d){w.ctatdebug("In evaluate -- we are in the doUpdate if condition");
var g=m(b,a.getStudentSAI(),e);w.ctatdebug("In evaluate -- updatingVariable table");e.setInterpolatedSAI(e.updateVariableTable(a.getStudentSAI(),g,b));w.ctatdebug("In evaluate -- done updatingVariable table: "+e.getVariableTable())}f.add(e);w.ctatdebug("In evaluate -- added new interp")}w.ctatdebug("In evaluate -- out of saiLinkMatches loop")});w.ctatdebug("In evaluate -- out of interpretation loops")});a.setNumberOfInterpretations(f.size);w.ctatdebug("In evaluate -- number of interpretations "+f.size+
" set");var r=c(a,b,d,f);if(null!==r)return r;if(0===f.size)return w.ctatdebug("In evaluate -- if condition no new interpretations"),0!==g.length&&!0===g[0].isDone()&&a.setDoneStepFailed(!0),a.setResult(CTATExampleTracerLink.NO_MODEL),a.setTraceOutcome(CTATExampleTracerLink.NO_MODEL),w.ctatdebug("In evaluate -- if condition no new interpretations returning false"),!1;r=p(f);w.ctatdebug("In evaluate -- just found bestInterp");var q=null;!0===a.isSolverResult()?(w.ctatdebug("In evaluate -- in if branch of isSolverResult"),
q=CTATExampleTracerLink.NO_MODEL.toString().toUpperCase()===a.getResult().toString().toUpperCase()?CTATExampleTracerLink.BUGGY_ACTION.toString():a.getResult().toString()):(w.ctatdebug("In evaluate -- in else branch of isSolverResult"),q=r.getLastMatchedLink().getType());return e(a,d,q,null,r,f)}function h(a,b,c,d,e){var f=b&&c.isCorrect();if("undefined"!=typeof H[c.getUniqueID()]||c.matchesSAIforHint(a,d,null,e))H[c.getUniqueID()]=f;w.ctatdebug("updateMatchedSelections(): link "+c.getUniqueID()+", matched "+
b+", newResult "+f+", matchedSelections[link] "+H[c.getUniqueID()])}function l(a,b,c,d,e){w.ctatdebug("CTATExampleTracerTracer --\x3e in findSAIMatchingLinks("+a+", "+b+", "+c+")");var f=[];A.getLinks().forEach(function(g){if(!1===c){w.ctatdebug("Calling link.matchesSAI() on link "+g+", sai "+a);var l=g.matchesSAI(a,b,d);w.ctatdebug("Result from link.matchesSAI() on link "+g+": "+l+", typeof "+typeof l);!0===l&&f.push(g);A.hideButRequireSteps()&&h(a,l,g,b,d)}else!0===g.matchesSAIforHint(a,b,e,d)&&
f.push(g)});w.ctatdebug("CTATExampleTracerTracer --\x3e out of findSAIMatchingLinks: #matchingLinks "+f.length);return f}function n(a,b,c,d,e){w.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK");var f=null;if(!0===d){w.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK in demonstrate mode");var g=b.getMatchedLinks().slice();g.push(a);f=c.getLinksRestricted(g)}else w.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK NOT in demonstrate mode"),f=c.getLinks();w.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK path.getLinks() "+
c.getLinks().size);w.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK pathLinks "+f.size);if(!0===d){var h=[],l=!0;b.getMatchedLinks().forEach(function(a){!1!==l&&(!1===A.observesOrderingConstraints(h,a,f,e)||!1===x(b,a,f)?(w.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"),l=!1):h.push(a))});if(!1===l)return w.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false2"),!1}if(a.getType().toString()===CTATExampleTracerLink.BUGGY_ACTION.toString()){if(!1===
A.isIncorrectLinkOK(b.getMatchedLinks(),a,f,b))return w.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false3"),!1}else{if(!1===A.observesOrderingConstraints(b.getMatchedLinks(),a,f,e))return w.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false4"),!1;if(!1===x(b,a,f))return w.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false5"),!1}w.ctatdebug("CTATExampleTracerTracer --\x3e out of isPathOK returning true");return!0}function m(a,b,c){w.ctatdebug("CTATExampleTracerTracer.replaceInput("+
...
v.length=0;0===a.size?w.ctatdebug("CTATExampleTracerTracer --\x3e returning from setInterpretations"):(w.ctatdebug("CTATExampleTracerTracer --\x3e setInterpretations c.size: "+a.size),a.forEach(function(a){v.push(a)}),K=null,w.ctatdebug("CTATExampleTracerTracer --\x3e out of setInterpretations"))}function u(){w.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths");var a=A.findAllPaths();w.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths: #paths "+a.size);a.forEach(function(a){w.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths loopring through paths");
w.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths size of path"+a.getLinks().size)});return a}function x(a,b,c){w.ctatdebug("CTATExampleTracerTracer --\x3e in doneStepOK: link "+b+", isDone() "+b.isDone());if(null===b||"undefined"===typeof b||!1===b.isDone())return w.ctatdebug("doneStepOK in first if condition"),!0;if(b.isDone()&&A.exitOnIncorrectDone())return!0;if(b.getType().toString()===CTATExampleTracerLink.BUGGY_ACTION.toString())return w.ctatdebug("doneStepOK in second if condition"),
!0;w.ctatdebug("doneStepOK before loop");var d=!0;c.forEach(function(c){if(!1===d)w.ctatdebug("CTATExampleTracerTracer --\x3e we are breaking from the loop");else if(c.getUniqueID()===b.getUniqueID())w.ctatdebug("CTATExampleTracerTracer --\x3e inside second if condition");else{var e=a.getTraversalCount(c);A.hideButRequireSteps()&&(0<e||1>c.getMinTraversals())||!(e<c.getMinTraversals())||(w.ctatdebug("CTATExampleTracerTracer --\x3e we should return false from the second if condition"),d=!1)}});if(!1===
...
function(a,b){w.ctatdebug("CTATExampleTracerTracer --\x3e in doHint");var c=w.matchForHint(a);Array.isArray(b)&&(w.ctatdebug("CTATExampleTracerTracer --\x3e in doHint last if condition"),b.push(a));w.ctatdebug("CTATExampleTracerTracer --\x3e returning from doHint: "+c);return c};this.getBestInterpretation=function(){w.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation");if(null===K||"undefined"===typeof K)w.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation in if condition"),
K=p(w.getInterpretationsInternal());w.ctatdebug("CTATExampleTracerTracer --\x3e out of getBestInterpretation "+(null===K||void 0===K));return K};this.getInterpretationsInternal=function(){w.ctatdebug("CTATExampleTracerTracer --\x3e in getInterpretationsInternal");return v};this.toString=function(){var a="TracerState\n";null===v?a+="(no interpretations)\n":v.forEach(function(b){a+=b.toString()+"\n"});return a};this.addInterfaceVariablesFromEvent=function(a){if(a){var b=a.getTutorSelection();a=a.getTutorInput();
w.addInterfaceVariables(b,a)}};this.addInterfaceVariables=function(a,b){w.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables("+a+", "+b+")");if(a&&b){var c=a.length;c>b.length&&(c=b.length);for(var d=0;d<c;d++)a[d]&&(g.put(a[d],CTATVariableTable.standardizeType(b[d])),g.put(CTATVariableTable.nameAsString(a[d]),CTATVariableTable.valueAsString(b[d])));w.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables() startStateVT "+g);v&&v.forEach(function(d){if(d=d.getVariableTable()){for(var e=0;e<
c;e++)a[e]&&(d.put(a[e],CTATVariableTable.standardizeType(b[e])),d.put(CTATVariableTable.nameAsString(a[e]),CTATVariableTable.valueAsString(b[e])));w.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables() interp.vt "+d)}})}};this.findCurrentState=function(){w.ctatdebug("Entering findCurrentState");var a=w.getBestInterpretation();return a&&a.getLastMatchedLink()&&a.getLastMatchedLink().isDone()?a.getLastMatchedLink().getNextNode():(a=r(!1,[a]))?a.getPrevNode():A?A.getStartNode():null};this.saveLastReport=
...
0;a<B.length;a++)B[a].clearInLinks();var b=D.getStartNode();null!==b&&"undefined"!==typeof b&&null!==b.getOutLinks()&&"undefined"!==typeof b.getOutLinks()&&(a=0,b.getOutLinks().forEach(function(b){x(b,a++)}))}function x(a,b){ctatdebug("updateInLinkSubGraph("+a+", "+b+")");var c=D.getNode(a.getNextNode());if(null!==c&&"undefined"!==typeof c){c.addInLink(a);var d=0;c.getOutLinks().forEach(function(a){x(a,d++)})}}function r(a){var b=D.getNode(a.getPrevNode());if(null!==b&&"undefined"!==typeof b){var c=
-1;b.getInLinks().forEach(function(a){-1===a.getDepth()&&r(a);a.getDepth()>c&&(c=a.getDepth())});a.setDepth(c+1)}}function y(a){var b=D.getGroupModel(),c=b.getTopLevelGroup(),d="",e=c.getSubgroups(),d=a+'<EdgesGroups ordered="'+c.getIsOrdered()+'">\n';e.forEach(function(c){d+=c.toXML(a+"    ",b)});return d+=a+"</EdgesGroups>\n"}CTATBase.call(this,"CTATExampleTracerGraph","visualdata");var z=null,B=null,v=null,E=null,C=null,A=null,F="",K=[],H=new Set,w=new Set,G=null,I=null,S=!0,Q=!0,L=CTATMsgType.SHOW_ALL_FEEDBACK,
...
CTATExampleTracerGraph.prototype.constructor=CTATExampleTracerGraph;"undefined"!==typeof module&&(module.exports=CTATExampleTracerGraph);var CTATGraphParser=function(){function b(b){ctatdebug("processEdge()");for(var c=new CTATExampleTracerLink(null,null,null),f=d.getElementChildren(b),h,l,n,p,q,u=b=-1,A=CTATMsgType.DEFAULT_ACTOR,F=!1,K=0;K<f.length;K++){"sourceID"===d.getElementName(f[K])&&(b=parseInt(d.getNodeTextValue(f[K])),c.setPrevNode(b));"destID"===d.getElementName(f[K])&&(u=parseInt(d.getNodeTextValue(f[K])),c.setNextNode(u));if("rule"===d.getElementName(f[K]))for(var H=d.getElementChildren(f[K]),w=0;w<H.length;w++)"text"===
d.getElementName(H[w])&&c.addSkillName(d.getNodeTextValue(H[w]).toString());if("actionLabel"===d.getElementName(f[K]))for(c.setIsPreferredLink("false"!=d.getElementAttr(f[K],"preferPathMark")),c.setMinTraversalsStr(d.getElementAttr(f[K],"minTraversals")),c.setMaxTraversalsStr(d.getElementAttr(f[K],"maxTraversals")),H=d.getElementChildren(f[K]),w=0;w<H.length;w++){"uniqueID"===d.getElementName(H[w])&&(q=d.getNodeTextValue(H[w]),c.setUniqueID(parseInt(d.getNodeTextValue(H[w]))));"message"===d.getElementName(H[w])&&
(p=new CTATMessage(H[w]),c.setDemoMsgObj(p));"actionType"===d.getElementName(H[w])&&c.setActionType(d.getNodeTextValue(H[w]));"buggyMessage"===d.getElementName(H[w])&&c.setBuggyMsg(d.getNodeTextValue(H[w]));"successMessage"===d.getElementName(H[w])&&c.setSuccessMsg(d.getNodeTextValue(H[w]));"hintMessage"===d.getElementName(H[w])&&c.addHint(d.getNodeTextValue(H[w]));if("matchers"===d.getElementName(H[w]))for(var G=d.getElementChildren(H[w]),I=0;I<G.length;I++)"Selection"===d.getElementName(G[I])&&
(h=g(G[I],0)),"Action"===d.getElementName(G[I])&&(l=g(G[I],1)),"Input"===d.getElementName(G[I])&&(n=g(G[I],2)),"Actor"===d.getElementName(G[I])&&(A=d.getNodeTextValue(G[I]),F=(F=d.getElementAttr(G[I],"linkTriggered"))&&"false"!=F.toLowerCase().trim()?!0:!1);if("matcher"===d.getElementName(H[w])){n=H[w];l=p;h=d.getElementAttr(n,"replacementFormula");var S=d.getElementChildren(n),Q=G=void 0,L,D=void 0,I=CTATMsgType.DEFAULT_ACTOR;n=new CTATExactMatcher(CTATMatcher.SELECTION,null);A=new CTATExactMatcher(CTATMatcher.ACTION,
...
"matcherParameter"===d.getElementName(S[N])&&(L=d.getElementAttr(S[N],"name"),D=d.getNodeTextValue(S[N]),"selection"==L&&n.setParameter(D),"action"==L&&A.setParameter(D),"input"==L&&(G=G?G:new Q(CTATMatcher.INPUT,null),G.setParameter(D)),"actor"==L&&(I=D),"minimum"==L&&(G=G?G:new Q(CTATMatcher.INPUT,null),G.setParameter(D,"minimum")),"maximum"==L&&(G=G?G:new Q(CTATMatcher.INPUT,null),G.setParameter(D,"maximum")),"InputExpression"==L&&(G=G?G:new Q(CTATMatcher.INPUT,null),G.setParameter(S[N],L,d)),
"relation"==L&&(G=G?G:new Q(CTATMatcher.INPUT,null),G.setParameter(S[N],L,d)),e.ctatdebug("processMatcher(): child "+N+", eltAttrName "+L+", inputMatcher "+G));G||(G=Q?new Q(CTATMatcher.INPUT,null):new CTATExactMatcher(CTATMatcher.INPUT,null),G.setParameter(D?D:""),"undefined"!=typeof l&&"function"==typeof l.getSAI&&(l=l.getSAI(),n.setSingle(l.getSelection()),A.setSingle(l.getAction()),G.setSingle(l.getInput())));G.setReplacementFormula(h);A=[[n],[A],[G],I];h=A[0];l=A[1];n=A[2];A=A[3]}}}a.getStartNode()&&
u==a.getStartNode().getNodeID()&&console.log("***WARNING*** edge "+q+" destination is graph startNode "+a.getStartNode());q=new CTATVectorMatcher(h,l,n,A);q.setDefaultSAI(p.getSAI());q.setCaseInsensitive(m);q.setLinkTriggered(F);c.setMatcher(q);ctatdebug("GraphParser.processEdge() "+b+"->"+u+", edge "+c);a.getNode(b).addOutLink(c);a.checkForDoneState(c);return c}function g(a,b){e.ctatdebug("processMatchers()");for(var c=d.getElementChildren(a),f=[],g=0;g<c.length;g++)if("matcher"===d.getElementName(c[g])){for(var h=
...
"maximum"):h.setParameter(n[m],p,d)}}h&&h.setReplacementFormula(l);f.push(h)}return f}function f(a,b){var c=new Set;if("group"!==d.getElementName(a))return c;var e=d.getElementAttr(a,"name");ctatdebug("readGroupFromXML group name: "+e);var g="true"===d.getElementAttr(a,"ordered"),h="true"===d.getElementAttr(a,"reenterable");ctatdebug("readGroupFromXML group isOrdered typeof: "+typeof g);ctatdebug("readGroupFromXML group isOrdered: "+g);for(var l=function(a){c.add(a)},m=d.getElementChildren(a),p=0;p<
m.length;p++){if("link"===d.getElementName(m[p])){var q=Number(d.getElementAttr(m[p],"id")),u=b[q];if(null!==u||void 0!==u)ctatdebug("Added link ID : "+q),c.add(u)}"group"===d.getElementName(m[p])&&(ctatdebug("encountered a subgroup"),f(m[p],b).forEach(l))}n.addGroup(e,g,c);n.setGroupReenterable(n.getGroupByName(e),h);return c}CTATBase.call(this,"CTATGraphParser","__undefined__");var e=this,c,a,d=new CTATXML,h=null,l=[];new XMLSerializer;var n,m=!0,p=!0,q=[];this.getLockWidget=function(){return p};
this.setLockWidget=function(a){p=a};this.parseGraph=function(e,g){ctatdebug("parseBRD()");var r=0,u="true"===d.getElementAttr(e,"unordered");m="false"!=String(d.getElementAttr(e,"caseInsensitive")).toLowerCase();p=d.getElementAttr(e,"lockWidget");hintPolicy=d.getElementAttr(e,"hintPolicy");feedbackSuppressed=d.getElementAttr(e,"suppressStudentFeedback");var x=new CTATVariableTable;a=new CTATExampleTracerGraph(u,!1,x);a.setCaseInsensitive(m);a.setStudentStartStateNodeName(d.getElementAttr(e,"startStateNodeName"));
var B=d.getElementChildren(e),x=d.getElementAttr(e,"suppressStudentFeedback");if(null===x||void 0===x)x=CTATMsgType.SHOW_ALL_FEEDBACK;a.setFeedbackPolicy(x);g.setFeedbackSuppressed(x);x=d.getElementAttr(e,"highlightRightSelection");g.setHighlightRightSelection("false"!=x);var v=d.getElementAttr(e,"confirmDone");g.setConfirmDone("true"===v?!0:"false"===v?!1:a.getFeedbackPolicy()===CTATMsgType.HIDE_ALL_FEEDBACK);g.setHintPolicy(d.getElementAttr(e,"hintPolicy"));g.setOutOfOrderMessage(d.getElementAttr(e,
"outOfOrderMessage"));for(var v=null,E=0;E<B.length;E++)switch(d.getElementName(B[E])){case "startNodeMessages":l=d.getElementChildren(B[E]);a.setStartStateMsgs(l);break;case "node":r++;var C;C=B[E];ctatdebug("processNode("+C+")");var A=d.getElementChildren(C),F=-1;C="";for(var K=[],H=0;H<A.length;H++)switch(d.getElementName(A[H])){case "uniqueID":F=parseInt(d.getNodeTextValue(A[H]));break;case "text":C=d.getNodeTextValue(A[H]);break;case "dimension":for(var w=d.getElementChildren(A[H]),G=0;G<w.length;G++)ctatdebug("grandkids "+
G+", "+w[G]+", "+d.getNodeTextValue(w[G])+", "+parseInt(d.getNodeTextValue(w[G]))),K[G]=parseInt(d.getNodeTextValue(w[G]));ctatdebug("grandkids d "+K)}A=new CTATExampleTracerNode(F,new Set);""!==C&&A.setNodeName(C);2<=K.length&&A.setDimension({x:K[0],y:K[1]});C=A;a.addNode(C);1==r&&(a.setStartNode(C),a.setStudentStartsHereNode(C));C.getNodeName()==a.getStudentStartStateNodeName()&&a.setStudentStartsHereNode(C);break;case "edge":a.addLink(b(B[E]));break;case "EdgesGroups":v=B[E];break;case "productionRule":H=
B[E];ctatdebug("processSkill()");K=C="";F=A=null;H=d.getElementChildren(H);for(w=0;w<H.length;w++)G=d.getElementName(H[w]),"ruleName"==G&&(C=d.getNodeTextValue(H[w]),ctatdebug("ruleName="+C)),"productionSet"==G&&(K=d.getNodeTextValue(H[w]),ctatdebug("productionSet="+K)),"label"==G&&(A=d.getNodeTextValue(H[w]),ctatdebug("label="+A)),"description"==G&&(F=d.getNodeTextValue(H[w]),ctatdebug("description="+F));C&&(H=new CTATExampleTracerSkill(K,C,CTATExampleTracerSkill.DEFAULT_P_GUESS,CTATExampleTracerSkill.DEFAULT_P_KNOWN,
CTATExampleTracerSkill.DEFAULT_P_SLIP,CTATExampleTracerSkill.DEFAULT_P_LEARN,CTATExampleTracerSkill.DEFAULT_HISTORY),null!=A?H.setLabel(A):H.setLabel(C),null!=F?H.setDescription(F):H.setDescription(C+(K?" "+K:"")),q.push(H))}if(v){r=d.getElementAttr(v,"ordered");if(null===r||"undefined"==typeof isordered)r=!u;ctatdebug("parseGraph() value of isOrdered = "+r);ctatdebug("parseGraph() value of isUnordered = "+u);ctatdebug("parseGraph() typeof isOrdered: "+typeof r);ctatdebug("parseGraph()typeof isUnordered: "+
typeof u);B=v;v=r;ctatdebug("processGroup()");n=a.getGroupModel();r=n.createIdToLinkMap();n.setGroupOrdered(n.getTopLevelGroup(),v);ctatdebug("processGroup() name of group: "+n.getGroupName(n.getTopLevelGroup()));ctatdebug("processGroup() group isOrdered?: "+n.isGroupOrdered(n.getTopLevelGroup()));ctatdebug("processGroup() order of group: isOrdered= "+v);ctatdebug("processGroup() order of group: isOrdered typeof= "+typeof v);B=d.getElementChildren(B);for(v=0;v<B.length;v++)switch(d.getElementName(B[v])){case "group":f(B[v],
r);break;case "outOfOrderMessage":n.getTopLevelGroup().setDefaultBuggyMsg(d.getNodeTextValue(B[v]))}a.addGroup(void 0)}r=g.getSkillBarVector(!1,!0);if(!r||1>r.length)ctatdebug("No existing skills. Add skills from BRD."),g.addGraphSkills(q),r=g.getSkillBarVector();h=(new CTATTutorMessageBuilder).createStateGraphMessage(m,u,p,g.isSourceFlash()?a.exitOnIncorrectDone():g.isFeedbackSuppressed(),x,String(g.getConfirmDone()),r);a.redoLinkDepths();c=a.getExampleTracer();c.resetTracer();a.forDebugging();ctatdebug("Graph loaded.");
...
h=null,n=null,m=null,B=d.getStudentSAI();B&&(h=B.getSelection())&&(n=B.getAction())&&(g="done"==String(h).toLowerCase()&&"buttonpressed"==String(n).toLowerCase());b.setCompletionStatus(e,CTATGlobals.confirmDone);l.ctatdebug("updateProblemSummary() Completion status "+e+", doneStep "+g+", correct "+f);g&&(e=f?(m=B.getInput())&&"-1"!=m?m:CTATMsgType.CompletionValue[1]:CTATMsgType.CompletionValue[0],b.setCompletionStatus(e,!0));e.startsWith(CTATMsgType.CompletionValue[1])?(b.stopTimer(),c&&c.setOutputStatus(CTATProblemStateStatus.complete)):
...
l.ctatdebug("flushMessageTank() after updateProblemSummary; messageTank.length "+a.length);for(var n=[],q=[],u=0;u<a.length;++u){var x=a[u];if(x.msg){var r=x.msgType,y=x.evt;l.ctatdebug("entering processInterfaceVariables() msgType "+r+", evt "+y);if(r){var z=c?c.getTracer():null;l.ctatdebug("entering processInterfaceVariables() et "+c+", tracer "+z);r=r.toLowerCase();(0===r.indexOf("correct")||0===r.indexOf("interfaceaction"))&&z&&z.addInterfaceVariablesFromEvent(y)}if(!(r=f(x)))if(r=x,y=q,CTATConfiguration.usingFlash()){var B=
z=void 0;if(!(r&&r.sai&&(z=r.sai.getAction())&&(B=CTATSAI.delayedActionRegExp.exec(z)))||3>B.length||1>=B[2])r=!1;else{var v=y.length-1,v=0>v?null:y[v];r.msg=r.msg.replace(z,B[1]);v&&v.timeout==B[2]?v.msgTuples.push(r):y.push({timeout:Number(B[2]),msgTuples:[r]});r=!0}}else r=!1;r||n.push(x.msg)}}l.ctatdebug("flushMessageTank(): msgBundle.length "+n.length+", delayedMsgsBundle.length "+q.length);for(u=0;u<q.length;++u)x=q[u],l.ctatdebug("processDelayedMsgs() delayedMsgs.timeout "+x.timeout+", .msgTuples.length "+
x.msgTuples.length),setTimeout(e,x.timeout,c,x.msgTuples);0<n.length&&(l.ctatdebug("Bottom of flushMessageTank(); to send bundle of length "+n.length+" via "+c),c.sendBundle(n)&&(l.ctatdebug("CTATMessageTank.shouldSaveNow() resultTypes "+h+", msgTypes "+d),(h[CTATExampleTracerLink.CORRECT_ACTION]||h[CTATExampleTracerLink.FIREABLE_BUGGY_ACTION]||d.CorrectAction||d.InterfaceAction||d.UntutoredAction||c.isFeedbackSuppressed()&&d.AssociatedRules)&&c.isSendingSavedMsgsForRestore()&&(CTATGlobalFunctions.isInstructorMode()?
...
SCORMProblemSummary.SESSION_TIME);return g+f+e+b};CTATMsgType.prototype=Object.create(CTATBase.prototype);CTATMsgType.prototype.constructor=SCORMProblemSummary;"undefined"!==typeof module&&(module.exports=SCORMProblemSummary);var CTATExampleTracer=function(){function b(){return"example"===B&&C&&C.getModelInitialized()||"rule"===B&&A&&A.getModelInitialized()}function g(b,c){c?ea|=1<<b:(ea&=-65537>>16-b,a())}function f(a){if(v.isFeedbackSuppressed()){var b=new CTATSAI("hint","SetVisible","false"),b=(new CTATTutoringServiceMessageBuilder).createInterfaceActionMessage("dummyTransactionID",b);a.push(b)}}function e(){return"<message><verb>NotePropertySet</verb><properties><MessageType>"+CTATMsgType.INTERFACE_REBOOT+"</MessageType></properties></message>"}
function c(a){a.unshift(e());v.ctatdebug("sendStartStateMessageStrings(): "+a.length+" elts, "+O);v.sendBundle(a)}function a(){v.ctatdebug("workTheQueue() working "+ea+", workQueue.length "+W.length+", restoreQueue.length "+U.length);if(0==ea)for(;0!=(ea=0<W.length|(0<U.length)<<1);){var a,b=!1;0<U.length?(T=1,a=U.shift(),b=!0):(T=0,a=W.shift());if(!d(a,b)){v.ctatdebug("workTheQueue() suspending workQueue.length "+W.length+", restoreQueue.length "+U.length);v.stopWorking(b?1:0);break}v.ctatdebug("workTheQueue() bottom workQueue.length "+
W.length+", restoreQueue.length "+U.length)}}function d(a,c){v.lastMessageAsString=a;var d=v.lastMessageAsXML=(new CTATXML).parseXML(a),f=v.lastMessage=new CTATMessage(d),g=f.getMessageType();v.ctatdebug("CTATExampleTracer.handleMessageFromInterface(msgType "+g+")");switch(g){case CTATMsgType.SET_PREFERENCES:g=w;v.ctatdebug("handleSetPreferences ()");N=f.getProperty("problem_name");v.ctatdebug("SetPreferences.problem_name = "+N);f=g.getElementChildren(g.getElementChildren(d)[1]);for(d=0;d<f.length;d++){var h=
...
g=!1),g;default:return console.log("CTATExampleTracer.handleMessageFromInterface(restoring "+c+") "+(c?"sending":"unprocessed")+" message, type "+g+"\n  "+a),c&&v.sendBundle([a]),!0}}function h(a,b,c){var d={tutorAdvice:null,msg:null,msgType:null};d.tutorAdvice=a.getSuccessOrBuggyMsg();d.tutorAdvice&&d.tutorAdvice.trim()?(d.msg=c.createBuggyMessage(a.getTransactionID(),d.tutorAdvice),d.msgType="BuggyMessage"):d.tutorAdvice=null;if(a.isBuggyResult())return d;v.ctatdebug("CTATET.createBuggyMessage() past getReportableLink()");
...
a.getTutorSAI(),r(CTATMsgType.DEFAULT_STUDENT_ACTOR),v.getSkillBarVector(!0),e,b,m(a.getCustomFields(),{rules:a.getAssociatedRules()}));v.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES,b,a,null);b=v.getProblemSummary(a.getReportableInterpretation());v.messageTank.flushMessageTank(b,!0);v.ctatdebug("handleInterfaceAction() sent hint result "+a);G=null;v.restartWorking();return a}function q(a,b){v.ctatdebug("doNewTrace ( "+a+", "+b+" )");var c=b.shift(),d=b.shift(),e=b.shift(),f=b.shift(),
...
if(a.getResult()===CTATExampleTracerLink.CORRECT_ACTION){CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase()!=c.toUpperCase()&&v.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION,n.createCorrectActionMessage(g,f),a,f);v.updateSkills(CTATExampleTracerSkill.CORRECT,b,a.getStepID(),c);b=a.getSuccessOrBuggyMsg();var w=n.createAssociatedRulesMessageForAction(a.getResult(),f,r(c),e,v.getSkillBarVector(!0,c),p?p.getUniqueID():a.getStepID(),g,b,a.isOutOfOrder(),m(a.getCustomFields(),{rules:a.getAssociatedRules()}),
a.getTraceOutcome());v.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES,w,a,f);v.ctatdebug("finishNewExampleTrace() successMsg "+b);b&&v.messageTank.addToMessageTank("SuccessMessage",n.createSuccessMessage(g,b),a,null);G=null;d&&(q=l(p?p.getNextNode():null,C.findCurrentState(!1,!1),v.lastMessage?v.lastMessage.getSAI():null,a))&&(a=q);return u()}v.messageTank.addToMessageTank(CTATMsgType.INCORRECT_ACTION,n.createInCorrectActionMessage(g,a.getInterpolatedSAI()),a,null);v.ctatdebug("about to do silent traceForHint("+
e+"), selectionArray "+e.getSelectionArray());var x=v.lastSilentHintResult=new CTATExampleTracerEvent(v,e,c);x.setHintRequest(!0);b=function(){var b=a.getAssociatedSkills()||[],m=a.getStepID()||"";v.updateSkills(CTATExampleTracerSkill.INCORRECT,b,m,c);f=a.getTutorSAI();b=h(a,x,n);v.ctatdebug("createBuggyMessage() tutorAdvice: "+b.tutorAdvice+";\n  msg "+b.msg);m=n.createAssociatedRulesMessageForAction(a.getResult(),f&&f.getSelection()?f:e,r(c),e,v.getSkillBarVector(!0,c),m,g,b.tutorAdvice,a.isOutOfOrder(),
a.getCustomFields(),a.getTraceOutcome());v.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES,m,a,null);b.msg&&v.messageTank.addToMessageTank(b.msgType,b.msg,a);G=e;d&&CTATExampleTracerLink.FIREABLE_BUGGY_ACTION==a.getResult()?(q=l(p?p.getNextNode():null,C.findCurrentState(!1,!1),v.lastMessage?v.lastMessage.getSAI():null,a))&&(a=q):a.isDoneStepFailed()&&v.messageTank.flushDelayedFeedback();return u()};if("example"===B)return z(a,x),b();"rule"===B&&(a.setCustomFields(m(a.getCustomFields(),{rules:a.getAssociatedRules()})),
b())}function z(a,b){var c=C.traceForHint(b);v.ctatdebug("silent hint result: "+b+"; hintLink "+c);c||(c=C.getBestNextLink(!1,b),v.ctatdebug("getBestNextLink result: "+b+"; hintLink "+c));c&&((c=b.getTutorSAI())&&c.getSelection()&&a.setTutorSAI(c),a.setStepID(b.getStepID()),a.setAssociatedSkills(b.getAssociatedSkills()),a.setReportableInterpretation(b.getReportableInterpretation()))}CTATBase.call(this,"CTATExampleTracer","tracer");var B=null,v=this,E=null,C,A,F=null,K,H,w=new CTATXML;new XMLSerializer;
var G=null,I,S=!0,Q=!0,L=!1,D=null,N=null,P=null,V=new ProblemStateSaver(v);V.setAuthenticityToken(CTATCommLibrary.getAuthenticityToken());var R=null,T=1,O=new CTATProblemStateStatus,U=[],W=[],ea=0,ia="",ga=-1,da=null;v.ctatdebug("CTATExampleTracer constructor outputStatus="+O);this.messageTank=this.lastSilentHintResult=this.lastResult=this.lastMessage=this.lastMessageAsXML=this.lastMessageAsString=null;var oa=new CTATCommLibrary;this.receiveFromInterface=function(b){v.ctatdebug("CTATExampleTracer.receiveFromInterface() \n  "+
...
null),b.push(q("example",[a[d],a[d].getDefaultSAI(),a[d].getActor(),!1,null])),v.ctatdebug("traceLinks["+d+"] result "+b[d]));return b};this.enqueueForRestore=function(a){v.ctatdebug("enqueueForRestore() tracerReady "+b()+": got "+(a?a.length:-1)+" message elements");null==F&&null!=a&&(F=a);null!=F&&(U=U.concat(F),F=null,a=(new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,null),U.push(a),T=1,b()&&v.startWorking())};this.restartWorking=function(){"rule"===B&&g(T,!1)};this.startWorking=
...
this.processXML=function(a){if(null!=a){B="example";v.ctatdebug("processXML (), tutorType = "+B);v.ctatdebug("No of children"+w.getElementChildren(a).length);var b=new CTATGraphParser,d=b.parseGraph(a,v);H=d.gr;C=d.tracer;a=d.ssm;d=d.sgMsg;v.ctatdebug("sendStartStateMessages() nMsgs "+a.length+", outputStatus "+O);for(var e=[],g=new XMLSerializer,h=null,m=0;m<a.length;m++)if("message"==w.getElementName(a[m])){var n=g.serializeToString(a[m]),p=CTATMsgType.getMessageType(n);CTATMsgType.UNTUTORED_ACTION!=
p&&CTATMsgType.INTERFACE_ACTION!=p||v.setVariablesFromSAI(a[m],w);CTATMsgType.START_STATE_END==p?(f(e),h=n,e.push((new CTATTutoringServiceMessageBuilder).createInterfaceConfigurationEnd()),e.push((new CTATTutorMessageBuilder).createLockWidgetMsg(b.getLockWidget()))):e.push(n)}e.unshift(d);c(e);b=h;a:{a=[];d=H.getStartNode();e=CTATMsgType.START_STATE_END;g=d.getNodeID();h=null;m=ga;ga=-1;0>m&&(m=(m=H?H.getStudentStartsHereNode():null)?m.getNodeID():g);console.log("CTATExampleTracer.resetGoToState to transition1 destNodeID",
...
1],a=e.getReportableLink(),null!==a&&(d=a.getNextNode()));v.ctatdebug("advanceToStudentStartsHere() to check for TPA "+d+", "+e);l(d,C.findCurrentState(!1,!1),null,e)}a=[];b&&a.push(b);O.canRestore()||a.push((new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,null));0<a.length&&v.sendBundle(a);C.setModelInitialized(!0)}v.startWorking()};this.processNools=function(a){var b=new CTATTutorMessageBuilder;B="rule";A=new CTATRuleTracer("nools",v);A.initEngine(a,function(a,d){v.ctatdebug("nools engine compiled");
