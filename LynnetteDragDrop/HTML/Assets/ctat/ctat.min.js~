...
(u.insertRule("@"+(f&&"-"+f+"-"||"")+"keyframes "+e+"{0%{opacity:"+b+"}"+d+"%{opacity:"+a+"}"+(d+.01)+"%{opacity:1}"+(d+c)%100+"%{opacity:"+a+"}100%{opacity:"+b+"}}",u.cssRules.length),m[e]=1);return e}function e(a,c){var d=a.style,b,e;c=c.charAt(0).toUpperCase()+c.slice(1);if(void 0!==d[c])return c;for(e=0;e<n.length;e++)if(b=n[e]+c,void 0!==d[b])return b}function c(a,c){for(var d in c)a.style[e(a,d)||d]=c[d];return a}function a(a){for(var c=1;c<arguments.length;c++){var d=arguments[c],b;for(b in d)void 0===
a[b]&&(a[b]=d[b])}return a}function d(a,c){return"string"==typeof a?a:a[c%a.length]}function h(c){this.opts=a(c||{},h.defaults,q)}function l(){function a(a,c){return b("<"+a+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',c)}u.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(b,e){function f(){return c(a("group",{coordsize:l+" "+l,coordorigin:-n+" "+-n}),{width:l,height:l})}function h(b,h,l){g(v,g(c(f(),{rotation:360/e.lines*b+"deg",left:~~h}),g(c(a("roundrect",
{arcsize:e.corners}),{width:n,height:e.scale*e.width,left:e.scale*e.radius,top:-e.scale*e.width>>1,filter:l}),a("fill",{color:d(e.color,b),opacity:e.opacity}),a("stroke",{opacity:0}))))}var n=e.scale*(e.length+e.width),l=2*e.scale*n,m=-(e.width+e.length)*e.scale*2+"px",v=c(f(),{position:"absolute",top:m,left:m});if(e.shadow)for(m=1;m<=e.lines;m++)h(m,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(m=1;m<=e.lines;m++)h(m);return g(b,v)};h.prototype.opacity=
function(a,c,d,b){a=a.firstChild;b=b.shadow&&b.lines||0;a&&c+b<a.childNodes.length&&(a=(a=(a=a.childNodes[c+b])&&a.firstChild)&&a.firstChild)&&(a.opacity=d)}}var n=["webkit","Moz","ms","O"],m={},p,u,q={lines:12,length:7,width:5,radius:10,scale:1,corners:1,color:"#000",opacity:.25,rotate:0,direction:1,speed:1,trail:100,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",shadow:!1,hwaccel:!1,position:"absolute"};h.defaults={};a(h.prototype,{spin:function(a){this.stop();var d=this,e=d.opts,f=
d.el=b(null,{className:e.className});c(f,{position:e.position,width:0,zIndex:e.zIndex,left:e.left,top:e.top});a&&a.insertBefore(f,a.firstChild||null);f.setAttribute("role","progressbar");d.lines(f,d.opts);if(!p){var h=0,g=(e.lines-1)*(1-e.direction)/2,n,l=e.fps,m=l/e.speed,v=(1-e.opacity)/(m*e.trail/100),w=m/e.lines;(function H(){h++;for(var a=0;a<e.lines;a++)n=Math.max(1-(h+(e.lines-a)*w)%m*v,e.opacity),d.opacity(f,a*e.direction+g,n,e);d.timeout=d.el&&setTimeout(H,~~(1E3/l))})()}return d},stop:function(){var a=
...
g.getElementName(e));switch(l){case "Problems":b.processProblemsElement(e);break;case "ProblemSets":b.processProblemSetsElement(e);break;case "Assets":h=b.processAssetsElement(e,h)}}}};this.processProblemsElement=function(a){a=g.getElementChildren(a);b.ctatdebug("CTATPackage.processProblemsElement ... nChildren="+a.length);for(var c=[],d=0;d<a.length;d++){var e=a[d],f=g.getElementAttr(e,"problem_file"),l=g.getElementAttr(e,"student_interface"),w=g.getElementAttr(e,"name"),v=g.getElementAttr(e,"label"),
A=g.getElementAttr(e,"description");h[f]=f;h[l]=l;b.ctatdebug("Problem ["+d+"] desc: "+A+", ui: "+l+", brd: "+f);f=b.addProblem(f,l,w,v,A);f.setTutorFlag(g.getElementAttr(e,"tutor_flag"));e=g.getElementChildren(e);for(l=0;l<e.length;l++)if("Skills"==g.getElementName(e[l]))for(w=g.getElementChildren(e[l]),v=0;v<w.length;v++){var A=w[v],y=0;f.addSkillOpps({name:g.getElementAttr(A,"name"),category:g.getElementAttr(A,"category"),opportunities:Number.isNaN(y=Number.parseInt(g.getElementAttr(A,"occurrences")),
...
scrimIsUp);$("#scrim").remove();n.removeComponent();v.removeHTMLElements();waitScrim=scrimIsUp=!1;e="";v.ctatdebug("exit scrimDownForced() scrimIsUp "+scrimIsUp)};this.defaultClickHandler=function(){v.ctatdebug("defaultClickHandler ()");v.scrimDown()};this.setInAuthorTime=function(a){v.ctatdebug("setting inAuthorTime = "+a);authorTimeSet=!0;inAuthorTime=a;if(!a)warnScrim=errorScrim=!1,d&&null.removeChild(q);else if(errorScrim||warnScrim)for(var c in m)g(c)};this.getInAuthorTime=function(){return inAuthorTime}};
...
h[0]+", to: "+decodeURIComponent(h[1].replace(/\+/g," ")));g[decodeURIComponent(h[0])]="";for(var w=1;w<h.length;w++)g[decodeURIComponent(h[0])]+=(1<w?"=":"")+decodeURIComponent(h[w].replace(/\+/g," "));ctatdebug("Decoded args: "+g[decodeURIComponent(h[0])])}null!==g&&(ctatdebug("tutorPrep(): Assigning parsed arguments ..."),q=g);g=!1;for(var v in q)if(q.hasOwnProperty(v))switch(ctatdebug("Processing external FlashVar "+v+"("+q[v]+")"),v){case "GENERATED":"on"==q[v]&&(d.session_id=CTATGuid.guid(),
g=!0);break;case "BRD":d.question_file=q[v];break;case "BRMODE":d.BehaviorRecorderMode=q[v];break;case "PROBLEM":d.problem_name=q[v];break;case "DATASET":d.dataset_name=q[v];break;case "LEVEL1":d.dataset_level_name1=q[v];break;case "TYPE1":d.dataset_level_type1=q[v];break;case "LEVEL2":d.dataset_level_name2=q[v];break;case "TYPE2":d.dataset_level_type2=q[v];break;case "LEVEL3":d.dataset_level_name3=q[v];break;case "TYPE3":d.dataset_level_type3=q[v];break;case "LEVEL4":d.dataset_level_name4=q[v];break;
case "TYPE4":d.dataset_level_type4=q[v];break;case "USER":d.user_guid=q[v];break;case "SESSION":!1===g&&(d.session_id=q[v]);break;case "SOURCE":d.source_id=q[v];break;case "LOGTYPE":d.Logging=q[v];break;case "PORT":d.remoteSocketPort=q[v];break;case "REMOTEURL":d.remoteSocketURL=q[v];break;case "DISKDIR":d.log_to_disk_directory=q[v];break;case "log_service_url":d.log_service_url=q[v];break;case "URL":d.log_service_url=q[v];break;case "LOGURL":d.log_service_url=q[v];break;case "CONNECTION":d.tutoring_service_communication=
q[v];break;case "SUI":d.sui=q[v];break;case "VAR1":d.var1=q[v];break;case "VAL1":d.val1=q[v];break;case "VAR2":d.var2=q[v];break;case "VAL2":d.val2=q[v];break;case "VAR3":d.var3=q[v];break;case "VAL3":d.val3=q[v];break;case "VAR4":d.var4=q[v];break;case "VAL4":d.val4=q[v];break;case "SLOG":case "SessionLog":d.SessionLog=q[v];break;case "KEYBOARDGROUP":"Disabled"==q[v]&&(d.keyboard="disabled");"Auto"==q[v]&&(d.keyboard="auto");"On"==q[v]&&(d.keyboard="on");break;default:d[v]=q[v]}}return d};this.getCustomFields=
...
l.status&&(e=!0,m.ctatdebug("Received message (status 0): ("+l.responseText+"), status: "+l.status),h&&CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(u))),408==l.status&&(e=!0,m.ctatdebug("Received message (status 408): "+l.responseText),h&&CTATScrim.scrim.scrimDown()),502==l.status&&(e=!0,m.ctatdebug("Received message (status 502): "+l.responseText),h&&CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(ERROR_502))),200==l.status?(e=!0,m.ctatdebug("Processing 200 response ..."),
...
var u=!1;if(Array.isArray(b)&&Array.isArray(g)&&(Array.isArray(f)||null==f)&&(p.setSelectionArray(b),p.setActionArray(g),p.setInputArray(f),u=!0,0<b.length&&0<g.length)){p.setSAI(b[0],g[0],null==f?null:f[0],"String",e);return}null!==b&&""!==b&&p.setSelection(b);null!==b&&(p.setSAI(b,g,f,"String",e),u||(p.setSelectionArray(Array.isArray(b)?b:[b]),p.setActionArray(Array.isArray(g)?g:[g]),p.setInputArray(Array.isArray(f)?f:[f]),u=!0))};CTATSAI.prototype=Object.create(CTATBase.prototype);
...
var e=b,c=null,a=null;void 0==b&&(e=null);a="xml"==CTATConfig.parserType?new CTATXML:new CTATJSON;e&&(this.ctatdebug("messageParser "+a+", messageObj "+e),e.children&&this.ctatdebug(e.children));var d="ungraded",h=!1,l=!1,n=new CTATSkillSet,m="",p="",u="",q="",w="",v=!0,A,y=null,C=null,r=null,F=!1;this.setURL=function(a){A=a};this.getURL=function(){return A};this.assignSAI=function(a){l=!0;y=a};this.setTransactionID=function(a){p=a};this.getTransactionID=function(){return p};this.setGradeResult=function(a){d=
a};this.getGradeResult=function(){return d};this.getXMLObject=function(){return e};this.getSkillsObject=function(){return n};this.getCustomFields=function(){return C};this.getRules=function(){return r};this.getSuccessMessage=function(){return u};this.getBuggyMsg=function(){return q};this.getHighlightMsg=function(){return w};this.parse=function(){this.ctatdebug("parse ()");if(null!==e){this.ctatdebug("messageParser: "+a);this.ctatdebug("Root name: "+a.getElementName(e));"tool_message"==a.getElementName(e)?
...
p)}};this.parseSAI=function(){this.ctatdebug("parseSAI ()");var c="",b="",d="",v="",p=[],x=[],H=[];if("tool_message"==m){this.ctatdebug("Parsing s, a and i");c=a.getElementChildren(e);for(b=0;b<c.length;b++)if(d=c[b],"tool_message"==a.getElementName(d))for(d=a.getElementChildren(d),v=0;v<d.length;v++)p=d[v],"event_descriptor"==a.getElementName(p)&&(y=new CTATSAI,y.fromXMLInternal(p));l=!0}else{if(h){this.ctatdebug("isLogMessage ...");for(var J=a.getElementChildren(e),F=0;F<J.length;F++){var O=J[F];
if("event_descriptor"==a.getElementName(O))for(var O=a.getElementChildren(O),L=0;L<O.length;L++){var D=O[L];"selection"==a.getElementName(D)&&(c=a.getNodeTextValue(D),p.push(D));"action"==a.getElementName(D)&&(b=a.getNodeTextValue(D),x.push(D));"input"==a.getElementName(D)&&(d=a.getNodeTextValue(D),H.push(D));"prompt"==a.getElementName(D)&&(v=a.getNodeTextValue(D))}}}else for(this.ctatdebug("!isLogMessage ..."),J=a.getElementChildren(e),F=0;F<J.length;F++)if(O=J[F],"properties"==a.getElementName(O))for(O=
a.getElementChildren(O),L=0;L<O.length;L++){var D=O[L],P=a.getElementName(D);this.ctatdebug("Nodename: "+P);switch(P){case "URL":A=a.getNodeTextValue(D);break;case "Skills":n.parseByValue(D);break;case "SuccessMsg":u=c=a.getNodeTextValue(D);break;case "BuggyMsg":q=a.getNodeTextValue(D);break;case "Selection":c=a.getNodeTextValue(D);p.push(D);break;case "Action":b=a.getNodeTextValue(D);x.push(D);break;case "Input":d=a.getNodeTextValue(D);H.push(D);break;case "prompt":v=a.getNodeTextValue(D);break;
case "HighlightMsgText":w=a.getNodeTextValue(D);break;case "custom_fields":C=f(D);break;case "Rules":r=g(D)}}this.ctatdebug("SAI: "+c+","+b+","+d);""!==c&&null!==c?(y=new CTATSAI(c,b,d,v),y.setArrayFromElements(p),y.setArrayFromElements(x),y.setArrayFromElements(H),l=!0):(this.ctatdebug("No SAI found"),l=!1);this.ctatdebug("parseSAI () done, hassai: "+l+", ("+c+","+b+","+d+","+v+")")}};this.parseTransactionID=function(){this.ctatdebug("parseTransactionID()");if("tool_message"!=m){if(!h)for(var c=
...
function(a,b,h){var d=null,g=c.getSkill(b);null!==g&&"undefined"!==typeof g&&(g.setTransactionNumber(f),b=h+" "+b,e.has(b)||(e.add(b),g.updatePKnown(a),g.updateHistory(a),g.changeOpportunityCount(1)),CTATExampleTracerSkill.CORRECT.toString().toUpperCase()===a.toString().toUpperCase()&&e["delete"](b),d=g);return d};this.startTransaction=function(){++f};this.getSkill=function(a){var b=null===a||"undefined"===typeof a?null:a.toLowerCase(),b=g[b];c.ctatdebug("CTATSkills.getSkill("+a+") returns "+b);return b};
...
function(a){var c=document.getElementById(f.iframeId);f.ctatdebug("CTATSequencer.init() iframe "+c+", evt.data "+a.data);if(a.data&&/tutorready/i.test(a.data.command))try{c.contentWindow.CTATCommShell.commShell.assignDoneProcessor(f.advanceToNextProblem.bind(f))}catch(A){throw Error("CTATSequencer.init() error adding listener to iframe '"+f.iframeId+": "+A);}})};this.getSequenceType=function(){return"fixed"};this.advanceToNextProblem=function(a){f.ctatdebug("advanceToNextProblem()\n psResp "+a);f.processProblemSummaryResponse(a);
...
function(a,c,b,d,e,h,g){f.ctatdebug("logSemanticEvent ("+g+")");f.initCheck();r=c;var n=new Date,l=f.extCommLogMessageBuilder||new CTATLogMessageBuilder;l.resetCustomFields();l.addCustomFields(e,h);l.addCustomField("tool_event_time",l.formatTimeStamp(n)+" UTC");a=l.createSemanticEventToolMessage(c,a,b,d,!0,g);this.sendMessage(a,{datashopType:"tool",semanticName:b,sai:c})};this.logTutorResponse=function(a,c,b,d,e,h,g,n,l){f.ctatdebug("logTutorResponse ()");f.initCheck();r=c;var m=new Date,v=f.extCommLogMessageBuilder||
new CTATLogMessageBuilder;v.resetCustomFields();v.addCustomFields(n,l);v.addCustomField("tutor_event_time",v.formatTimeStamp(m)+" UTC");f.ctatdebug("Formatting feedback ...");void 0!=h&&null!=h?h="<![CDATA["+CTATGlobals.languageManager.filterString(h)+"]]\x3e":(f.ctatdebug("No feedback provided, using empty string"),h="");f.ctatdebug("Creating tutor message ...");a=v.createTutorMessage(c,a,b,e,h,d,g,!0);this.sendMessage(a,{datashopType:"tutor",semanticName:b,stepID:v.getStepID(),sai:c,evaluation:e&&
...
l=!l||/tutor/i.test(l)?"tutor":l;f.updateLastActionTimestamp&&f.updateLastActionTimestamp();var n=a.getElementChildren(h);e.ctatdebug("Generated CTATMessage, now doing regular processing ...");for(var u=0;u<n.length;u++){var q=n[u];if("properties"==a.getElementName(q)){e.ctatdebug("Parsing properties ...");for(var w=a.getElementChildren(q),v=0;v<w.length;v++){var A=w[v];if("MessageType"==a.getElementName(A)){A=a.getNodeTextValue(A);e.ctatdebug("MessageType: "+A);switch(A){case "StateGraph":ctatdebug("Setting inStartState to true");
...
g);break;case "AssociatedRules":e.ctatdebug("Found: AssociatedRules ("+w.length+")");for(var y=A="",C="",r=0;r<w.length;r++){var F=w[r];switch(a.getElementName(F)){case "TutorAdvice":A=a.getNodeTextValue(F);break;case "Actor":l=a.getNodeTextValue(F);break;case "Indicator":y=a.getNodeTextValue(F);break;case "StepID":a.getNodeTextValue(F);break;case "LogAsResult":a.getNodeTextValue(F);break;case "tool_selection":case "StudentSelection":C=a.getNodeTextValue(F);break;case "Skills":e.ctatdebug("Processing skills ..."),
null===CTATSkillSet.skills&&(e.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."),CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(F)}}f.processAssociatedRules(g,y,A,C);b.propagateShellEvent("AssociatedRules",g,l);break;case "BuggyMessage":e.ctatdebug("Found: BuggyMessage");f.processBuggyMessage(g);b.propagateShellEvent("BuggyMessage",g);break;case "SuccessMessage":e.ctatdebug("Found: SuccessMessage");f.processSuccessMessage(g);b.propagateShellEvent("SuccessMessage",
g);break;case "InterfaceAction":e.ctatdebug("Found: InterfaceAction");A=g.getSAI();-1!=A.getAction().indexOf(":")?(e.ctatdebug("Processing and storing timed interface action : "+A.getAction()),y=parseInt(A.getAction().substring(A.getAction().indexOf(":")+1)),e.ctatdebug("Target time: "+y),A.setAction(A.getAction().substring(0,A.getAction().indexOf(":"))),e.ctatdebug("Timing ..."),setTimeout(f.processInterfaceAction,y,g),setTimeout(b.propagateShellEvent,y,"InterfaceAction",g,l)):(e.ctatdebug("Processing regular (non-timed) interface action"),
!0===CTATMessageHandler.inStartState?(e.ctatdebug("inStartState==true => storing for later playback ..."),c.push(g)):(f.processInterfaceAction(g),b.propagateShellEvent("InterfaceAction",g,l)));break;case "UntutoredAction":e.ctatdebug("Found: UntutoredAction");A=g.getSAI();-1!=A.getAction().indexOf(":")?(e.ctatdebug("Processing and storing timed interface action : "+A.getAction()),y=parseInt(A.getAction().substring(A.getAction().indexOf(":")+1)),e.ctatdebug("Target time: "+y),A.setAction(A.getAction().substring(0,
A.getAction().indexOf(":"))),e.ctatdebug("Timing ..."),setTimeout(f.processUntutoredAction,y,g),setTimeout(b.propagateShellEvent,y,"UntutoredAction",g,l)):(e.ctatdebug("Processing regular (non-timed) interface action"),!0===CTATMessageHandler.inStartState?(e.ctatdebug("inStartState==true => storing for later playback ..."),c.push(g)):(f.processUntutoredAction(g),b.propagateShellEvent("UntutoredAction",g,l)));break;case "InterfaceIdentification":e.ctatdebug("Found: InterfaceIdentification");b.propagateShellEvent("InterfaceIdentification",
g);break;case "AuthorModeChange":e.ctatdebug("Found: AuthorModeChange");f.globalReset();b.propagateShellEvent("AuthorModeChange",g);break;case "ResetAction":e.ctatdebug("Found: ResetAction");f.globalReset();b.propagateShellEvent("ResetAction",g);break;case "ShowHintsMessage":e.ctatdebug("Found: ShowHintsMessage");A=!1;y=[];for(C=0;C<w.length;C++)if(r=w[C],"HintsMessage"==a.getElementName(r))for(r=a.getElementChildren(r),F=0;F<r.length;F++){var B=r[F];"value"==a.getElementName(B)&&(y.push(a.getNodeTextValue(B)),
A=!0)}!0===A?f.processHintResponse(g,y):e.ctatdebug("Error: incomplete hint message received");b.propagateShellEvent("ShowHintsMessage",g);break;case "ConfirmDone":e.ctatdebug("Found: ConfirmDone");f.processConfirmDone(g);b.propagateShellEvent("ConfirmDone",g);break;case "VersionInfo":e.ctatdebug("Found: VersionInfo");f.processVersionInfo(w);b.propagateShellEvent("VersionInfo",g);break;case "TutoringServiceAlert":e.ctatdebug("Found: TutoringServiceAlert");f.processTutoringServiceAlert(w);b.propagateShellEvent("TutoringServiceAlert",
g);break;case "TutoringServiceError":A=g.getProperty("Action");e.ctatdebug("Found: TutoringServiceError - actor "+l+", action "+A);var z;A&&(z=CTATSAI.delayedActionRegExp.exec(A))&&2<z.length&&1<z[2]?(y=parseInt(z[2]),g.setProperty("Action",z[1]),e.ctatdebug("Delaying TutoringServiceError by "+y+" ..."),setTimeout(f.processTutoringServiceError,y,g),setTimeout(b.propagateShellEvent,y,"TutoringServiceError",g,l)):(f.processTutoringServiceError(g),b.propagateShellEvent("TutoringServiceError",g,l));break;
...
c.length+")");for(var b="Unknown",d="Unknown",f=null,g=0;g<c.length;g++){var h=c[g];e.ctatdebug("Inspecting element: "+a.getElementName(h));"WidgetType"==a.getElementName(h)&&(e.ctatdebug("Widget type: "+a.getNodeTextValue(h)),b=a.getNodeTextValue(h));"CommName"==a.getElementName(h)&&(e.ctatdebug("Instance name: "+a.getNodeTextValue(h)),d=a.getNodeTextValue(h));if("serialized"==a.getElementName(h)){e.ctatdebug("Prepareing to de-serialize component ...");for(var l=a.getElementChildren(h),v=0;v<l.length;v++){var A=
l[v];-1!=a.getElementName(A).indexOf("CTAT")&&(f=A)}}"interface"==a.getElementName(h)&&(e.ctatdebug("Storing interface for post start-state reconstruction ..."),CTATGlobals.interfaceElement=h);"script"==a.getElementName(h)&&(e.ctatdebug("Storing and loading main javascript code as defined by the BRD ..."),scriptElement=a.getNodeTextValue(h))}null!==f?this.deserializeComponent(b,d,f):e.ctatdebug("Error: unable to find CTAT serialization point of attachement");e.ctatdebug("processInterfaceDescription () done")};
...
(function(b){function g(){var a=arguments[0],c=g.cache;c[a]&&c.hasOwnProperty(a)||(c[a]=g.parse(a));return g.format.call(null,c[a],arguments)}function f(a){return Object.prototype.toString.call(a).slice(8,-1).toLowerCase()}var e=/[^s]/,c=/[def]/,a=/^[^\x25]+/,d=/^\x25{2}/,h=/^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/,l=/^([a-z_][a-z_\d]*)/i,n=/^\.([a-z_][a-z_\d]*)/i,m=/^\[(\d+)\]/,p=/^[\+\-]/;g.format=function(a,b){var d=1,h=a.length,l,n=[],m,q,w,u,E=!0,
I="";for(m=0;m<h;m++)if(l=f(a[m]),"string"===l)n[n.length]=a[m];else if("array"===l){w=a[m];if(w[2])for(l=b[d],q=0;q<w[2].length;q++){if(!l.hasOwnProperty(w[2][q]))throw Error(g("[sprintf] property '%s' does not exist",w[2][q]));l=l[w[2][q]]}else l=w[1]?b[w[1]]:b[d++];"function"==f(l)&&(l=l());if(e.test(w[8])&&"number"!=f(l)&&isNaN(l))throw new TypeError(g("[sprintf] expecting number but found %s",f(l)));c.test(w[8])&&(E=0<=l);switch(w[8]){case "b":l=l.toString(2);break;case "c":l=String.fromCharCode(l);
break;case "d":l=parseInt(l,10);break;case "e":l=w[7]?l.toExponential(w[7]):l.toExponential();break;case "f":l=w[7]?parseFloat(l).toFixed(w[7]):parseFloat(l);break;case "o":l=l.toString(8);break;case "s":l=(l=String(l))&&w[7]?l.substring(0,w[7]):l;break;case "u":l>>>=0;break;case "x":l=l.toString(16);break;case "X":l=l.toString(16).toUpperCase()}if(!E||c.test(w[8])&&w[3])I=E?"+":"-",l=l.toString().replace(p,"");q=w[4]?"0"==w[4]?"0":w[4].charAt(1):" ";u=w[6]-(I+l).length;u=w[6]?Array(u+1).join(q):
"";n[n.length]=w[5]?I+l+u:0==q?I+u+l:u+I+l}return n.join("")};g.cache={};g.parse=function(c){for(var b,e=[],f=0;c;){if(null!==(b=a.exec(c)))e[e.length]=b[0];else if(null!==(b=d.exec(c)))e[e.length]="%";else if(null!==(b=h.exec(c))){if(b[2]){var f=f|1,g=[],p=b[2],q;if(null!==(q=l.exec(p)))for(g[g.length]=q[1];""!==(p=p.substring(q[0].length));)if(null!==(q=n.exec(p)))g[g.length]=q[1];else if(null!==(q=m.exec(p)))g[g.length]=q[1];else throw new SyntaxError("[sprintf] failed to parse named argument key");
else throw new SyntaxError("[sprintf] failed to parse named argument key");b[2]=g}else f|=2;if(3===f)throw Error("[sprintf] mixing positional and named placeholders is not (yet) supported");e[e.length]=b}else throw new SyntaxError("[sprintf] unexpected placeholder");c=c.substring(b[0].length)}return e};var u=function(a,c,b){b=(c||[]).slice(0);b.splice(0,0,a);return g.apply(null,b)};"undefined"!==typeof exports?(exports.sprintf=g,exports.vsprintf=u):(b.sprintf=g,b.vsprintf=u,"function"===typeof define&&
define.amd&&define(function(){return{sprintf:g,vsprintf:u}}))})("undefined"===typeof window?this:window);var CTATTransactionListener=function(b){function g(a){return a&&"function"==typeof a.getTransactionID?a.getTransactionID():null}function f(a){h.ctatdebug("formatTimeStamp ("+a+")");return sprintf("%04d-%02d-%02d %02d:%02d:%02d.%03d UTC",a.getUTCFullYear(),a.getUTCMonth()+1,a.getUTCDate(),a.getUTCHours(),a.getUTCMinutes(),a.getUTCSeconds(),a.getUTCMilliseconds())}function e(a,c){for(var b,d,e=1;;++e){var f=c+"_type"+e,g=c+"_name"+e;b=CTATConfiguration.get(f);d=CTATConfiguration.get(g);if(!b||!d)break;
...
u);l=l=null;break a}l=void 0}this.isReady=function(){return null!=h.mailerProxy};this.toString=function(){return"transactions sent to ["+h.process_transactions_url+":]"};this.processCommShellEvent=function(b,q,w){console.trace("CTATTransactionListener.processCommShellEvent("+b+", "+q+", "+w+")");try{var v=null;switch(b){case "InterfaceAction":case "AssociatedRules":case "UntutoredAction":case "NextPressed":case "PreviousPressed":var u=q;q&&q.constructor!=CTATMessage&&(u=q.constructor!=Element?p.parse(u):
u,u=new CTATMessage(u));var y=u;h.ctatdebug("CTATTransactionListener.makeOrCompleteTransaction("+b+") pointer "+h+", problemInfo null, pointer.problemInfo "+(h?h.problemInfo:null));var C=u=null,r=!1;if(C=g(y)){var F,B;b:switch(b){case "UntutoredAction":B=!1;break b;case "InterfaceAction":B="tutor-performed"!=d(y,"subtype").toLowerCase();break b;default:B=!0}if(F=!(r=!B)){var z;B=C;var E=n[B];E?(delete n[B],--m,h.ctatdebug("CTATTransactionListener.removeIncompleteTransaction("+B+") count now "+m),
z=E):z=null;F=(u=z)&&(r=!0)}F||(u={meta:h.problemInfo.meta,context:h.problemInfo.context});switch(b){case "AssociatedRules":case "NextPressed":case "PreviousPressed":w=u;w.tutor_data&&console.log("Warning: CTATTransactionListener.addTutorInfo("+b+") tx has tutor_data with time "+w.tutor_data.tutor_event_time);w.tutor_data={};w.tutor_data.tutor_event_time=f(new Date);w.tutor_data.selection=d(y,"Selection");w.tutor_data.action=d(y,"Action");w.tutor_data.input=d(y,"Input");w.tutor_data.action_evaluation=
y.getIndicator();0<=w.tutor_data.action_evaluation.toLowerCase().indexOf("hint")&&(w.tutor_data.current_hint_number=d(y,"CurrentHintNumber"),w.tutor_data.total_hints_available=d(y,"TotalHintsAvailable"));w.tutor_data.tutor_advice=d(y,"TutorAdvice");var I=w.tutor_data;F=[];var G=CTAT.ToolTutor.tutor&&CTAT.ToolTutor.tutor.getProblemSummary()?CTAT.ToolTutor.tutor.getProblemSummary().getSkills():null,x=y.getSkillsObject().getSkillSet();for(z=0;z<x.length;++z){var H=x[z],J=CTATSkillSet.skills?CTATSkillSet.skills.getSkill(H.getSkillName()):
...
J.getPSlip())?"":L,E.pLearn=isNaN(L=J.getPLearn())?"":L);h.ctatdebug("CTATTransactionListener.createSkills() ssSk "+J+", tracerSk "+O+", skElt "+E);F.push(E)}}I.skills=F;w.tutor_data.step_id=d(y,"StepID");w.tutor_data.rule_names=a(y,"Rules");var D=w.tutor_data,P=y.getCustomFields();h.ctatdebug("CTATTransactionListener.createCustomFields() result "+P);D.custom_fields=P;break;default:u.meta.date_time=f(new Date);I=u;if(!(I.transaction_id=g(y)))throw Error("Message has no transaction_id: eventType "+
b+", msg\n  "+y);I.semantic_event="UntutoredAction"==b?"UNTUTORED-ACTION":c(b,y)?"HINT-REQUEST-HINTS":"ATTEMPT-RESULT";I.actor=w?w:"student";I.tool_data&&console.log("Warning: CTATTransactionListener.addToolInfo("+b+") tx has tool_data with time "+I.tool_data.tool_event_time);I.tool_data={};I.tool_data.tool_event_time=f(new Date);I.tool_data.selection=d(y,"Selection");I.tool_data.action=d(y,"Action");I.tool_data.input=d(y,"Input")}var S;if(r)S=u;else{var I=C,G=u,T=n[I];T&&(console.log("Warning: CTATTransactionListener.storeIncompleteTransaction() found tx with ID "+
I,T),--m);n[I]=G;++m;h.ctatdebug("CTATTransactionListener.storeIncompleteTransaction("+I+") count now "+m);S=null}v=S}else v=null;break;case "StartProblem":h.ctatdebug("CTATTransactionListener.createContextMessage()");S={};r=new Date;h.ctatdebug("TX.makeMetaElement ()");T={};T.date_time=f(r);T.session_id=CTATConfiguration.get("session_id");T.user_guid=CTATConfiguration.get("user_guid");S.meta=T;S.context={};var R=S.context,W=CTATLogMessageBuilder.contextGUID;if(!W)throw Error("Context message ID not yet defined");
...
U.problem_name=prop?prop:"";prop=CTATConfiguration.get("problem_context");U.problem_context=prop?prop:"";prop=CTATConfiguration.get("problem_tutorflag");U.problem_tutorFlag=prop?prop:"";e(U,"study_condition");u=S.context;T=0;if(y=CTATConfiguration.getCustomFields())for(C in u.custom_fields={},y)y.hasOwnProperty(C)&&(u.custom_fields[C]=y[C],++T);h.ctatdebug("CTATTransactionListener.createCustomFields() nAdded "+T+", cfs "+y);h.problemInfo=S;break;case "ProblemRestoreEnd":h.initializing=!1}v&&!h.initializing&&
l.sendTransaction(v)}catch(fa){console.log("Error in CTATTransactionListener.processCommShellEvent("+b+"): "+fa,fa.stack)}};ctatdebug("**<end of CTATTransactionListener constructor, process_transactions_url "+b+", mailerProxy "+l)};Object.defineProperty(CTATTransactionListener,"scriptParam",{enumerable:!1,configurable:!1,writable:!1,value:"process_transactions_url"});Object.defineProperty(CTATTransactionListener,"valueDelimiter",{enumerable:!1,configurable:!1,writable:!1,value:/<\/?value>/});
...
null!=u&&(ctatdebug("Calling custom grading processor ..."),u("INCORRECT",c));var b=c.getSelection();if(l[b]&&null!=n)n("INCORRECT",c);else{var d=CTATShellTools.findComponent(b);if(null!==d)for(b=0;b<d.length;b++)ctatdebug("Calling setIncorrect on component ("+d[b].getClassName()+")..."),d[b].setIncorrect&&d[b].setIncorrect(c);else a.ctatdebug("Error: component is null for selection "+b)}};this.processHighlightMsg=function(c){a.ctatdebug("processHighlightMsg()");var b=c.getSelection(),d=CTATShellTools.findComponent(b);
...
b)};this.processAssociatedRules=function(c,d,f,g){var h="";a.ctatdebug("processAssociatedRules()");if(0==commMessageHandler.getInStartState()){logHintSAI=c.getSAI();var l,n=new CTATActionEvaluationData("");a.ctatdebug("Found tutor advice: "+f);"Hint"==d||"HintWindow"==d?(ctatdebug("Preparing log message to indicate a hint response","commShell"),n.setCurrentHintNumber(hintIndex+1),n.setTotalHintsAvailable(hints.length),n.setEvaluation("HINT"),l="HINT_MSG",hints[hintIndex]&&(f=hints[hintIndex])):("Correct"==
c.getIndicator()?n.setEvaluation("CORRECT"):n.setEvaluation("INCORRECT"),l="RESULT");ctatdebug("Adding custom field names ...");var m=[],p=[];m.push("step_id");p.push(c.getProperty("StepID"));var v=c.getInput();ctatdebug("CTATCommShell.processAssociatedRules() tutorInput: "+v);v&&(m.push("tutor_input"),p.push(v.toString()));if(v=c.getRules())m.push("rule_names"),p.push(v.toString());var v=c.getCustomFields(),q;for(q in v)m.push(q),p.push(v[q]);q=c.getSkillsObject();a.updateSkillWindow(q);ctatdebug("Sending log message ...");
null!=commLoggingLibrary?w?h=commLoggingLibrary.logTutorResponse(c.getTransactionID(),logHintSAI,l,"",n,f,q,m,p):c.suppressLogging():this.ctatdebug("Info: no logging library available!");"done"==logHintSAI.getSelection()&&"ButtonPressed"==logHintSAI.getAction()&&"Correct"==c.getIndicator()&&(l=e.createProblemSummaryRequestMessage(),b.sendXML(l,!1))}else a.updateSkillWindow(null);if((g=g&&CTATShellTools.findComponent(g))&&g.length)for(l=0;l<g.length;l++)ctatdebug("Calling processAssociatedRules on component ("+
g[l].getClassName()+")..."),g[l].processAssociatedRules&&g[l].processAssociatedRules(c,d,f,h);a.ctatdebug("processAssociatedRules() done");return h};this.processBuggyMessage=function(c){a.ctatdebug("processBuggyMessage()");this.showFeedback(c.getBuggyMsg())};this.processSuccessMessage=function(c){a.ctatdebug("processSuccessMessage()");this.showFeedback(c.getSuccessMessage())};this.processUntutoredAction=function(c,b){a.processInterfaceAction(c,b)};this.processInterfaceAction=function(c,b){a.ctatdebug('CTATCommShell.processInterfaceAction ("'+
c.getMessageType()+'")');var d=c.getProperty("trigger"),d=c.getProperty("subtype")||(d&&"data"==d.toLowerCase()?"tutor-performed":"");null!=commLoggingLibrary?w&&commLoggingLibrary.logSemanticEvent(c.getTransactionID(),c.getSAI(),"ATTEMPT",d):this.ctatdebug("Info: no logging library available!");if("root"==c.getSelection()||"_root"==c.getSelection()){a.ctatdebug("Info: selection is 'root', we'll call the function straight up ...");for(var d=[window,CTATCommShell.commShell],e=c.getAction(),f=c.getInput(),
g=0;g<d.length&&"function"!=typeof d[g][e];++g);if(g>=d.length)a.ctatdebug("Internal error: unable to find function: "+e);else{a.ctatdebug("Calling as: "+e+"("+f+")");try{d[g][e](f)}catch(z){a.ctatdebug("Internal error: unable to execute function: "+z.message)}}}else if(d=CTATShellTools.findComponent(c.getSelection()),null===d)a.ctatdebug("Internal error: unable to find pointer to component object");else if(0==d.length)a.ctatdebug("Error: no component found to call interface action on");else{e=d.length;
a.ctatdebug("Call the action on the component(s) -> ("+e+")...");for(f=0;f<e;f++)if(a.ctatdebug("About to call "+c.getAction()+" ("+c.getInput()+") on: "+c.getSelection()),g=d[f],"function"==typeof g.executeSAI&&g.executeSAI(c),a.ctatdebug("Method executed, continuing with post-processing ..."),1==commMessageHandler.getInStartState()){var h=c.getAction();h&&h.toLowerCase().startsWith("updatetext")&&!g.getDivWrap().className.includes("CTATTextField")&&g.setEnabled(!b)}a.ctatdebug("processInterfaceAction() Done")}};
...
h+l+n+e+"</scorm>");p=null}else n=new CTATXML,null!=d?d(n.xmlToString(c.getXMLObject()),f.sendSummary.bind(f,c)):f.sendSummary(c)};this.setGotProblemRestoreEnd=function(a){w=a};this.getGotProblemRestoreEnd=function(){return w};this.processProblemRestoreEnd=function(c){a.ctatdebug("processProblemRestoreEnd() scrimIsUp "+scrimIsUp);w=!0;a.getCommLibrary()&&a.getCommLibrary().sendTutorReady();a.hasTutorShopCable()||CTATScrim.scrim.scrimDown()};this.hasTutorShopCable=function(){var a=CTATConfiguration.getCustomFields();
...
try{document.close()}catch(A){alert("Error closing document: "+A.message)}try{document.write(c)}catch(A){alert("Error writing document: "+A.message)}}};this.updateSkillWindow=function(c){a.ctatdebug("updateSkillWindow()");CTATSkillSet.skills.untouchSkills();var b=CTATShellTools.findComponentByClass("CTATSkillWindow");null!==b?null!=c?b.updateSkillSet(c):b.drawComponent():a.ctatdebug("Info: no skill window available")};this.processComponentFocus=function(c){a.ctatdebug("processComponentFocus("+c.getName()+
...
CTATComponentReference.getComponentFromID=function(b){var g=CTATComponentReference.components;return g.hasOwnProperty(b)?(b=g[b],b.getElement()?b.getElement():null):null};CTATComponentReference.add=function(b,g){var f=new CTATComponentReference(b,g);return CTATComponentReference.components[f.getDiv().getAttribute("id")]=f};var CTATCompBase=function(b,g,f,e,c,a){CTATBase.call(this,b,g);var d=f||0,h=e||0,l=c||-2,n=a||-2,m=50,p=25,u=!1,q=!1,w="",v=!1,A=!0,y=null,C="",r=null;this.isTabIndexable=!0;var F=0,B=null,z=this,E=null,I="hidden",G=CTATGlobalFunctions.gensym.z_index(),x=CTATGlobalFunctions.gensym.div_id(),H=CTATGlobalFunctions.gensym.z_index(),J=CTATGlobalFunctions.gensym.div_id();this.setIsAbstractComponent=function(a){u=a};this.isAbstractComponent=function(){return u};this.setIsFeedbackComponent=function(a){q=
...
this.getSubCanvas=function(){return E};this.getX=function(){return d};this.getY=function(){return h};this.getWidth=function(){if(0>=l){var a;B?a=window.getComputedStyle(B):y&&(a=window.getComputedStyle(y));if(a)return parseFloat(a.width)}return l};this.getHeight=function(){if(0>=n&&y){var a=window.getComputedStyle(y);return parseFloat(a.getPropertyValue("height"))}return n};this.getText=function(){return w};this.getEnabled=function(){return A};this.assignEnabled=function(a){A=a;y.setAttribute("data-ctat-enabled",
A)};this.setEnabled=function(a){z.ctatdebug("setEnabled ("+a+")");z.assignEnabled(a);B?B.disabled=!A:z.ctatdebug("Error: component pointer is null")};this.lock=this.setEnabled.bind(z,!1);this.unlock=this.setEnabled.bind(z,!0);this.getDivWrap=function(){return y};this.getComponent=function(){return B};this.component=null;Object.defineProperty(this,"component",{get:function(){return B}});this.getCanvasZIndex=function(){return H};this.getComponentGroup=function(){return C};this.setComponent=function(a){B=
a;this.setEnabled(this.getEnabled())};this.getTopDivZIndex=function(){return G};this.getTopDivID=function(){return x};this.setComponentGroup=function(a){C=a;B&&(B.name=a)};this.assignText=function(a){w=a};this.init=function(){z.ctatdebug("THIS IS THE BASE INIT METHOD")};this.initialize=function(){z.ctatdebug("initialize ()");z.configFromDescription();z.init();z.processSerialization();z.render();z.processTabOrder();z.ctatdebug("initialize () done")};this.getInitialized=function(){return v};this.setInitialized=
function(a){z.ctatdebug("setInitialized ("+a+")");v=a;!0!==v||y?z.ctatdebug("Not wrapping, initialized="+v+", divWrapper = "+y):(z.ctatdebug("Wrapping a component and appending it to the top container div if one was never set ..."),(a=findPointOfAttachment(this.getName()))?(z.ctatdebug("Attaching component to existing MovieClip ..."),z.wrapComponent(a.getDivWrapper())):(z.ctatdebug("Attaching component to main div ..."),0<$("#"+ctatcontainer).length&&z.wrapComponent(getSafeElementById(ctatcontainer))));
...
a)};this.setParameterHandler("DisableOnCorrect",this.setDisableOnCorrect);var q=!0;this.getShowHintHighlight=function(){return q};this.setShowHintHighlight=function(a){q=CTATGlobalFunctions.toBoolean(a)};this.setParameterHandler("ShowHintHighlight",this.setShowHintHighlight);this.data_ctat_handlers["show-hint-highlight"]=function(a){q=CTATGlobalFunctions.toBoolean(a)};var w=CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED;this.getComponentStatus=function(){return w};this.setComponentStatus=
...
[],w=this;this.generateClassname=function(){return this.getName()+" UnitPart"};this.getPieces=function(){return q};var v=function(a){if(a.hasAttributeNS(null,"data-selected"))return CTATGlobalFunctions.toBoolean(a.getAttributeNS(null,"data-selected"));a.setAttributeNS(null,"data-selected",!0);return!0};this.getPiecesBySelected=function(a){for(var c=this.getPieces(),b=[],d,e=0;e<c.length;e++)d=c[e],v(d)===a&&b.push(d);return b};this.getSelectedPieces=this.getPiecesBySelected.bind(this,!0);this.getDeselectedPieces=
...
this.drawPieces=function(){if(this.baseGroup){this.clear();for(var c=this.parseValue(),b=0,e=document.createDocumentFragment(),f=0;f<c.length;f++){var g=c[f],p=100*g,u=document.createElementNS(a,"rect");u.classList.add("CTATFractionBar--piece");u.setAttributeNS(null,"height","100%");u.setAttributeNS(null,"width",p+"%");u.setAttributeNS(null,"y",0);u.setAttributeNS(null,"x",b+"%");this.addPieceElem(u,g,g.selected);e.appendChild(u);var q=document.createElementNS(a,"text");q.classList.add("CTATFractionBar--label");
q.setAttributeNS(null,"text-anchor","middle");q.setAttributeNS(null,"dominant-baseline","middle");e.appendChild(q);var u=""+String(g.numerator),g=""+String(g.denominator),w=document.createElementNS(a,"tspan"),v=document.createElementNS(a,"tspan");w.appendChild(document.createTextNode(u));v.appendChild(document.createTextNode(g));q.appendChild(w);q.appendChild(v);q=b+p/2;w.setAttributeNS(null,"x",q+"%");w.setAttributeNS(null,"y","60%");w.setAttributeNS(null,"dy","-1em");v.setAttributeNS(null,"x",q+
"%");v.setAttributeNS(null,"y","60%");u.length>g.length?w.style.textDecoration="underline":v.style.textDecoration="overline";b+=p}this.baseGroup.innerHTML="";this.baseGroup.appendChild(e);var A=this.baseGroup.getBBox().width-1;Array.prototype.slice.call(this.baseGroup.childNodes).forEach(function(a){if("rect"==a.nodeName){var c=window.getComputedStyle(a),b=parseFloat(c.getPropertyValue("padding-left")),d=parseFloat(c.getPropertyValue("stroke-width")),c=a.getBBox();a.setAttributeNS(null,"y",c.y+d/
...
CTATHintButton.prototype=Object.create(CTAT.Component.Base.Clickable.prototype);CTATHintButton.prototype.constructor=CTATHintButton;CTAT.ComponentRegistry.addComponentType("CTATHintButton",CTATHintButton);var CTATHintWindow=function(b,g,f,e,c){CTAT.Component.Base.Graphical.call(this,"CTATHintWindow","__undefined__",b,g,f,e,c);var a=this;a.isTabIndexable=!1;var d=CTATConfig.parserType_is_XML()?new CTATXML:new CTATJSON,h=new CTATTutorMessageBuilder,l=null,n=null,m=null,p=null,u=null,q=CTATGlobals.languageManager.getString("NEXT"),w=CTATGlobals.languageManager.getString("PREVIOUS"),v=null;this.data_ctat_handlers["next-content"]=function(a){v=a;p&&(p.innerHTML=a)};var A=null;this.data_ctat_handlers["previous-content"]=
function(a){A=a;m&&(m.innerHTML=a)};this.getCurrentHint=function(){return l.innerHTML};this.init=function(){a.ctatdebug("init ("+a.getName()+")");a.setInitialized(!0);a.setIsAbstractComponent(!0);u=this.getDivWrap();u.id||u.setAttribute("id",CTATGlobalFunctions.gensym.div_id());u.setAttribute("onkeypress","return noenter(event)");a.setComponent(u);a.addComponentReference(a,u);l=document.createElement("div");u.appendChild(l);l.classList.add("CTATHintWindow--hint-content");n=document.createElement("div");
u.appendChild(n);n.classList.add("CTATHintWindow--hint-indicator");var c=document.createElement("div");c.classList.add("CTATHintWindow--hint-button-area");u.appendChild(c);if(A)m=document.createElement("button"),m.classList.add("CTATHintWindow--previous"),m.innerHTML=A;else{m=document.createElement("button");m.classList.add("CTATHintWindow--previous");var b=document.createElement("span");b.classList.add("CTATHintWindow--button-icon");b.textContent="\u25c0";m.appendChild(b);w&&(b.style.cssFloat="left",
m.appendChild(document.createTextNode(w)))}m.addEventListener("click",function(a){CTATShellTools.showPrevHint()},!1);c.appendChild(m);v?(p=document.createElement("button"),p.classList.add("CTATHintWindow--next"),p.innerHTML=v):(p=document.createElement("button"),p.classList.add("CTATHintWindow--next"),b=document.createElement("span"),b.classList.add("CTATHintWindow--button-icon"),b.textContent="\u25b6",q&&(b.style.cssFloat="right",p.appendChild(document.createTextNode(q))),p.appendChild(b));p.addEventListener("click",
function(a){CTATShellTools.showNextHint()},!1);c.appendChild(p);var d=function(a){this.disabled=!a;a||(this.classList.remove("CTAT-hint-button--hover"),this.classList.remove("CTAT-hint-button--clicked"))};[m,p].forEach(function(a){a.setEnabled=d.bind(a);a.classList.add("CTATHintWindow--button");a.classList.add("CTAT-hint-button");a.addEventListener("mouseenter",function(a){a.target.classList.add("CTAT-hint-button--hover")});a.addEventListener("mouseleave",function(a){a.target.classList.remove("CTAT-hint-button--hover");
...
m.setEnabled(!1);p.setEnabled(!1)};this.setStyleHandler("OuterBorderColor",this.setBorderColor);this.SetText=this.showFeedback=function(c){a.ctatdebug("showFeedback ("+c+")");l&&(l.innerHTML=CTATGlobals.languageManager.filterString(c));m.setEnabled(!1);p.setEnabled(!1);n.innerHTML=""};this.showHint=function(c){a.ctatdebug("showHint ()");n.innerHTML="";hints=c||[];hintIndex=0;m.setEnabled(!1);p.setEnabled(!1);hints=hints.filter(function(a){return""!==a});if(!hints||0>=hints.length)hints=[],l.innerHTML=
"";else for(this.setEnabled(!0),l.innerHTML=CTATGlobals.languageManager.filterString(hints[hintIndex]),1<hints.length?(a.ctatdebug("We have more than one hint, enabling next button"),p.setEnabled(!0)):a.ctatdebug("We only have one hint, leaving next button disabled"),c=0;c<hints.length;c++){var b=document.createElement("span");b.classList.add("CTATHintWindow--hint-indicator-bullet");b.innerHTML=0===c?"&#9679;":"&#9675;";n.appendChild(b)}};this.setEnabled=function(c){a.assignEnabled(c);null===a.getComponent()?
a.ctatdebug("Error pointer.getComponent()==null"):a.getComponent().disabled=!c};this.goPrevious=function(){a.ctatdebug("goPrevious ()");hintIndex--;p.setEnabled(!0);0>=hintIndex?(hintIndex=0,m.setEnabled(!1)):m.setEnabled(!0);l.innerHTML=CTATGlobals.languageManager.filterString(hints[hintIndex]);var c=n.querySelectorAll(".CTATHintWindow--hint-indicator-bullet");c[hintIndex+1].innerHTML="&#9675;";c[hintIndex].innerHTML="&#9679;";var b=new CTATTutoringServiceMessageBuilder,c=CTATGuid.guid(),e=new CTATSAI("previousButton",
"ButtonPressed","-1"),b=b.createInterfaceActionMessage(c,e),e=new CTATSAI("previousButton","ButtonPressed","hint request");commLoggingLibrary.logSemanticEvent(c,e,"HINT_REQUEST","");CTATCommShell.commShell.propagateShellEvent("InterfaceAction",b);e=a.getCurrentHint();c=h.createAssociatedRulesMessageForHint([e],logHintSAI,"student",null,"",c,hints.length,hintIndex+1);c=new CTATMessage(d.parse(c));CTATCommShell.commShell.processAssociatedRules(c,"HintWindow",e);CTATCommShell.commShell.propagateShellEvent("PreviousPressed",
c)};this.goNext=function(){a.ctatdebug("goNext ()");hintIndex++;m.setEnabled(!0);hintIndex>hints.length-1&&(hintIndex=hints.length-1);hintIndex>hints.length-2?p.setEnabled(!1):p.setEnabled(!0);l.innerHTML=CTATGlobals.languageManager.filterString(hints[hintIndex]);var c=n.querySelectorAll(".CTATHintWindow--hint-indicator-bullet");c[hintIndex-1].innerHTML="&#9675;";c[hintIndex].innerHTML="&#9679;";var b=new CTATTutoringServiceMessageBuilder,c=CTATGuid.guid(),e=new CTATSAI("nextButton","ButtonPressed",
"-1"),b=b.createInterfaceActionMessage(c,e),e=new CTATSAI("nextButton","ButtonPressed","hint request");commLoggingLibrary.logSemanticEvent(c,e,"HINT_REQUEST","");CTATCommShell.commShell.propagateShellEvent("InterfaceAction",b);e=a.getCurrentHint();c=h.createAssociatedRulesMessageForHint([e],logHintSAI,"student",null,"",c,hints.length,hintIndex+1);c=new CTATMessage(d.parse(c));CTATCommShell.commShell.processAssociatedRules(c,"HintWindow",e);CTATCommShell.commShell.propagateShellEvent("NextPressed",
...
f.addEventListener("dragstart",l,!1);f.addEventListener("dragenter",m,!1);f.addEventListener("dragover",n,!1);f.addEventListener("dragleave",p,!1);f.addEventListener("drop",u,!1);f.addEventListener("dragend",q,!1);c.appendChild(f)}d.innerHTML="";d.appendChild(c)}};this.setParameterHandler("textItems",this.init_items);this.SetOrder=function(a){a.split(";").forEach(function(a){$(d).append($("#"+a))})};this.getOrder=function(){var c=[];$(d).children().each(function(){this.draggable&&(this.id?c.push(this.id):
...
e&&e.removeChild(c),d=g.xml(),Guppy.Doc.render(d,a.id),CTATMathInput.__osk&&CTATMathInput.__osk.guppy===g&&CTATMathInput.__osk.detach()))};var m=this.setCorrect;this.setCorrect=function(){d=!0;m.apply(this,arguments)};var p=this.showCorrect;this.showCorrect=function(){p.apply(this,arguments);a.style.color="darkgreen"};var u=this.setIncorrect;this.setIncorrect=function(){d=!1;u.apply(this,arguments)};var q=this.showIncorrect;this.showIncorrect=function(){q.apply(this,arguments);c.style.color="red"};
...
var m=1;Object.defineProperty(this,"Max_Points",{get:function(){return m},set:function(a){a=parseInt(a);isNaN(a)||(m=a)}});this.setMaxPoints=function(a){this.Max_Points=a};this.setParameterHandler("Max_Points",this.setMaxPoints);this.data_ctat_handlers["max-points"]=this.setMaxPoints;var p=7;this.setPointSize=function(a){p=Number(a);v&&(v.setAttributeNS(null,"r",p),$(this._point_group).find("circle").each(function(){$(this).attr("r",p)}))};this.setStyleHandler("PointSize",this.setPointSize);this.data_ctat_handlers["point-size"]=
...
-c,-c),b=new DOMPoint(a.width/2,a.height/2),e=b.add(CTAT.Geom.Point.polar(Math.min(40,a.height,a.width)/4,this.theta)),f=Math.sin(this.theta),g=-Math.cos(this.theta),m=f*b.x+g*b.y,p=-a.height*g,w=-f*a.width,c=new DOMPoint(a.left,b.y),b=new DOMPoint(a.right,b.y);if(0<Math.abs(CTAT.Math.round(p))){var p=new DOMPoint(a.left,(m-f*a.left)/g),q=new DOMPoint(a.right,(m-f*a.right)/g);if(a.contains(p)||a.contains(q))e.distance(p)<e.distance(q)?(c=q,b=p):(c=p,b=q)}0<Math.abs(CTAT.Math.round(w))&&(w=new DOMPoint((m-
...
[];c=document.createDocumentFragment();c.appendChild(h.generate());c.appendChild(l.generate());c.appendChild(n.generate());this._tick_mark_group.innerHTML="";this._tick_mark_group.appendChild(c);c=this._point_group.children;for(b=0;b<c.length;b++)a=c[b],e=this.X_Axis.getPosition(a.value),f=new DOMPoint(a.cx.baseVal.value,a.cy.baseVal.value),1<e.distance(f)&&(a.cx.baseVal.value=e.x,a.cy.baseVal.value=e.y)}}.bind(this),w=0,v=null,A=new DOMPoint(-30,-30),y=!1,C=function(a){A.x=a.clientX;A.y=a.clientY},
r=function(a){cancelAnimationFrame(w);v.style.visibility="hidden";y=!1},F=function(a){if(!0===this.getEnabled()&&0<m){this.setHintHighlight(!1);var c;u?(a=I(a.clientX,a.clientY),c=a.location,a=a.data):(a=z(a.clientX,a.clientY),c=this.X_Axis.getProjectedPoint(a),a=this.X_Axis.getAxisValue(a));var b=document.createElementNS(d,"circle");b.classList.add("CTATNumberLine--point");b.setAttributeNS(null,"cx",c.x);b.setAttributeNS(null,"cy",c.y);b.setAttributeNS(null,"r",p);b.value=a;if(this._point_group.children.length>=
...
this.component.appendChild(this._point_group);this.component.appendChild(v);this.X_Axis.svg_group=this._axis_line_group;q();this.addComponentReference(this,this.getDivWrap());this.component.addEventListener("mousemove",C);this.component.addEventListener("mouseleave",r);var a=this.getEnabled;this.component.addEventListener("mouseenter",function(){!0===a()&&0<m&&(y=!0,v.style.visibility=null,w=requestAnimationFrame(G))});this.component.addEventListener("click",F);this.component.addEventListener("focus",
...
d.classList.add("CTAT--incorrect")}break;case "set_minimum":U(R()).forEach(b);break;case "set_maximum":U(T()).forEach(b);break;case "set_large_step":U(W()).forEach(b);break;case "set_small_step":U(N()).forEach(b);break;case "set_denominator":U(Q()).forEach(b);break;default:console.log("Unhandled Action in",this.getName(),c)}};var H=this.setEnabled;this.setEnabled=function(a){H(a);v&&y&&(v.style.visibility=this.getEnabled()?null:"hidden")};this.set_minimum=function(a){this.Minimum=a;this.render()};
...
g.getLevel()+" ...");var u=document.createElement("div");u.classList.add("CTATSkillWindow--skill");var q=document.createElement("div");q.classList.add("CTATSkillWindow--bar");var w=document.createElement("div"),v=g.getLevel();v<e?w.classList.add("CTATSkillWindow--bar--nonmastered"):w.classList.add("CTATSkillWindow--bar--mastery");w.style.width=v>e?"100%":100*v+"%";q.appendChild(w);u.appendChild(q);b.appendChild(u);q=document.createElement("div");q.textContent=g.getDisplayName()||"no-name";q.classList.add("CTATSkillWindow--label");
u.appendChild(q)}d.innerHTML="";d.appendChild(b)}}}};CTATSkillWindow.prototype=Object.create(CTAT.Component.Base.Graphical.prototype);CTATSkillWindow.prototype.constructor=CTATSkillWindow;CTAT.ComponentRegistry.addComponentType("CTATSkillWindow",CTATSkillWindow);var CTATSubmitButton=function(b,g,f,e,c){CTATButton.call(this,b,g,f,e,c);this.setClassName("CTATSubmitButton");CTATConfiguration.get("previewMode");var a=this;this.setParameterHandler("target_components",function(a){this.getDivWrap().setAttribute("data-ctat-target",a);return this});var d=this.init;this.init=function(){d();this.setParameter("tutorComponent",CTAT.Component.Base.Tutorable.Options.DO_NOT_TUTOR);this.component.addEventListener("focus",this.processFocus)};var h=function(c){var b=a.getTargets();
...
b.object&&(d=c.aliases[e]);d?a[d]=b:console.warn("no alias found for "+JSON.stringify(b))});return a}function e(c,a){var d={},e="NotNode"===a.nodeType||"FromNotNode"===a.nodeType;switch(a.nodeType){case "BetaNode":case "NotNode":case "ExistsNode":var f=a.rightMemory,g,m=[],p;for(p in f)g=f[p].data.match,m.push(b(g));d.factBindings=m;break;case "JoinNode":var m=a.leftMemory,u,q=[];for(f in m)for(g in u=m[f].data.rightMatches,u)p=u[g].match,q.push(b(p));d.factBindings=q;break;case "FromNode":case "FromNotNode":f=
a.fromMemory;q=[];for(m in f)for(u in g=f[m],g)p=g[u][1],p.match&&q.push(b(p.match));d.factBindings=q;break;default:d.factBindings=[]}d.isMatch=d.factBindings.length&&!e||!d.factBindings.length&&e;return d}return function(c,a){var b=!0,f=c.getRuleData(a),g="";if(f){var n=f.memoryNodes,f=[].concat(f.patterns),m={},p=null,u,q,w,v=/("([^"]*)"):/g;try{for(var A=0;A<f.length;A++){var g=g+(p?"\n\t":'\npattern: "'),y=f[A];y.disjuncts&&(g+="or (\n\t",p=A-1+y.disjuncts.length,f.splice.apply(f,[].concat([A,
1],$jscomp.arrayFromIterable(y.disjuncts))),y=f[A]);g+=y.string+(p?"":'"');u=y.alias;m[u]||(m[u]=0);q=e(y,n[u][m[u]++]);q.isMatch||(g+=" NOT");g+=" MATCHED";(w=q.factBindings).length&&(g+=" - Possible bindings: ",w.forEach(function(a,c){for(var b in a)if("__i__"!==b){for(var d=JSON.stringify(a[b].object),e;e=v.exec(d);)d=d.replace(e[1],e[2]);g+="\n\t"+(p?"\t":"")+b+": "+d+" (fact ID "+a[b].id+")"}g+="\n"}));A===p&&(g+='\n)"',p=null);if(!q.isMatch){b=!1;break}}return g+"\nRule "+(b?"":"not ")+"matched"}catch(C){throw console.log("got here: "+
...
b.prototype.even=function(){return!1};return b}();"undefined"!==typeof module&&null!==module?module.exports=b:this.CTATAlgebraTreeNode=b}).call(this);var CTATRelationNode={};
...
new d.CTATVariableNode(d.variableTable,f[a]);break;case 26:this.$=new d.CTATConstantNode(Number(f[a]));break;case 27:this.$=new d.CTATUnknownNode}},table:[{3:1,4:2,6:3,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{1:[3]},{5:[1,15]},{5:[2,8],7:[1,16],8:[1,17],9:[1,18],10:[1,19],11:[1,20],12:[1,21],13:n,15:m},g(p,[2,11],{22:9,19:26,16:u,18:q,20:w,21:v,24:c,25:a,27:d,28:h,29:l}),g(A,[2,17]),{13:f,15:e,17:29,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{13:f,15:e,17:30,19:8,22:9,24:c,25:a,27:d,28:h,
29:l},g(A,[2,20]),g(A,[2,23],{23:[1,31]}),{13:f,15:e,17:32,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{6:33,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},g(y,[2,25]),g(y,[2,26]),g(y,[2,27]),{1:[2,1]},{6:34,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{6:35,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{6:36,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{6:37,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,28:h,29:l},{6:38,13:f,14:4,15:e,17:5,19:8,22:9,24:c,25:a,27:d,
...
{13:n,15:m,26:[1,47]},{5:[2,2],13:n,15:m},{5:[2,3],13:n,15:m},{5:[2,4],13:n,15:m},{5:[2,5],13:n,15:m},{5:[2,6],13:n,15:m},{5:[2,7],13:n,15:m},g(p,[2,9],{22:9,19:26,16:u,18:q,20:w,21:v,24:c,25:a,27:d,28:h,29:l}),g(p,[2,10],{22:9,19:26,16:u,18:q,20:w,21:v,24:c,25:a,27:d,28:h,29:l}),g(A,[2,12]),g(A,[2,13]),g(A,[2,15]),g(A,[2,16]),g(A,[2,21]),g(y,[2,24])],defaultActions:{15:[2,1]},parseError:function(a,c){if(c.recoverable)this.trace(a);else{var b=function(a,c){this.message=a;this.hash=c};b.prototype=
Error;throw new b(a,c);}},parse:function(a){var c=[0],b=[null],d=[],e=this.table,f="",g=0,h=0,l=0,n=d.slice.call(arguments,1),m=Object.create(this.lexer),p={},q;for(q in this.yy)Object.prototype.hasOwnProperty.call(this.yy,q)&&(p[q]=this.yy[q]);m.setInput(a,p);p.lexer=m;p.parser=this;"undefined"==typeof m.yylloc&&(m.yylloc={});q=m.yylloc;d.push(q);var w=m.options&&m.options.ranges;this.parseError="function"===typeof p.parseError?p.parseError:Object.getPrototypeOf(this).parseError;for(var u,v,A,y,
C={},W,N;;){A=c[c.length-1];if(this.defaultActions[A])y=this.defaultActions[A];else{if(null===u||"undefined"==typeof u)u=m.lex()||1,"number"!==typeof u&&(u=this.symbols_[u]||u);y=e[A]&&e[A][u]}if("undefined"===typeof y||!y.length||!y[0]){var Q;N=[];for(W in e[A])this.terminals_[W]&&2<W&&N.push("'"+this.terminals_[W]+"'");Q=m.showPosition?"Parse error on line "+(g+1)+":\n"+m.showPosition()+"\nExpecting "+N.join(", ")+", got '"+(this.terminals_[u]||u)+"'":"Parse error on line "+(g+1)+": Unexpected "+
(1==u?"end of input":"'"+(this.terminals_[u]||u)+"'");this.parseError(Q,{text:m.match,token:this.terminals_[u]||u,line:m.yylineno,loc:q,expected:N})}if(y[0]instanceof Array&&1<y.length)throw Error("Parse Error: multiple actions possible at state: "+A+", token: "+u);switch(y[0]){case 1:c.push(u);b.push(m.yytext);d.push(m.yylloc);c.push(y[1]);u=null;v?(u=v,v=null):(h=m.yyleng,f=m.yytext,g=m.yylineno,q=m.yylloc,0<l&&l--);break;case 2:N=this.productions_[y[1]][1];C.$=b[b.length-N];C._$={first_line:d[d.length-
(N||1)].first_line,last_line:d[d.length-1].last_line,first_column:d[d.length-(N||1)].first_column,last_column:d[d.length-1].last_column};w&&(C._$.range=[d[d.length-(N||1)].range[0],d[d.length-1].range[1]]);A=this.performAction.apply(C,[f,h,g,p,y[1],b,d].concat(n));if("undefined"!==typeof A)return A;N&&(c=c.slice(0,-2*N),b=b.slice(0,-1*N),d=d.slice(0,-1*N));c.push(this.productions_[y[1]][0]);b.push(C.$);d.push(C._$);y=e[c[c.length-2]][c[c.length-1]];c.push(y);break;case 3:return!0}}}},f=function(){return{EOF:1,
...
g[a],d.lexer.matched);this.$=new d.CTATLogicRelationNode("NOT",null,f[a],f[a-1]);break;case 10:this.$=f[a];break;case 11:this.$=f[a-1].setParens();break;case 12:this.$=new d.CTATLogicVariableNode(d.variableTable,f[a]);break;case 13:this.$=new d.CTATLogicConstantNode(!0,f[a]);break;case 14:this.$=new d.CTATLogicConstantNode(!1,f[a])}},table:[{3:1,4:2,13:f,14:4,15:e,17:c,18:a,19:d},{1:[3]},{5:[1,9],6:h,7:l,8:n,9:m,10:p,11:u,12:q},{4:17,13:f,14:4,15:e,17:c,18:a,19:d},g(w,[2,10]),{4:18,13:f,14:4,15:e,
17:c,18:a,19:d},g(w,[2,12]),g(w,[2,13]),g(w,[2,14]),{1:[2,1]},{4:19,13:f,14:4,15:e,17:c,18:a,19:d},{4:20,13:f,14:4,15:e,17:c,18:a,19:d},{4:21,13:f,14:4,15:e,17:c,18:a,19:d},{4:22,13:f,14:4,15:e,17:c,18:a,19:d},{4:23,13:f,14:4,15:e,17:c,18:a,19:d},{4:24,13:f,14:4,15:e,17:c,18:a,19:d},{4:25,13:f,14:4,15:e,17:c,18:a,19:d},g(w,[2,9]),{6:h,7:l,8:n,9:m,10:p,11:u,12:q,16:[1,26]},g(w,[2,2]),g(v,[2,3],{6:h,8:n}),g(v,[2,4],{6:h}),g([5,10,11,12,16],[2,5],{6:h,7:l,8:n}),g([5,11,12,16],[2,6],{6:h,7:l,8:n,9:m,
10:p}),g([5,12,16],[2,7],{6:h,7:l,8:n,9:m,10:p,11:u}),g([5,16],[2,8],{6:h,7:l,8:n,9:m,10:p,11:u,12:q}),g(w,[2,11])],defaultActions:{9:[2,1]},parseError:function(a,c){if(c.recoverable)this.trace(a);else{var b=function(a,c){this.message=a;this.hash=c};b.prototype=Error;throw new b(a,c);}},parse:function(a){var c=[0],b=[null],d=[],e=this.table,f="",g=0,h=0,l=0,n=d.slice.call(arguments,1),m=Object.create(this.lexer),p={},q;for(q in this.yy)Object.prototype.hasOwnProperty.call(this.yy,q)&&(p[q]=this.yy[q]);
m.setInput(a,p);p.lexer=m;p.parser=this;"undefined"==typeof m.yylloc&&(m.yylloc={});q=m.yylloc;d.push(q);var w=m.options&&m.options.ranges;this.parseError="function"===typeof p.parseError?p.parseError:Object.getPrototypeOf(this).parseError;for(var u,v,A,P,S={},T,R;;){A=c[c.length-1];if(this.defaultActions[A])P=this.defaultActions[A];else{if(null===u||"undefined"==typeof u)u=m.lex()||1,"number"!==typeof u&&(u=this.symbols_[u]||u);P=e[A]&&e[A][u]}if("undefined"===typeof P||!P.length||!P[0]){var W;R=
[];for(T in e[A])this.terminals_[T]&&2<T&&R.push("'"+this.terminals_[T]+"'");W=m.showPosition?"Parse error on line "+(g+1)+":\n"+m.showPosition()+"\nExpecting "+R.join(", ")+", got '"+(this.terminals_[u]||u)+"'":"Parse error on line "+(g+1)+": Unexpected "+(1==u?"end of input":"'"+(this.terminals_[u]||u)+"'");this.parseError(W,{text:m.match,token:this.terminals_[u]||u,line:m.yylineno,loc:q,expected:R})}if(P[0]instanceof Array&&1<P.length)throw Error("Parse Error: multiple actions possible at state: "+
A+", token: "+u);switch(P[0]){case 1:c.push(u);b.push(m.yytext);d.push(m.yylloc);c.push(P[1]);u=null;v?(u=v,v=null):(h=m.yyleng,f=m.yytext,g=m.yylineno,q=m.yylloc,0<l&&l--);break;case 2:R=this.productions_[P[1]][1];S.$=b[b.length-R];S._$={first_line:d[d.length-(R||1)].first_line,last_line:d[d.length-1].last_line,first_column:d[d.length-(R||1)].first_column,last_column:d[d.length-1].last_column};w&&(S._$.range=[d[d.length-(R||1)].range[0],d[d.length-1].range[1]]);A=this.performAction.apply(S,[f,h,
g,p,P[1],b,d].concat(n));if("undefined"!==typeof A)return A;R&&(c=c.slice(0,-2*R),b=b.slice(0,-1*R),d=d.slice(0,-1*R));c.push(this.productions_[P[1]][0]);b.push(S.$);d.push(S._$);P=e[c[c.length-2]][c[c.length-1]];c.push(P);break;case 3:return!0}}},checkStrict:function(a,c,b){var d=b+"\n"+"-".repeat(c.first_column)+"^",e=["'LPAREN'","'VARIABLE'","'TRUE'","'FALSE'"],d="Parse error on line "+c.first_line+":\n"+d+"\nExpecting "+e.join(", ")+" got '"+b[c.first_column]+"'";this.yy.strictMode&&!a.checkParens()&&
...
b,c)};return c}(CTATChemTreeNode);"undefined"!==typeof module&&null!==module?module.exports=b:this.CTATChemLogNode=b}).call(this);var CTATChemGrammar=function(){function b(){this.yy={}}var g=function(a,b,c,d){c=c||{};for(d=a.length;d--;c[a[d]]=b);return c},f=[1,6],e=[1,7],c=[1,11],a=[1,12],d=[1,14],h=[1,13],l=[1,15],n=[1,16],m=[1,17],p=[1,25],u=[1,26],q=[5,7,8,9,10,11,12,13,15,32],w=[1,27],v=[1,28],A=[1,29],y=[1,32],C=[1,33],r=[5,7,8,9,10,11,12,13,15,16,18,19,22,23,29,30,31,32,33,34,35,36],F=[1,37],B=[5,7,8,9,10,11,12,13,15,16,18,19,22,23,26,29,30,31,32,33,34,35,36],z=[1,40],E=[1,41],I=[5,7,8,9,10,11,12,13,15,16,18,19,22,23,
...
8],7:[1,19],8:[1,20],9:[1,21],10:[1,22],11:[1,23],12:[1,24],13:p,15:u},g(q,[2,11],{27:10,20:30,21:31,16:w,18:v,19:A,22:y,23:C,29:c,30:a,31:d,33:h,34:l,35:n,36:m}),g(r,[2,19]),{13:f,15:e,17:34,20:8,21:9,27:10,29:c,30:a,31:d,33:h,34:l,35:n,36:m},{13:f,15:e,17:35,20:8,21:9,27:10,29:c,30:a,31:d,33:h,34:l,35:n,36:m},g(r,[2,22]),g(r,[2,23],{25:36,26:F}),g(B,[2,31],{28:[1,38]}),{13:z,15:E,21:42,24:39,27:10,29:c,30:a,31:d,33:h,34:l,35:n,36:m},{31:[1,43]},{31:[1,44]},{6:45,13:f,14:4,15:e,17:5,20:8,21:9,27:10,
...
36:m},{13:f,15:e,17:58,20:8,21:9,27:10,29:c,30:a,31:d,33:h,34:l,35:n,36:m},g(r,[2,20]),g(r,[2,21]),g(r,[2,27]),g(r,[2,28]),{13:z,15:E,21:42,24:59,27:10,29:c,30:a,31:d,33:h,34:l,35:n,36:m},g(B,[2,30]),{13:z,15:E,21:42,24:60,27:10,29:c,30:a,31:d,33:h,34:l,35:n,36:m},{13:z,15:E,21:42,24:61,27:10,29:c,30:a,31:d,33:h,34:l,35:n,36:m},g(B,[2,26]),{6:62,13:f,14:4,15:e,17:5,20:8,21:9,27:10,29:c,30:a,31:d,33:h,34:l,35:n,36:m},{6:63,13:f,14:4,15:e,17:5,20:8,21:9,27:10,29:c,30:a,31:d,33:h,34:l,35:n,36:m},{13:p,
15:u,32:[1,64]},{5:[2,2],13:p,15:u},{5:[2,3],13:p,15:u},{5:[2,4],13:p,15:u},{5:[2,5],13:p,15:u},{5:[2,6],13:p,15:u},{5:[2,7],13:p,15:u},g(q,[2,9],{27:10,20:30,21:31,16:w,18:v,19:A,22:y,23:C,29:c,30:a,31:d,33:h,34:l,35:n,36:m}),g(q,[2,10],{27:10,20:30,21:31,16:w,18:v,19:A,22:y,23:C,29:c,30:a,31:d,33:h,34:l,35:n,36:m}),g(r,[2,12]),g(r,[2,13]),g(r,[2,14]),g(r,[2,17]),g(r,[2,18]),g(B,[2,29]),g(B,[2,24]),g(B,[2,25]),{13:p,15:u,32:[1,65]},{13:p,15:u,32:[1,66]},g(I,[2,34]),g(I,[2,32]),g(I,[2,33])],defaultActions:{18:[2,
...
e,!0)};b.prototype.polyTermsEqual=function(f,e){return this.parser.parse(f).simplify(b.partial).equals(this.parser.parse(e).simplify(b.partial))};b.prototype.algebraicMatches=function(b,e){return this.chemEquivalent(b,e,!0)};b.prototype.expressionMatches=b.prototype.algebraicMatches;b.prototype.chemGetQuadraticCoefficients=function(b,e){var c,a,d,f,g,n,m,p,u,q,w,v;c=e?this.chemSimplify(b,!1,!0):b;a=this.chemParse(c);c=null;q=[];v=null;"EQUAL"===a.operator&&("PLUS"===a.left.operator&&"CONST"===a.right.operator&&
...
a.evaluate());return b};a={a:a,b:d,c:f};n=["a","b","c"];for(f=g=0;3>g;f=++g)if(c.terms[f]){w=u=null;d=m=0;for(p=n.length;0<=p?m<p:m>p;d=0<=p?++m:--m)if(a[n[d]]&&(u=a[n[d]](c.terms[f]))){w=d;break}if(null===u)return null;q[w]=u;delete a[n[w]]}if(!q[0]||!q[1])return null;q[2]||(q[2]=0);return q}return null};b.prototype.chemSolveQuadratic=function(b,e,c){var a;a=Math.pow(e,2)-4*b*c;c=[];0===a?c.push(""+-e/(2*b)):0<a?(a=Math.sqrt(a),c.push(""+(-e+a)/(2*b)),c.push(""+(-e-a)/(2*b))):(a=Math.sqrt(Math.abs(a)),
...
b){return function(){var d;d=1<=arguments.length?c.call(arguments,0):[];return a.apply(b,d)}}(CTATFormulaActions[b],CTATFormulaActions))}b.prototype.evaluate=function(b,d,n,m){var h,l,q,w,v,A,y,C,r,F,B,z;try{C="undefined"!==typeof window&&null!==window?window:global;h=function(){var a;a=[];for(w in C)a.push(w);return a}().concat(["selection","action","input"]);r=b.split(e);l=0;for(v=r.length;l<v;l++)for(y=r[l],B=null!=(F=y.match(g))?F:[],q=0,A=B.length;q<A;q++)w=B[q],0>a.call(f,w)&&0>a.call(h,w)&&
0>a.call(this.keys,w)&&CTATFormulaFunctions.assign(w,void 0);for(w in z=this.variableTable.getTable())C[w]=z[w];return function(a,b,c){c.prototype=a.prototype;c=new c;a=a.apply(c,b);return Object(a)===a?a:c}(Function,["selection","action","input"].concat(c.call(this.keys),["return "+b.trim()]),function(){}).apply(C,[d,n,m].concat(c.call(this.values)))}catch(E){return console.log(E),null}finally{for(w in C)null!=w&&0>a.call(h,w)&&(z[w]=C[w],delete C[w])}};b.prototype.interpolateSplitPattern=/<%=|%>/;
...
ea.__hintTree[0]));if(!e)for(var g=0;g<ea.length;g++){var h=ea[g][0],m=ea[g][1],n=m.firstPredictedSolution,m=m.selectionMap;!f&&("hint"!==c||0<n.hints.length)&&(f=n);if(G(a,h).isMatch){!e&&("hint"!==c||0<n.hints.length)&&(e=n);for(var p in m){if(m.hasOwnProperty(p))for(h=m[p],n=0;n<h.length;n++){var u=h[n];if("tutored_action"===c){if(G(a,u.sai,u.saiComparator).isMatch){d=u;break}}else!e&&0<u.hints.length&&(e=u)}if(d||"hint"===c&&e)break}}}if(d)K("debug","Matched w/ pregen tree, refiring chain: "+
...
1].priority=a}function q(a){var b=e[e.length-1].sai;a.selection&&(b.selection=a.selection);a.action&&(b.action=a.action);a.input&&(b.input=a.input)}function w(a,b,c,d,e,f,g){K("debug","handleImports for "+b);c=c||{};e=e||{count:0,chunks:[]};f=f||0;g=g||0;for(var h=/\bimport\s?\(('|")?([^()'"\s]*)\1?\);/g,l,m=[];null!=(l=h.exec(a));){var n=Z.relativeToAbsolute(l[2],b);c[n]?K("debug","skipping duplicate import: "+n):(m.push(n),c[n]=!0);a=a.replace(l[0],"");h.lastIndex-=l[0].length}e.chunks[f]||(e.chunks[f]=
[]);e.chunks[f][g]=a;e.count+=m.length;K("debug",b+" is importing "+m.length+" files");if(0<m.length)for(a={i:0};a.i<m.length;a={url$16:a.url$16,i:a.i},a.i++)a.url$16=m[a.i],$.ajax(a.url$16,{dataType:"text",success:function(a){return function(b){w(b,a.url$16,c,d,e,f+1,a.i);e.count--;0==e.count&&d(v(e.chunks))}}(a),error:function(a,b,c){K("error","Error in _handleImports() : ");K("error",b)}});else 0==f&&d(v(e.chunks))}function v(a){for(var b="",c;0<a.length;)for(c=a.pop();0<c.length;)b+=c.shift()+
"\n";return b}function A(a,b){var c={getRuntime:function(){return Ea},getStudentInput:function(){return ba.getLastStudentSAI()},getStudentSAIs:function(){return ba.getStudentSAIs()},checkSAI:I,setTutorSAI:q,setSuccessOrBugMsg:p,setChainPriority:u,setProblemAttribute:H,getInitialized:function(){return ba.getInitialized()},backtrack:function(){M.setAboutToBacktrack()},assert:O,modify:D,retract:L,undoAll:S,addPregenSAI:R,halt:P,pruneOldActivations:T,setCTNodeData:J};[CTATAlgebraParser,CTATLogicParser,
...
d=new va)}return d}function I(b,c,d){var f=!1,g=b.selection,h=b.action,l=b.input,m=e,m=m[m.length-1],n="not_specified"===g||"not_specified"===h||"not_specified"===l;K("sai_check","check SAI against: "+JSON.stringify(b));if(Y.pregen_conflict_tree)return K("sai_check","in pregen mode, skipping check  (was "+(d?"":"not")+" a buggy step)"),m.sai={selection:g,action:h,input:l,isCorrect:!d&&!n},m.comparator=c,ra&&(K("sai_check","currently re-firing; updating sai in matched chain..."),ra.sai=m.sai),!0;if(!ca)return K("sai_check",
"no student input to check, returning false"),!1;K("sai_check","student input: "+JSON.stringify(ca));m.sai={selection:null!==g&&void 0!==g&&"not_specified"!==g&&"don't_care"!==g?g:"",action:null!==h&&void 0!==h&&"not_specified"!==h&&"don't_care"!==h?h:"",input:null!==l&&void 0!==l&&"not_specified"!==l&&"don't_care"!==l?l:"",isCorrect:!d&&!n};Ca?K("sai_check","Skipping check, we're hint matching"):(f=G(ca,b,c),K("sai_check",(f.isMatch?"Match":"No match")+", "+(d?"was":"was not")+" a buggy step"),a=
f.isMatch?d?"buggy":"match":null,M.setNodeMatcherResult(f,d));return f.isMatch}function G(a,b,c){var d=b.selection,e=b.action,f=b.input,g=a.selection,h=a.action,l=a.input,m=["-","-","-"],n={student:a,tutor:b,isMatch:!1,matchedFields:null},l=isNaN(l)?l:parseInt(l,10),f=isNaN(f)?f:parseInt(f,10),p=function(a,b,c){return"don't_care"===a?"*":"not_specified"===a?" ":a===b?c:"-"};m[0]=p(d.toLowerCase(),g.toLowerCase(),"S");m[1]=p(e.toLowerCase(),h.toLowerCase(),"A");m[2]=p(f,l,"I");n.matchedFields=m;if(c&&
"function"===typeof c)n.isMatch=c(a,b);else for(n.isMatch=!0,a=0;3>a;a++)if("-"===m[a]){n.isMatch=!1;break}return n}function x(){X=new ua;e=[];c=[];a=null;na=d=!1}function H(a,b){K("debug","setProblemAttribute ("+a+", "+b+")");Y[a]=b}function J(a){M.setNodeData(a)}function V(){for(var b=e,c=X.selectionMap,f,g,h={message:"",priority:Number.NEGATIVE_INFINITY},l,m=[],n=[],p=[],u=[],q=[],w,r={selection:"",action:"",input:""},v=null,z={},J=d?ja?1:2:0,H=0,da=0;da<b.length;da++)f=b[da],g=f.sai,n.push(f.ruleName),
(l=za[f.ruleName])&&p.push(l.name+" "+l.category),p=p.concat(f.skills),u=u.concat(f.hints),q=q.concat(f.tpas),m.push(f.activationId),f.successOrBugMsg&&f.successOrBugMsg.priority>h.priority&&(h=f.successOrBugMsg),g&&(g.selection&&(w=r.selection=g.selection),g.action&&(r.action=g.action),g.input&&(r.input=g.input),r.isCorrect=g.isCorrect,f.comparator&&"function"===typeof f.comparator&&(v=f.comparator)),f.customFields.forEach(function(a){return z[a.name]=a.value}),H=f.priority>H?f.priority:H;u.sort(function(a,
b){var c=b.precedence-a.precedence;0===c&&(c=a.pos-b.pos);return c});w?X.firstTutorSelection||(X.firstTutorSelection=w):w="_default_key";c[w]||(c[w]=[]);b=new va(r,n,p,u,h,z,m,v,q,J,H);r.isCorrect&&!X.firstPredictedSolution&&(X.firstPredictedSolution=b);c[w].push(b);switch(a){case "buggy":X.bugMatchChains.push(b);break;case "match":X.matchChain=b}X.numChains++;Ba=q;K("debug","stored last chain: \n\trules: "+n+"\n\tskills: "+p+"\n\thints: "+u.map(function(a){return a.msg})+"\n\tfinalSAI: "+JSON.stringify(r)+
...
"not ")+"skipped")}function da(a){K("agenda_retract",a+" removed from agenda")}function Ha(){K("agenda_empty","No more activations in agenda, all branches have been explored");na=!0}function Ia(a){K("override","hit breakpoint on rule "+a+" (call resume() to resume matching)")}var ua=function(){this.firstTutorSelection=null;this.selectionMap={};this.matchChain=null;this.bugMatchChains=[];this.numChains=0;this.firstPredictedSolution=null},va=function(a,b,c,d,e,f,g,h,l,m,n){this.sai=a||{selection:"",
action:"",input:""};this.rules=b||[];this.skills=c||[];this.hints=d||[];this.msg=e?e.message:"";this.customFields=f||{};this.activationIds=g||[];this.saiComparator=h||null;this.tpas=l||[];this.halted=m;this.priority=n||0},Ja=function(a,b){this.ruleName=a;this.activationId=b;this.hints=[];this.tpas=[];this.skills=[];this.customFields=[]},K=b,Ka=g,Ea=f,ba=this,ha=!1,oa=null,M=null,sa={},X=new ua,ca=null,Fa=0;e=[];c=[];a=null;var Da=d=!1,Z=null,wa=[],Y={use_backtracking:!0,prune_old_activations:!1,use_hint_fact:!1,
search_all_permutations:!0,hint_out_of_order:!1,substitute_input:!1,auto_hint:"none",auto_hint_threshold:3},la=!0,Ca=!1,ta=null,za={},Ba=[],qa=!1,ka=!0,xa=function(){},na=!1,ma=[],ja=!1,ya=function(){},ea=[],ra=null,Aa=null,Ga;this.getSession=function(){return M};this.getInitialized=function(){return ha};this.getSkills=function(){return za};this.getProblemAttribute=function(a){return Y[a]};this.getProblemStateStatus=function(){return Ea.getOutputStatus()};this.init=function(a,b,c){K("debug","noolstracer init w/ source file: "+
a);if(nools){Z=new CTATNoolsTracerUtil;var d=Z.relativeToAbsolute(a);$.ajax(a,{dataType:"text",success:function(e){w(e,d,null,function(d){K("debug","compiling model...");!0!==(d=A(d,a))?(K("error","CTATNoolsTracer: Error compiling model"),c(d)):(K("debug","done compile"),ba.createSession()||c("CTATNoolsTracer: Error creating session"),registerTracerWrapper(new CTATNoolsTracerWrapper(ba)),h(function(){K("override","tracer initialized, log flags: ");getTracerLogFlags();printBreakpoints();b(wa,Y);var a=
new Event("noolsModelLoaded");window.dispatchEvent(a);Y.pregen_conflict_tree&&l()}))})},error:function(a,b,d){ctatdebug("Error retrieving rule file: ");ctatdebug(b);c(b)}})}else K("error","Error: nools is not defined"),c("nools is not defined")};this.createSession=function(){K("debug","creating session...");(M=oa.getSession({iAmEventListeners:!0,assert:Q,retract:aa,modify:U,state_save:fa,state_restore:ia,backtrack:N,fire:ga,agenda_insert:pa,agenda_retract:da,agenda_empty:Ha,endOfChain:W,breakpoint:Ia}))&&
K("debug","session created");return!!M};this.evaluate=function(a,b,c){K("debug","noolsTracer.evaluate, matchType = "+c+", sai "+JSON.stringify(a)+", "+la);Ga=Date.now();if(Y.pregen_conflict_tree)return m(a,b,c);var d=B.bind(ba,b);M.prepForMatch();switch(c){case "hint":if(la||Y.use_hint_fact)Ca=!0,d=z.bind(ba,b,!0),Y.use_hint_fact&&r();else return K("debug","re-using hints from last match"),z(b,!1,a.selection),!0;case "tutored_action":x();C(a,!0);xa=function(){M.prepForMatch();M.restoreAgenda();ba.printTraceTime();
ba.printAgenda("agenda_post");ba.printConflictTree("conflict_tree");d()};qa||(ba.printAgenda("agenda_pre"),F());break;case "untutored_action":return C(a,!1),!0}return!1};this.setListener=function(a,b){M&&M.on(a,b)};this.getStudentSAIs=function(){return sa};this.getLastStudentSAI=function(){return ca};this.getTutorSAIs=function(){return X.selectionMap};this.reset=function(a){ba.createSession();ha=!1;sa={};X=new ua;ca=null;la=!0;h(a)};this.printTraceTime=function(){var a=(Date.now()-Ga)/1E3;K("time",
"trace took "+a+" seconds.")};this.printAgenda=function(a){K(a,Z.printAgenda(M))};this.printConflictTree=function(a,b,c){K(a,"\n"+Aa.toString(b,c))};this.printPregenTrees=function(a,b,c){ea.__hintTree&&K(a," hint tree: \n"+ea.__hintTree[1].toString(b,c));ea.forEach(function(d){K(a," tree for sai: "+JSON.stringify(d[0])+"\n"+d[2].toString(b,c))})};this.printTutorSAIs=function(a,b){var c="";Aa.getMatchChains().forEach(function(a){var d=a.match.tutor;c+="\n"+d.selection+" ; "+d.action+" ; "+d.input;
b&&(c+=" \n "+a.rules.join(",")+"\n")});K(a,c)};this.printFact=function(a){K("override",Z.printFact(M,a))};this.printFacts=function(a){K("override",Z.printFacts(M,a))};this.printRules=function(a){K("override",Z.printRules(M,a))};this.getFact=function(a){return Z.getFact(M,a)};this.getFacts=function(a){return Z.getFacts(M,a)};this.printCtNodeMatch=function(a){K("override",Z.printCtNodeMatch(M,a))};this.printRuleNodes=function(a){K("override",Z.printRuleNodes(M,a))};this.printBreakpoints=function(){K("override",
Z.printBreakpoints(M))};this.setInStepMode=function(a){a=a&&"false"!==a;K("override","Stepper mode "+(a?"on":"off"));!qa||a||na||F();qa=a};this.takeSteps=function(a){qa?ca?(a=a||1,K("override","taking "+a+" steps"),F(a)):K("override","no new student input, ignoring"):K("override","not in step mode, ignoring")};this.setBreakpoint=function(a,b){a?(b=b||"first",M.setBreakpoint(a,b)?K("override","breakpoint "+("none"===b?"cleared":"set")+" for rule "+a):K("override","breakpoint not "+("none"===b?"cleared":
"set")+" -- rule "+a+" doesn't exist")):K("override","need a rule name to break on")};this.resume=function(){qa?K("override","can't resume; engine is in stepper mode"):na?K("override","not at a breakpoint, ignoring"):F()};this.getIAmPregenerating=function(){return ja};this.setDonePregenCallback=function(a){K("debug","setDonePregenCallback()");ya=a}};var CTATLogger=function(b){var g={},f=0;b&&b.forEach(function(b){g[b]=!1});this.isSet=function(b){return!!g[b]};this.set=function(e){if(b&&!(e in g))return!1;f++;return g[e]=!0};this.unset=function(e){if(b&&!(e in g))return!1;f--;return!(g[e]=!1)};this.getFlags=function(){return g};this.getNFlagsSet=function(){return f};this.log=function(b,c){(g[b]||"override"===b)&&console.log(("override"!==b?"["+b+"]: ":"")+c)}};var CTATRuleTracerGlobals={},NOOLS_LOG_FLAGS="time conflict_tree assert modify retract state_save state_restore backtrack agenda_insert agenda_retract agenda_empty fire error debug sai_check agenda_pre agenda_post tpa".split(" "),CTATNoolsTracerLogger=new CTATLogger(NOOLS_LOG_FLAGS),globalTracerRef=null;function registerTracerWrapper(b){globalTracerRef=b}function setTracerLogFlag(b){b=CTATNoolsTracerLogger.set(b)?"set flag "+b:"Error - invalid flag: "+b;CTATNoolsTracerLogger.log("override",b)}
...
a.setActor(CTATMsgType.DEFAULT_STUDENT_ACTOR);a.setStepID(g);a.setAssociatedSkills(f);a.setAssociatedRules(e);u={all:0};b(a,a.getTransactionID())}function a(a){l&&l.addTPAToMessageTank(a.selection,a.action,a.input,"tutor-performed")}function d(a){return{selection:a.getSelection()||"",action:a.getAction()||"",input:a.getInput()||""}}function h(){var a=m.getProblemAttribute("auto_hint"),b=m.getProblemAttribute("auto_hint_threshold");if("all"===a?u.all>=b:"selection"===a&&Object.keys(u).some(function(a){return"all"!==
a&&u[a]>=b}))n("debug","at consecutive error threshold, sending hint request..."),CTATCommShell.commShell.processComponentAction(new CTATSAI("hint","ButtonPressed","hint request"))}var l=g,n=CTATNoolsTracerLogger.log,m=null,p=null,u={all:0},q=this;this.getEngine=function(){return m};this.initEngine=function(c,d,e){switch(b){case "nools":m=new CTATNoolsTracer(n,a,l)}var f=function(a,b){console.log("CTATRuleTracer.doneInit");var c=m.getSkills();if(!CTATConfiguration.get("skills"))if(CTATSkillSet.skills){n("debug",
...
function(){return C};this.isDone=function(){var a=String(B.getDefaultSAI().getSelection()).toLowerCase(),b=String(B.getDefaultSAI().getAction()).toLowerCase(),a=CTATMsgType.DONE.toLowerCase()==a&&CTATMsgType.BUTTON_PRESSED.toLowerCase()==b;B.ctatdebug("CTATExampleTracerLink.isDone() returns "+a);return a};this.interpolateHints=function(a){B.ctatdebug("CTATExampleTracerLink --\x3e interpolateHints("+a+")");var b=[];if(null===q||"undefined"===typeof q||0===q.length)return b;null==a&&(a=new CTATVariableTable);
...
w+", now "+a);w=a};this.setVisualData=function(a){r=a};this.getVisualData=function(){return r}};
...
a);return a};this.setReportableLink=function(a){E.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableLink("+a+")");m=a};this.setReportableInterpretation=function(a){E.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableInterpretation("+a+")");p=a};this.setStepID=function(a){E.ctatdebug("CTATExampleTracerEvent --\x3e in setStepID("+a+")");u=a?a.toString():""};this.setReportableVariableTable=function(a){y=a.clone()};this.setSuccessOrBuggyMsg=function(a){E.ctatdebug("CTATExampleTracerEvent --\x3e in setSuccessOrBuggyMsg("+
...
CTATExampleTracerLink.BUGGY_ACTION.toString()&&(x.ctatdebug("In evaluate -- deleting an incorrect interp"),g["delete"](a))});x.ctatdebug("In evaluate -- to call setInterpretations(), if 0 < newInterps.size "+g.size);0<g.size&&(u(g),I=e);for(var h in F)F.hasOwnProperty(h)&&delete F[h];x.ctatdebug("In evaluate -- out of DoUpdate if branch")}else{x.ctatdebug("In evaluate -- in else branch of doUpdate");a.setNumberOfInterpretations(0);for(var l in F)F.hasOwnProperty(l)&&delete F[l];g.forEach(function(a){F[a.getLastMatchedLink().getUniqueID()]=
...
var C=!1,r=null,F=null,B=null,z=b,E=null;CTATExampleTracerTracer_count++;var I=null,G={},x=this;this.getModelInitialized=function(){return C};this.setModelInitialized=function(a){C=a};this.goToDone=function(a,b,c){return(a=a.getPathToDone(b))?c.traceLinks(a.getSortedLinks()):!1};this.getMatchedSelections=function(){return G};this.getLastResult=function(){x.ctatdebug("CTATExampleTracerTracer --\x3e in getResult");return E};this.resetTracer=function(){x.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer entering");
...
!0);else if(!1===J.isLinkInGroup(a,b)){f=!0;return}c.getTraversalCount(b)<b.getMaxTraversals()&&(e=!1)}});return!1===e?!1:!0}function m(a){var b=!0;J.getGroupLinks(a).forEach(function(a){!1!==b&&0!==a.getMinTraversals()&&(b=!1)});return!1===b?!1:!0}function p(a,b){for(var c=0;c<b.length;c++)if(!0===J.isLinkInGroup(a,b[c]))return!0;return!1}function u(a,b,c){var d=!0;J.getGroupLinks(a).forEach(function(a){!1!==d&&!0===c.has(a)&&l(b,a)<a.getMinTraversals()&&(d=!1)});return!1===d?!1:!0}function q(){for(var a=
0;a<C.length;a++)C[a].clearInLinks();var b=D.getStartNode();null!==b&&"undefined"!==typeof b&&null!==b.getOutLinks()&&"undefined"!==typeof b.getOutLinks()&&(a=0,b.getOutLinks().forEach(function(b){w(b,a++)}))}function w(a,b){ctatdebug("updateInLinkSubGraph("+a+", "+b+")");var c=D.getNode(a.getNextNode());if(null!==c&&"undefined"!==typeof c){c.addInLink(a);var d=0;c.getOutLinks().forEach(function(a){w(a,d++)})}}function v(a){var b=D.getNode(a.getPrevNode());if(null!==b&&"undefined"!==typeof b){var c=
-1;b.getInLinks().forEach(function(a){-1===a.getDepth()&&v(a);a.getDepth()>c&&(c=a.getDepth())});a.setDepth(c+1)}}function A(a){var b=D.getGroupModel(),c=b.getTopLevelGroup(),d="",e=c.getSubgroups(),d=a+'<EdgesGroups ordered="'+c.getIsOrdered()+'">\n';e.forEach(function(c){d+=c.toXML(a+"    ",b)});return d+=a+"</EdgesGroups>\n"}CTATBase.call(this,"CTATExampleTracerGraph","visualdata");var y=null,C=null,r=null,F=null,B=null,z=null,E="",I=[],G=new Set,x=new Set,H=null,J=null,V=!0,O=!0,L=CTATMsgType.SHOW_ALL_FEEDBACK,
...
CTATExampleTracerGraph.prototype.constructor=CTATExampleTracerGraph;"undefined"!==typeof module&&(module.exports=CTATExampleTracerGraph);var CTATGraphParser=function(){function b(b){ctatdebug("processEdge()");for(var c=new CTATExampleTracerLink(null,null,null),f=d.getElementChildren(b),h,l,n,p,q,u=b=-1,z=CTATMsgType.DEFAULT_ACTOR,E=!1,I=0;I<f.length;I++){"sourceID"===d.getElementName(f[I])&&(b=parseInt(d.getNodeTextValue(f[I])),c.setPrevNode(b));"destID"===d.getElementName(f[I])&&(u=parseInt(d.getNodeTextValue(f[I])),c.setNextNode(u));if("rule"===d.getElementName(f[I]))for(var G=d.getElementChildren(f[I]),x=0;x<G.length;x++)"text"===
...
u==a.getStartNode().getNodeID()&&console.log("***WARNING*** edge "+q+" destination is graph startNode "+a.getStartNode());q=new CTATVectorMatcher(h,l,n,z);q.setDefaultSAI(p.getSAI());q.setCaseInsensitive(m);q.setLinkTriggered(E);c.setMatcher(q);ctatdebug("GraphParser.processEdge() "+b+"->"+u+", edge "+c);a.getNode(b).addOutLink(c);a.checkForDoneState(c);return c}function g(a,b){e.ctatdebug("processMatchers()");for(var c=d.getElementChildren(a),f=[],g=0;g<c.length;g++)if("matcher"===d.getElementName(c[g])){for(var h=
...
"outOfOrderMessage"));for(var r=null,F=0;F<C.length;F++)switch(d.getElementName(C[F])){case "startNodeMessages":l=d.getElementChildren(C[F]);a.setStartStateMsgs(l);break;case "node":q++;var B;B=C[F];ctatdebug("processNode("+B+")");var z=d.getElementChildren(B),E=-1;B="";for(var I=[],G=0;G<z.length;G++)switch(d.getElementName(z[G])){case "uniqueID":E=parseInt(d.getNodeTextValue(z[G]));break;case "text":B=d.getNodeTextValue(z[G]);break;case "dimension":for(var x=d.getElementChildren(z[G]),H=0;H<x.length;H++)ctatdebug("grandkids "+
H+", "+x[H]+", "+d.getNodeTextValue(x[H])+", "+parseInt(d.getNodeTextValue(x[H]))),I[H]=parseInt(d.getNodeTextValue(x[H]));ctatdebug("grandkids d "+I)}z=new CTATExampleTracerNode(E,new Set);""!==B&&z.setNodeName(B);2<=I.length&&z.setDimension({x:I[0],y:I[1]});B=z;a.addNode(B);1==q&&(a.setStartNode(B),a.setStudentStartsHereNode(B));B.getNodeName()==a.getStudentStartStateNodeName()&&a.setStudentStartsHereNode(B);break;case "edge":a.addLink(b(C[F]));break;case "EdgesGroups":r=C[F];break;case "productionRule":G=
C[F];ctatdebug("processSkill()");I=B="";E=z=null;G=d.getElementChildren(G);for(x=0;x<G.length;x++)H=d.getElementName(G[x]),"ruleName"==H&&(B=d.getNodeTextValue(G[x]),ctatdebug("ruleName="+B)),"productionSet"==H&&(I=d.getNodeTextValue(G[x]),ctatdebug("productionSet="+I)),"label"==H&&(z=d.getNodeTextValue(G[x]),ctatdebug("label="+z)),"description"==H&&(E=d.getNodeTextValue(G[x]),ctatdebug("description="+E));B&&(G=new CTATExampleTracerSkill(I,B,CTATExampleTracerSkill.DEFAULT_P_GUESS,CTATExampleTracerSkill.DEFAULT_P_KNOWN,
CTATExampleTracerSkill.DEFAULT_P_SLIP,CTATExampleTracerSkill.DEFAULT_P_LEARN,CTATExampleTracerSkill.DEFAULT_HISTORY),null!=z?G.setLabel(z):G.setLabel(B),null!=E?G.setDescription(E):G.setDescription(B+(I?" "+I:"")),u.push(G))}if(r){q=d.getElementAttr(r,"ordered");if(null===q||"undefined"==typeof isordered)q=!w;ctatdebug("parseGraph() value of isOrdered = "+q);ctatdebug("parseGraph() value of isUnordered = "+w);ctatdebug("parseGraph() typeof isOrdered: "+typeof q);ctatdebug("parseGraph()typeof isUnordered: "+
typeof w);C=r;r=q;ctatdebug("processGroup()");n=a.getGroupModel();q=n.createIdToLinkMap();n.setGroupOrdered(n.getTopLevelGroup(),r);ctatdebug("processGroup() name of group: "+n.getGroupName(n.getTopLevelGroup()));ctatdebug("processGroup() group isOrdered?: "+n.isGroupOrdered(n.getTopLevelGroup()));ctatdebug("processGroup() order of group: isOrdered= "+r);ctatdebug("processGroup() order of group: isOrdered typeof= "+typeof r);C=d.getElementChildren(C);for(r=0;r<C.length;r++)switch(d.getElementName(C[r])){case "group":f(C[r],
q);break;case "outOfOrderMessage":n.getTopLevelGroup().setDefaultBuggyMsg(d.getNodeTextValue(C[r]))}a.addGroup(void 0)}q=g.getSkillBarVector(!1,!0);if(!q||1>q.length)ctatdebug("No existing skills. Add skills from BRD."),g.addGraphSkills(u),q=g.getSkillBarVector();h=(new CTATTutorMessageBuilder).createStateGraphMessage(m,w,p,g.isSourceFlash()?a.exitOnIncorrectDone():g.isFeedbackSuppressed(),y,String(g.getConfirmDone()),q);a.redoLinkDepths();c=a.getExampleTracer();c.resetTracer();a.forDebugging();ctatdebug("Graph loaded.");
...
l.ctatdebug("flushMessageTank() after updateProblemSummary; messageTank.length "+a.length);for(var n=[],u=[],q=0;q<a.length;++q){var w=a[q];if(w.msg){var v=w.msgType,A=w.evt;l.ctatdebug("entering processInterfaceVariables() msgType "+v+", evt "+A);if(v){var y=c?c.getTracer():null;l.ctatdebug("entering processInterfaceVariables() et "+c+", tracer "+y);v=v.toLowerCase();(0===v.indexOf("correct")||0===v.indexOf("interfaceaction"))&&y&&y.addInterfaceVariablesFromEvent(A)}if(!(v=f(w)))if(v=w,A=u,CTATConfiguration.usingFlash()){var C=
y=void 0;if(!(v&&v.sai&&(y=v.sai.getAction())&&(C=CTATSAI.delayedActionRegExp.exec(y)))||3>C.length||1>=C[2])v=!1;else{var r=A.length-1,r=0>r?null:A[r];v.msg=v.msg.replace(y,C[1]);r&&r.timeout==C[2]?r.msgTuples.push(v):A.push({timeout:Number(C[2]),msgTuples:[v]});v=!0}}else v=!1;v||n.push(w.msg)}}l.ctatdebug("flushMessageTank(): msgBundle.length "+n.length+", delayedMsgsBundle.length "+u.length);for(q=0;q<u.length;++q)w=u[q],l.ctatdebug("processDelayedMsgs() delayedMsgs.timeout "+w.timeout+", .msgTuples.length "+
...
a&&(d=a.getNextNode()));r.ctatdebug("advanceToStudentStartsHere() to check for TPA "+d+", "+e);l(d,B.findCurrentState(!1,!1),null,e)}a=[];b&&a.push(b);N.canRestore()||a.push((new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,null));0<a.length&&r.sendBundle(a);B.setModelInitialized(!0)}r.startWorking()};this.processNools=function(a){var b=new CTATTutorMessageBuilder;C="rule";z=new CTATRuleTracer("nools",r);z.initEngine(a,function(a,d){r.ctatdebug("nools engine compiled");var e;
