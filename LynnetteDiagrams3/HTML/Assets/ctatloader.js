/**-----------------------------------------------------------------------------
 $Author: sewall $
 $Date: 2020-11-13 14:35:07 -0500 (Fri, 13 Nov 2020) $
 $HeadURL: svn://localhost/usr5/local/svnroot/AuthoringTools/branches/CTAT_4_4_Mathtutor_Release/HTML5/ctatloader.js $
 $Revision: 25789 $
...
tutorInitializer = new Promise(
        resolve => {
                console.log("tutorInitialized Promise resolve:", resolve);
                document.addEventListener("tutorInitialized", resolve);
        }
);
...
/**
 * Listener for jQuery's ready event. Do not show the scrim here, for this listener can get invoked after initialization
 */
if (window.jQuery) 
{
	$(function()
